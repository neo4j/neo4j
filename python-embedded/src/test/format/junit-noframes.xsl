...
<xsl:template match="testcase" mode="print.test">
    ...
    <xsl:choose>
      <xsl:when test="system-err">
        <tr><th colspan="2">stderr</th>
        <td><xsl:apply-templates select="system-err"/></td></tr>
      </xsl:when>
      <xsl:when test="system-out">
        <tr><th colspan="2">stdout</th>
        <td><xsl:apply-templates select="system-out"/></td></tr>
      </xsl:when>
    </xsl:choose>
</xsl:template>
...
<xsl:template match="system-out">
  <xsl:call-template name="display-output"/>
</xsl:template>
...
<xsl:template name="display-output">
    <code><pre>
      <xsl:value-of select="."/>
    </pre></code>
</xsl:template>
