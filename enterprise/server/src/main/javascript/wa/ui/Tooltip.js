...
_.extend(wa.ui.Tooltip.prototype, {
    ...
    /**
     * If pos is an array, return it, assuing it already is a position.
     * Else, asume pos is a html element, return it's top center position.
     */
    _getPosition : function(pos) {
        if(_.isArray(pos)) {
            ...
            var el = $(pos);
            pos = el.offset();
            if(this._settings.position === "above") {
