    ...
    public void start() throws Throwable
    {
        ...
        if ( config.get( MetricsSettings.neoCheckPointingEnabled ) )
        {
            registry.register( CHECK_POINT_START_TIME, new Gauge<Long>()
            {
                ...
                public Long getValue()
                {
                    return checkPointerMonitor.lastCheckPointStartTimeMillis();
                }
            } );
            ...
            registry.register( CHECK_POINT_END_TIME, new Gauge<Long>()
            {
                ...
                public Long getValue()
                {
                    return checkPointerMonitor.lastCheckPointEndTimeMillis();
                }
            } );
            ...
            registry.register( CHECK_POINT_TOTAL_TIME, new Gauge<Long>()
            {
                ...
                public Long getValue()
                {
                    return checkPointerMonitor.lastCheckPointTotalTimeMillis();
                }
            } );
        }
        ...
        if ( config.get( MetricsSettings.neoLogRotationEnabled ) )
        {
            registry.register( LOG_ROTATION_START_TIME, new Gauge<Long>()
            {
                ...
                public Long getValue()
                {
                    return logRotationMonitor.lastLogRotationStartTimeMillis();
                }
            } );
            ...
            registry.register( LOG_ROTATION_END_TIME, new Gauge<Long>()
            {
                ...
                public Long getValue()
                {
                    return logRotationMonitor.lastLogRotationEndTimeMillis();
                }
            } );
            ...
            registry.register( LOG_ROTATION_TOTAL_TIME, new Gauge<Long>()
            {
                ...
                public Long getValue()
                {
                    return logRotationMonitor.lastLogRotationTotalTimeMillis();
                }
            } );
        }
