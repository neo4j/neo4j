...
public class RaftReplicatorTest
{
    ...
    public void shouldSendReplicatedContentToLeader() throws Exception
    {
        ...
        RaftReplicator replicator = getReplicator( outbound, capturedProgress, noWaitTimeoutStrategy, monitors );
    ...
    public void shouldReleaseSessionWhenFinished() throws Exception
    {
        ...
        RaftReplicator replicator = getReplicator( outbound, capturedProgress, noWaitTimeoutStrategy, new Monitors() );
    ...
    private RaftReplicator getReplicator( CapturingOutbound<RaftMessages.RaftMessage> outbound, CapturingProgressTracker capturedProgress,
            TimeoutStrategy timeoutStrategy, Monitors monitors )
    {
        return new RaftReplicator( leaderLocator, myself, outbound, sessionPool, capturedProgress, noWaitTimeoutStrategy, timeoutStrategy, availabilityGuard,
                NullLogProvider.getInstance(), replicationLimit, monitors );
    }
