...
{
    public EnterpriseClusterOverviewIT( Supplier<DiscoveryServiceFactory> discoveryServiceFactory )
    {
        super( discoveryServiceFactory );
    }

    @Parameterized.Parameters( name = "discovery-{0}" )
    public static Collection<Supplier<DiscoveryServiceFactory>> data()
    {
        return DiscoveryServiceType.values;
    }
}
