...
public class CatchupServerBootstrapper<C extends ServerChannel> implements Function<EventLoopContext<C>,ServerBootstrap>
{
    ...
    public CatchupServerBootstrapper( Supplier<StoreId> storeIdSupplier,
    ...
    private ChannelInboundHandler decoders( CatchupServerProtocol protocol )
    {
        ...
        decoderDispatcher.register( CatchupServerProtocol.State.GET_STORE_ID,
                new SimpleRequestDecoder( GetStoreIdRequest::new ) );
        decoderDispatcher.register( CatchupServerProtocol.State.GET_CORE_SNAPSHOT,
                new SimpleRequestDecoder( CoreSnapshotRequest::new ) );
