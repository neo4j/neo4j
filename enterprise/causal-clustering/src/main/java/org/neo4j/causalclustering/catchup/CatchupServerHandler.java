...
public class CatchupServerHandler
{
    ...
    private final ServerMessageTypeHandler serverMessageHandler;
    ...
    public CatchupServerHandler( CatchupServerProtocol protocol, Monitors monitors, LogProvider logProvider, Supplier<StoreId> storeIdSupplier,
            ...
            StoreCopyCheckPointMutex storeCopyCheckPointMutex, CoreSnapshotService snapshotService, Supplier<CheckPointer> checkPointerSupplier )
    {
        ...
        this.serverMessageHandler = new ServerMessageTypeHandler( protocol, logProvider );
    ...
    public ChannelHandler serverMessageHandler()
    {
