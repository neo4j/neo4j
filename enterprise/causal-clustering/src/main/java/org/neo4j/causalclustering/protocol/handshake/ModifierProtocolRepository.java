...
public class ModifierProtocolRepository extends ProtocolRepository<Protocol.ModifierProtocol>
{
    private final Collection<SupportedProtocols<Protocol.ModifierProtocol>> supportedProtocols;
    private final Map<String,SupportedProtocols<Protocol.ModifierProtocol>> supportedProtocolsLookup;

    public ModifierProtocolRepository( Protocol.ModifierProtocol[] protocols, Collection<SupportedProtocols<Protocol.ModifierProtocol>> supportedProtocols )
    {
    ...
    static Function<String,Comparator<Protocol.ModifierProtocol>> getModifierProtocolComparator(
            Collection<SupportedProtocols<Protocol.ModifierProtocol>> supportedProtocols )
    {
        return getModifierProtocolComparator( versionMap( supportedProtocols ) );
    }

    private static Map<String,List<Integer>> versionMap( Collection<SupportedProtocols<Protocol.ModifierProtocol>> supportedProtocols )
    {
    ...
    private static Function<String,Comparator<Protocol.ModifierProtocol>> getModifierProtocolComparator( Map<String,List<Integer>> versionMap )
    {
        return protocolName -> {
     ...
     */
    private static Integer byPosition( Protocol.ModifierProtocol modifierProtocol, List<Integer> versions )
    {
        int index = versions.indexOf( modifierProtocol.version() );
        return index == -1 ? Integer.MIN_VALUE : -index;
    }

    public Optional<SupportedProtocols<Protocol.ModifierProtocol>> supportedProtocolFor( String protocolName )
    {
        return Optional.ofNullable( supportedProtocolsLookup.get( protocolName ) );
    }

    public Collection<SupportedProtocols<Protocol.ModifierProtocol>> supportedProtocols()
    {
