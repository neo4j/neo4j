...
public class HazelcastDiscoveryServiceFactory implements DiscoveryServiceFactory
{
            ...
            LogProvider logProvider, LogProvider userLogProvider, ResolutionResolver resolutionResolver)
    {
        ...
        return new HazelcastCoreTopologyService( config, sslPolicy, myself, jobScheduler, logProvider, userLogProvider, resolutionResolver);
    }
    ...
    {
        configureHazelcast( config );
        return new HazelcastClient( new HazelcastClientConnector( config, logProvider, sslPolicy, resolutionResolver), jobScheduler, logProvider, config, myself );
    }
