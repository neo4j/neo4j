...
{
    private final CatchupServerProtocol inboundProtocol;
    private final Supplier<NeoStoreDataSource> dataSource;

    private final StoreStreamingProcess storeStreamingProcess;

    public GetStoreRequestHandler( CatchupServerProtocol inboundProtocol, Supplier<NeoStoreDataSource> dataSource, StoreStreamingProcess storeStreamingProcess )
    {
    ...
    protected void channelRead0( ChannelHandlerContext ctx, GetStoreRequest msg ) throws Exception
    {
        ...
        inboundProtocol.expect( State.MESSAGE_TYPE );
    }
}
