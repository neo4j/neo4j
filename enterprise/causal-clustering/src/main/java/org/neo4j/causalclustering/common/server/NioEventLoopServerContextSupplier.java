...
public class NioEventLoopServerContextSupplier implements Supplier<EventLoopContext<NioServerSocketChannel>>
{
    private final ThreadFactory threadFactory;
    private final int threads;

    public NioEventLoopServerContextSupplier( ThreadFactory threadFactory, int threads )
    {
    ...
    public NioEventLoopServerContextSupplier( ThreadFactory threadFactory )
    {
