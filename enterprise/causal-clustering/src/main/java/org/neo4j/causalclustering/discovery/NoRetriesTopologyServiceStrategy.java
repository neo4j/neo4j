...
public class NoRetriesTopologyServiceStrategy implements TopologyServiceRetryStrategy
{
    ...
    {
        return topologyServiceFindCatchupAddress.apply( memberId ).orElseThrow( () -> new TopologyLookupException( memberId ) );
    }
}
