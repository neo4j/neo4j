    ...
    protected void channelRead0( ChannelHandlerContext ctx, final TxPullRequest msg ) throws Exception
    {
        ...
        try
        {
            ...
            else
            {
                ...
                {
                    eventHandler.on( Info, "Request is ahead of local database.", param( "Requested tx id", firstTxId ),
                            param( "Local highest tx id", lastCommittedTransactionId ) );
                ...
                else
                {
                    ...
                    if ( txCursor == null )
                    {
                        eventHandler.on( Info, "Transaction does not exits" );
