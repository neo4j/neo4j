...
class FakeXAResource implements XAResource
{
	...
	{
		addMethodCall( new MethodCall( "commit", 
	...
	{
		addMethodCall( new MethodCall( "end", 
			new Object[] { xid, new Integer( flags ) },
			new String[] {	"javax.transaction.xa.Xid",
							"java.lang.Integer" } ) );
	}
	...
	{
		addMethodCall( new MethodCall( "forget", 
			new Object[] { xid },
			new String[] {	"javax.transaction.xa.Xid" } ) );
	}
	...
	{
		addMethodCall( new MethodCall( "prepare", 
			new Object[] { xid },
			new String[] {	"javax.transaction.xa.Xid" } ) );
	...
	{
		addMethodCall( new MethodCall( "recover", 
	...
	{
		addMethodCall( new MethodCall( "rollback", 
			new Object[] { xid },
			new String[] { "javax.transaction.xa.Xid" } ) );
	}
	...
	{
		addMethodCall( new MethodCall( "start", 
			new Object[] { xid, new Integer( flags ) },
			new String[] {	"javax.transaction.xa.Xid",
							"java.lang.Integer" } ) );
	}
