 ...
 * <p>
 * Put your methods that perform any transactional work towards the resource 
 * in your extention of this class. Create a instance of the 
 * {@link XaResourceHelpImpl} as your <CODE>XAResource</CODE>. Add a try-finally
 * block in your work methods around the command creations and enlist/delist the
 * <CODE>XAResource</CODE> with the transaction. Use the protected
 * <CODE>getTransaction</CODE> method to get a {@link XaTransaction} and 
 * add your commands to the transaction. Here is an example implementation: <p>
 * <pre>
 * <CODE>
...
public abstract class XaConnectionHelpImpl implements XaConnection
{
	...
	/**
	 * Returns the {@link XaTransaction} associated with this connection.
	 * If transaction is already completed it will still be returned. 
	 * 
	 * @return The {@link XaTransaction} associated with this connection
	 * @throws XAException If the transaction hasn't completed and the resource
	 * isn't enlisted
	 */
