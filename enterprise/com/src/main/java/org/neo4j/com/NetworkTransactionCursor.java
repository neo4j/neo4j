...
public class NetworkTransactionCursor implements IOCursor
{
    ...
    public NetworkTransactionCursor( ReadableLogChannel channel, LogEntryReader<ReadableLogChannel> entryReader,
