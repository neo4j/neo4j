...
public class InMemoryRaftMembershipStateTest
{
    ...
    public void shouldSerialiseAndDeserialiseEmptyStateCorrectly() throws Exception
    {
        ...
        InMemoryRaftMembershipState.InMemoryRaftMembershipStateMarshal<CoreMember> marshal = new InMemoryRaftMembershipState.InMemoryRaftMembershipStateMarshal<>( new CoreMemberMarshal() );
