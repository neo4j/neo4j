...
public interface DiscoveryServiceFactory
{
    ...
    TopologyService edgeDiscoveryService( Config config, SocketAddress boltAddress, LogProvider logProvider, DelayedRenewableTimeoutService timeoutService, long edgeTimeToLiveTimeout, long edgeRefreshRate );
}
