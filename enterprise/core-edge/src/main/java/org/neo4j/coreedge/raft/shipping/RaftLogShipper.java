...
import static org.neo4j.coreedge.raft.schedule.RenewableTimeoutService.RenewableTimeout;
import static org.neo4j.coreedge.raft.shipping.RaftLogShipper.Mode.PIPELINE;
import static org.neo4j.coreedge.raft.shipping.RaftLogShipper.Timeouts.RESEND;
