...
{
    private final InMemoryReplicatedLockStateChannelMarshal<MEMBER> marshal;

    public ReplicatedLockTokenStateRecoveryManager( FileSystemAbstraction fileSystemAbstraction,
    ...
    public InMemoryReplicatedLockTokenState<MEMBER> readLastEntryFrom( FileSystemAbstraction fileSystemAbstraction, File file )
            throws IOException
    {
