...
public class DeferringStatementLocksFactoryTest
{
    ...
    public void newInstanceCreatesSimpleLocksWhenConfigNotSet()
    {
        ...
        Config config = Config.defaults( stringMap( deferred_locks_enabled.name(), Settings.FALSE ) );
    ...
    public void newInstanceCreatesDeferredLocksWhenConfigSet()
    {
        ...
        Config config = Config.defaults( stringMap( deferred_locks_enabled.name(), Settings.TRUE ) );
