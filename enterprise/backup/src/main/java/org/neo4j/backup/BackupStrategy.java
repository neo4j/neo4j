...
{
    PotentiallyErroneousState<BackupStageOutcome> performIncrementalBackup( File desiredBackupLocation, Config config, OptionalHostnamePort userProvidedAddress );
