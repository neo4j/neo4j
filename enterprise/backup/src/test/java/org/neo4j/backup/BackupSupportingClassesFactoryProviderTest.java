...
public class BackupSupportingClassesFactoryProviderTest
{
    ...
    private Collection<BackupSupportingClassesFactoryProvider> allAvailableSupportingClassesFactories()
    {
    ...
    private <DESIRED extends BackupSupportingClassesFactoryProvider> Collection<DESIRED> findInstancesOf( Class<DESIRED> desiredClass,
    ...
    private Predicate<BackupSupportingClassesFactoryProvider> isOfClass( Class<? extends BackupSupportingClassesFactoryProvider> desiredClass )
    {
