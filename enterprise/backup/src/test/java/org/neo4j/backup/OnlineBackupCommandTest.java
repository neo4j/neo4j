...
public class OnlineBackupCommandTest
{
    ...
    public void setup() throws Exception
    {
        ...
        when( backupStrategyCoordinatorFactory.backupFlow( any(), any(), any(), any() ) ).thenReturn( backupStrategyCoordinator );

        subject = new OnlineBackupCommand( outsideWorld, onlineBackupContextLoader, backupSupportingClassesFactory, backupStrategyCoordinatorFactory );
    }
