  ...
  test("Plan should have right relationship direction") {
    ...
    result should havePlanLike(
      """
        ...
        |+-----------------------+----------------+------+---------+-----------------+-------------------+----------------------+------------------+----------------------------------+
        || +ProduceResults       |              0 |    1 |       2 |               0 |                 0 |               0.0000 | anon[*], a, e   |                                  |
        || |                     +----------------+------+---------+-----------------+-------------------+----------------------+------------------+----------------------------------+
        || +Filter               |              0 |    1 |       9 |               0 |                 0 |               0.0000 | anon[*], a, e   | a:From; a.name = {  AUTOSTRING0} |
        || |                     +----------------+------+---------+-----------------+-------------------+----------------------+------------------+----------------------------------+
        || +VarLengthExpand(All) |              0 |    4 |      18 |               0 |                 0 |               0.0000 | anon[*], a -- e | (e)<-[:*..4]-(a)                 |
        || |                     +----------------+------+---------+-----------------+-------------------+----------------------+------------------+----------------------------------+
  ...
  test("Plan should have right relationship direction other direction") {
    ...
    result should havePlanLike(
      """
        ...
        || +ProduceResults       |              0 |    1 |       2 |               0 |                 0 |               0.0000 | anon[*], a, e   |                                |
        || |                     +----------------+------+---------+-----------------+-------------------+----------------------+------------------+--------------------------------+
        || +Filter               |              0 |    1 |       9 |               0 |                 0 |               0.0000 | anon[*], a, e   | e:To; e.name = {  AUTOSTRING1} |
        || |                     +----------------+------+---------+-----------------+-------------------+----------------------+------------------+--------------------------------+
        || +VarLengthExpand(All) |              0 |    4 |      18 |               0 |                 0 |               0.0000 | anon[*], e -- a | (a)-[:*..4]->(e)               |
        || |                     +----------------+------+---------+-----------------+-------------------+----------------------+------------------+--------------------------------+
