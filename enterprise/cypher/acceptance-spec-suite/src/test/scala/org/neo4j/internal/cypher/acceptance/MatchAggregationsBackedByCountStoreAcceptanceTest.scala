...
class MatchAggregationsBackedByCountStoreAcceptanceTest
  ...
  test("counts nodes using count store and projection expression with variable") {
    ...
    withModel(
              ...
              // When
              query = "MATCH (n) RETURN count(n)/2.0*5 as someNum",
              f = { result =>
                // Then
  ...
  test("counts relationships with type using count store with count(*)") {
    ...
    withRelationshipsModel(
                           ...
                           // When
                           query = "MATCH ()-[r:KNOWS]->() RETURN count(*)",
                           f = { result =>
                             // Then
  ...
  test("counts relationships with unspecified type and labeled source node using count store") {
    ...
    withRelationshipsModel(
                           ...
                           // When
                           query = "MATCH (:User)-[r]->() RETURN count(r)",
                           f = { result =>
                             // Then
                             result.columnAs("count(r)").toSet[Int] should equal(Set(1))
  ...
  test("counts relationships with type and labeled source node using count store") {
    ...
    withRelationshipsModel(
      // When
      query = "MATCH ()<-[r:KNOWS]-(:User) RETURN count(r)",
      f = { result =>
        // Then
        result.columnAs("count(r)").toSet[Int] should equal(Set(1))
  ...
  test("counts relationships with unspecified type and labeled destination node using count store") {
    ...
    withRelationshipsModel(
                           ...
                           // When
                           query = "MATCH ()-[r]->(:User) RETURN count(r)",
                           f = { result =>
                             // Then
                             result.columnAs("count(r)").toSet[Int] should equal(Set(1))
  ...
  test("counts relationships with type and labeled source and destination without using count store") {
    // Given
    withRelationshipsModel(
      expectedLogicalPlan = "NodeByLabelScan",
      // When
      query = "MATCH (:User)-[r:KNOWS]->(:User) RETURN count(r)",
      f = { result =>
        // Then
        result.columnAs("count(r)").toSet[Int] should equal(Set(1))
  ...
  test("counts relationships with unspecified type and labeled source and destination without using count store") {
    ...
    withRelationshipsModel(
      expectedLogicalPlan = "NodeByLabelScan",
      // When
      query = "MATCH (:User)-[r]->(:User) RETURN count(r)",
      f = { result =>
        // Then
        result.columnAs("count(r)").toSet[Int] should equal(Set(1))
  ...
  test("counts relationships with type, reverse direction and labeled source node using count store") {
    ...
    withRelationshipsModel(
      // When
      query = "MATCH (:User)<-[r:KNOWS]-() RETURN count(r)",
      f = { result =>
        // Then
        result.columnAs("count(r)").toSet[Int] should equal(Set(1))
  ...
  test("counts relationships with type, any direction and no labeled nodes without using count store") {
    // Given
    withRelationshipsModel(
      expectedLogicalPlan = "AllNodesScan",
      // When
      query = "MATCH ()-[r:KNOWS]-() RETURN count(r)",
      f = { result =>
        // Then
  ...
  test("counts labeled nodes using count store considering transaction state (test2)") {
    ...
    withModelAndTransaction(
      ...
      label2 = "User",
      // When
      query = "MATCH (n:Admin) RETURN count(n)",
      f = { result =>
        // Then
        result.columnAs("count(n)").toSet[Int] should equal(Set(1))
  ...
  test("counts nodes using count store and projection expression considering transaction state") {
    ...
    withModelAndTransaction(
      label1 = "Admin",
      // When
      query = "MATCH (n:User) RETURN count(n) > 1",
      f = { result =>
        // Then
  ...
  test("counts nodes using count store and projection expression with variable considering transaction state") {
    ...
    withModelAndTransaction(
                            ...
                            // When
                            query = "MATCH (n) RETURN count(n)/3*5 as someNum",
                            f = { result =>
                              // Then
  ...
  test("counts relationships with multiple types using count store considering transaction state") {
    ...
    withRelationshipsModelAndTransaction(
      ...
      type3 = "FRIEND_OF",
      // When
      query = "MATCH ()-[r:KNOWS|FOLLOWS]->() RETURN count(r)",
      f = { result =>
        // Then
        result.columnAs("count(r)").toSet[Int] should equal(Set(2))
  ...
  test(
    "counts relationships using count store and projection with expression and variable considering transaction state") {
    // Given
    withRelationshipsModelAndTransaction(

                                         // When
                                         query = "MATCH ()-[r]->() RETURN count(r)/3*5 as someNum",
                                         f = { result =>
                                           // Then
                                           result.columnAs("someNum").toSet[Int] should equal(Set(5))
...
//  MATCH (n:X)-[r:Y]->() WITH count(r) as rcount MATCH (n)-[r:Y]->() WHERE count(r) = rcount RETURN rcount, labels(n)
  ...
  test(
    "counts relationships with type, reverse direction and labeled source using count store considering transaction state") {
    // Given
    withRelationshipsModelAndTransaction(
      // When
      query = "MATCH (:User)<-[r:KNOWS]-() RETURN count(r)",
  ...
  test(
    "counts relationships with type, reverse direction and labeled destination using count store considering transaction state") {
    // Given
    withRelationshipsModelAndTransaction(
      // When
      query = "MATCH ()<-[r:KNOWS]-(:User) RETURN count(r)",
  ...
  test(
    "counts relationships with unspecified type and labeled destination using count store considering transaction state") {
    // Given
    withRelationshipsModelAndTransaction(
  ...
  test(
    "counts relationships with type and labeled source and destination without using count store considering transaction state") {
    // Given
    withRelationshipsModelAndTransaction(
      expectedLogicalPlan = "NodeByLabelScan",
      // When
  ...
  test(
    "counts relationships with unspecified type and labeled source and destination without using count store considering transaction state") {
    // Given
    withRelationshipsModelAndTransaction(
      expectedLogicalPlan = "NodeByLabelScan",
      // When
  ...
  test("count store on two unlabeled nodes") {
    ...
    withModel(
              ...
              // When
              query = "MATCH (n), (m) RETURN count(n)",
              f = { result =>
                // Then
  ...
  test("count store on one labeled node and one unlabeled") {
    ...
    withModel(
              ...
              // When
              query = "MATCH (n:User),(m) RETURN count(n)",
              f = { result =>
                // Then
  ...
  test("count store on one labeled node and one unlabeled and count(*)") {
    ...
    withModel(
              ...
              // When
              query = "MATCH (n:User),(m) RETURN count(*)",
              f = { result =>
                // Then
  ...
  test("count store on two labeled nodes") {
    ...
    withModel(
              ...
              // When
              query = "MATCH (n:User),(m:User) RETURN count(n)",
              f = { result =>
                // Then
  ...
  test("count store with many nodes") {
    ...
    withModel(
      // When
      query = "MATCH (n:User),(m),(o:User),(p) RETURN count(*)",
      f = { result =>
        // Then
  ...
  test("count store with many but odd number of nodes") {
    ...
    withModel(
      // When
      query = "MATCH (n:User),(m),(o:User),(p), (q) RETURN count(*)",
      f = { result =>
        // Then
  ...
  def withModel(label1: String = "User",
                ...
                query: String,
                f: InternalExecutionResult => Unit,
  ...
  private def verifyOnEmptyDatabase(expectedLogicalPlan: String,
                                    query: String,
                                    expectedResult: Set[Any],
                                    allRuntimes: Boolean): Unit = {
  ...
  def withModelAndTransaction(label1: String = "User",
    ...
    graph.inTx {
      ...
      executeWithCostPlannerAndInterpretedRuntimeOnly(s"""
  ...
  def withRelationshipsModelAndTransaction(label1: String = "User",
                                           ...
                                           expectedResultOnEmptyDatabase: Set[Any] = Set(0),
                                           allRuntimes: Boolean = false): Unit = {
    withModelAndTransaction(label1,
                            label2,
                            label3,
                            type1,
                            type2,
