...
class QueryPlanCompactionAcceptanceTest extends ExecutionEngineFunSuite with QueryStatisticsTestSupport
  ...
  test("Don't compact complex query") {
    val query =
      """EXPLAIN LOAD CSV WITH HEADERS FROM {csv_filename} AS line
        |MERGE (u1:User {login: line.user1})
        |MERGE (u2:User {login: line.user2})
        |CREATE (u1)-[:FRIEND]->(u2)""".stripMargin
    val result = executeWithCostPlannerAndInterpretedRuntimeOnly(query)
    result should havePlanLike(
      """+---------------------------+----------------+---------------------------+------------------------+
        ...
        || +Apply                    |              1 | u1 -- line, u2            |                        |
        || |\                        +----------------+---------------------------+------------------------+
        || | +ConditionalApply       |              1 | line, u2                  | IsNull(Variable(u2))   |
        || | |\                      +----------------+---------------------------+------------------------+
        ...
        || | | | |                   +----------------+---------------------------+------------------------+
        || | | | +NodeByLabelScan    |              1 | line, u2                  | :User                  |
        || | | |                     +----------------+---------------------------+------------------------+
        || | | +MergeLock(Exclusive) |              1 | line, u2                  |                        |
        || | | |                     +----------------+---------------------------+------------------------+
        || | | +Argument             |              1 | line, u2                  |                        |
        || | |                       +----------------+---------------------------+------------------------+
        || | +Apply                  |              1 | line, u2                  |                        |
        ...
        || +Apply                    |              1 | line, u1                  |                        |
        || |\                        +----------------+---------------------------+------------------------+
        || | +ConditionalApply       |              1 | line, u1                  | IsNull(Variable(u1))   |
        || | |\                      +----------------+---------------------------+------------------------+
        ...
        || | | | |                   +----------------+---------------------------+------------------------+
        || | | | +NodeByLabelScan    |              1 | line, u1                  | :User                  |
        || | | |                     +----------------+---------------------------+------------------------+
        || | | +MergeLock(Exclusive) |              1 | line, u1                  |                        |
        || | | |                     +----------------+---------------------------+------------------------+
        || | | +Argument             |              1 | line, u1                  |                        |
        || | |                       +----------------+---------------------------+------------------------+
        || | +Apply                  |              1 | line, u1                  |                        |
