...
import org.neo4j.graphdb.factory.GraphDatabaseSettings.temporal_nanosecond_precision
...
object Neo4jAdapter {
  def apply(executionPrefix: String,
            dbConfig: collection.Map[Setting[_], String] = Map[Setting[_], String]
              (cypher_hints_error -> "true", temporal_nanosecond_precision -> "9")): Neo4jAdapter = {
