...
object Methods {
  ...
  val nodeGetRelationshipsWithDirection = method[ReadOperations, RelationshipIterator.Resource]("nodeGetRelationships", typeRef[Long], typeRef[Direction])
  val nodeGetRelationshipsWithDirectionAndTypes = method[ReadOperations, RelationshipIterator.Resource]("nodeGetRelationships", typeRef[Long], typeRef[Direction], typeRef[Array[Int]])
  val allConnectingRelationships = method[CompiledExpandUtils, RelationshipIterator.Resource]("connectingRelationships", typeRef[ReadOperations], typeRef[Long], typeRef[Direction], typeRef[Long])
  val connectingRelationships = method[CompiledExpandUtils, RelationshipIterator.Resource]("connectingRelationships", typeRef[ReadOperations], typeRef[Long], typeRef[Direction], typeRef[Long], typeRef[Array[Int]])
