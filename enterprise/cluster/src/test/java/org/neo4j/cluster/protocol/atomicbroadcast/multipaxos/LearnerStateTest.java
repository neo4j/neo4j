...
public class LearnerStateTest
{
    ...
    public void shouldUseLastKnownOnlineClusterMemberAndSetTimeoutForCatchup() throws Throwable
    {
        ...
        ClusterInstanceId upToDateClusterMember = new ClusterInstanceId( 1 );

        // What we know
        when(ctx.getLastLearnedInstanceId()).thenReturn( 0l );
        when(ctx.getPaxosInstance( new InstanceId( 1l ) )).thenReturn( new PaxosInstance( null, new InstanceId( 1l )));
