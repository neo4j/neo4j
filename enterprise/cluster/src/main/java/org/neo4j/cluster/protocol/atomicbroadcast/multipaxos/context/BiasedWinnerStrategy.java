...
public class BiasedWinnerStrategy implements ElectionContextImpl.WinnerStrategy
{
    ...
    {
        List<Vote> eligibleVotes = ElectionContextImpl.removeIneligibleVotes( votes );
