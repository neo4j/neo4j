...
/**
 * A running Neo4j high availability graph database.
 */
public interface HighAvailabilityGraphDatabase extends GraphDatabase
{
    /**
     ...
     */
    abstract class Builder extends HighAvailabilityGraphDatabaseBuilder<Builder,HighAvailabilityGraphDatabase>
    {
