...
public class SwitchToSlaveOld extends SwitchToSlave
{
    private final LogService logService;

    public SwitchToSlaveOld( File storeDir,
    ...
    private SwitchToSlaveOld( File storeDir,
                              LogService logService,
                              Config config,
                              DependencyResolver resolver,
                              HaIdGeneratorFactory idGeneratorFactory,
    ...
    {
        stopServices();
        branchPolicy.handle( storeDir, logService );
    }
}
