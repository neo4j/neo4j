...
public class SwitchToSlave
{
    ...
    public SwitchToSlave( LogService logService, FileSystemAbstraction fileSystemAbstraction, ClusterMembers
            clusterMembers, Config config, DependencyResolver resolver,
                                      ...
                                      CancellationRequest cancellationRequest ) throws Throwable
    {
        ...
        new StoreCopyClient( config, kernelExtensions, logService.getUserLogProvider(), fileSystemAbstraction, pageCache, storeCopyMonitor ).copyStore(
