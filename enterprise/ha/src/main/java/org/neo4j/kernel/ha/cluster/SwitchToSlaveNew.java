...
import static org.neo4j.kernel.ha.cluster.SwitchToSlave.SERVICES_TO_RESTART_FOR_STORE_COPY;
import static org.neo4j.kernel.impl.transaction.log.TransactionIdStore.BASE_TX_ID;

public class SwitchToSlaveNew extends SwitchToSlave
{
    private final LogService logService;

    public SwitchToSlaveNew( File storeDir,
    ...
    SwitchToSlaveNew( File storeDir,
                      LogService logService,
                      Config config,
                      DependencyResolver resolver,
                      HaIdGeneratorFactory idGeneratorFactory,
