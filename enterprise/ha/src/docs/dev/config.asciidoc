...
If you are running Neo4j server, specify +org.neo4j.server.database.mode=HA+ in _conf/neo4j.conf_.

include::{importdir}/neo4j-server-enterprise-docs-jar/ops/configuration-attributes.asciidoc[]

== Database configuration ==

HA configuration parameters should be supplied alongside general Neo4j parameters in _conf/neo4j.conf_.
