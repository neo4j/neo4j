...
You also have to make sure that all but one instance have the +ha.allow_init_cluster+ setting to +false+ -- the machine that has it set to true should be the one that is to become the new master.
