...
{
    public static final File PATH = new File( "var/man/db4" );
    static final String ME = "127.0.0.1:5562";
    ...
    private static GraphDatabaseService startDb() throws IOException
    {
        return new EnterpriseGraphDatabaseFactory().newHighlyAvailableDatabaseBuilder( PATH.getPath() ).
                setConfig( HaSettings.server_id, "4" ).
                ...
                setConfig( ShellSettings.remote_shell_port, "1340" ).
                ...
                setConfig( OnlineBackupSettings.online_backup_port, ""+Server.DEFAULT_BACKUP_PORT+3 ).
                newGraphDatabase();
    }
}
