...
abstract class HighAvailabilityTestGraphDatabaseBuilder<BUILDER extends HighAvailabilityTestGraphDatabaseBuilder<BUILDER>>
        extends HighAvailabilityGraphDatabaseBuilder<BUILDER,HighAvailabilityTestGraphDatabase>
{
    ...
    public HighAvailabilityTestGraphDatabaseBuilder withInternalLogProvider( LogProvider logProvider )
    {
    ...
    @Override
    protected HighAvailabilityTestGraphDatabase newInstance(
            File storeDir,
    ...
    )
    {
        ...
        return new EnterpriseHighAvailabilityTestGraphDatabase.GraphDatabaseImpl( facadeFactory, storeDir, params, dependencies );
    }
}
