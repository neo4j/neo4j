...
public class HaIdGeneratorFactoryTest
{
    ...
    public void shouldDeleteIdGeneratorsAsPartOfSwitchingToSlave() throws Exception
    {
        ...
        IdGenerator idGenerator = fac.open( idFile, 10, IdType.NODE, 10, StandardV3_0_7.RECORD_FORMATS.node().getMaxId() );
    ...
    {
        fac.switchToSlave();
        IdGenerator gen = fac.open( new File( "someFile" ), 10, IdType.NODE, 1, StandardV3_0_7.RECORD_FORMATS.node().getMaxId() );
