...
public class HaIdGeneratorFactoryTest
{
    ...
    public void shouldDeleteIdGeneratorsAsPartOfSwitchingToSlave() throws Exception
    {
        ...
        IdGenerator idGenerator = fac.open( idFile, 10, IdType.NODE, 10, LowLimitV3_0.RECORD_FORMATS.node().getMaxId() );
    ...
    {
        fac.switchToSlave();
        IdGenerator gen = fac.open( new File( "someFile" ), 10, IdType.NODE, 1, LowLimitV3_0.RECORD_FORMATS.node().getMaxId() );
