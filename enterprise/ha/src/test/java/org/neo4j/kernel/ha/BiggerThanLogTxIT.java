...
public class BiggerThanLogTxIT extends AbstractClusterTest
{
    ...
    private void assertAllMembersHasNodeCount( int expectedNodeCount )
    {
        ...
        {
            assertEquals( expectedNodeCount, count( GlobalGraphOperations.at( db ).getAllNodes() ) );
        }
    }
