...
import org.neo4j.kernel.ha.cluster.SwitchToSlaveNew;
...
public class HighAvailabilityModeSwitcherTest
{
    ...
    public void shouldReswitchToSlaveIfNewMasterBecameElectedAndAvailableDuringSwitch() throws Throwable
    {
        ...
        ClusterMemberAvailability availability = mock( ClusterMemberAvailability.class );
        SwitchToSlaveNew switchToSlave = mock( SwitchToSlaveNew.class );
    ...
    public void shouldPerformForcedElections()
    {
        ...
        HighAvailabilityModeSwitcher modeSwitcher = new HighAvailabilityModeSwitcher( mock( SwitchToSlaveNew.class ),
    ...
    public void shouldUseProperServerIdWhenDemotingFromMasterOnException() throws Throwable
    {
         ...
         */
        // Given
        SwitchToSlaveNew sts = mock( SwitchToSlaveNew.class );
    ...
    {
        return new HighAvailabilityModeSwitcher( mock( SwitchToSlaveNew.class ), mock( SwitchToMaster.class ),
                mock( Election.class ), availability, mock( ClusterClient.class ), storeSupplierMock(),
                mock( InstanceId.class ), new ComponentSwitcherContainer(), neoStoreDataSourceSupplierMock(),
                NullLogService.getInstance() );
    }
