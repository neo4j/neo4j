...
public class MandatoryRelationshipPropertyConstraintHaIT extends ConstraintHaIT
{
    @Override
    protected void createConstraint( GraphDatabaseService db, String type, String propertyKey )
    {
        db.schema().constraintFor( withName( type ) ).assertPropertyExists( propertyKey ).create();
    }
