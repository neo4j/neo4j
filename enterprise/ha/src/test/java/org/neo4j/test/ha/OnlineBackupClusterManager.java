...
public class OnlineBackupClusterManager extends ClusterManager
{
    ...
    {
        OnlineBackupManagedCluster( Cluster spec ) throws URISyntaxException, IOException
        {
            super( spec );
        }

        @Override
        protected void startMember( InstanceId serverId ) throws URISyntaxException, IOException
        {
