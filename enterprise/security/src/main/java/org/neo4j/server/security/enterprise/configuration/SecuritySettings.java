...
public class SecuritySettings
{
    ...
    @Description( "The security provider that contains the users and roles used for authentication and authorization. " +
    ...
    public static Setting<String> active_realm =
            setting( "dbms.security.provider", STRING, NATIVE_REALM_NAME );

    @Description( "A list of security providers containing the users and roles used for authentication and " +
    ...
    public static Setting<List<String>> active_realms =
            derivedSetting( "dbms.security.providers", active_realm,
    ...
    public static final Setting<Boolean> native_authentication_enabled =
            derivedSetting( "dbms.security.providers.native.authentication_enabled", active_realms,
    ...
    public static final Setting<Boolean> native_authorization_enabled =
            derivedSetting( "dbms.security.providers.native.authorization_enabled", active_realms,
                    ( providers ) -> providers.contains( NATIVE_REALM_NAME ), BOOLEAN );
    ...
    public static final Setting<Boolean> ldap_authentication_enabled =
            derivedSetting( "dbms.security.providers.ldap.authentication_enabled", active_realms,
    ...
    public static final Setting<Boolean> ldap_authorization_enabled =
            derivedSetting( "dbms.security.providers.ldap.authorization_enabled", active_realms,
                    ( providers ) -> providers.contains( LDAP_REALM_NAME ), BOOLEAN );
    ...
    public static final Setting<Boolean> plugin_authentication_enabled =
            derivedSetting( "dbms.security.providers.plugin.authentication_enabled", active_realms,
    ...
    public static final Setting<Boolean> plugin_authorization_enabled =
            derivedSetting( "dbms.security.providers.plugin.authorization_enabled", active_realms,
                    ( providers ) -> providers.stream().anyMatch( ( r ) -> r.startsWith( PLUGIN_REALM_NAME_PREFIX ) ),
                    BOOLEAN );
    ...
    public static final Setting<String> ldap_server =
            setting( "dbms.security.providers.ldap.host", STRING, "0.0.0.0:389" );
    ...
    public static final Setting<Boolean> ldap_use_starttls =
            setting( "dbms.security.providers.ldap.use_starttls", BOOLEAN, "false" );
    ...
    public static final Setting<String> ldap_auth_mechanism =
            setting( "dbms.security.providers.ldap.auth_mechanism", STRING, "simple" );
    ...
    public static final Setting<String> ldap_referral =
            setting( "dbms.security.providers.ldap.referral", STRING, "follow" );
    ...
    public static final Setting<String> ldap_user_dn_template =
            setting( "dbms.security.providers.ldap.user_dn_template", STRING, "uid={0},ou=users,dc=example,dc=com" );
    ...
    @Description( "Determines if the result of authentication via the LDAP server should be cached or not. " +
                  ...
                  "(see `dbms.security.providers.auth_cache_ttl`).\n" +
    ...
    public static final Setting<Boolean> ldap_authentication_cache_enabled =
            setting( "dbms.security.providers.ldap.authentication_cache_enabled", BOOLEAN, "true" );
    ...
    public static final Setting<Boolean> ldap_authorization_use_system_account =
            setting( "dbms.security.providers.ldap.authorization.use_system_account", BOOLEAN, "false" );

    @Description(
            "An LDAP system account username to use for authorization searches when " +
            "`dbms.security.providers.ldap.authorization.use_system_account` is `true`. " +
            "Note that the `dbms.security.providers.ldap.user_dn_template` will not be applied to this username, " +
            "so you may have to specify a full DN." )
    public static final Setting<String> ldap_system_username =
            setting( "dbms.security.providers.ldap.system_username", STRING, NO_DEFAULT );
    ...
    public static final Setting<String> ldap_system_password =
            setting( "dbms.security.providers.ldap.system_password", STRING, NO_DEFAULT );
    ...
    public static Setting<String> ldap_authorization_user_search_base =
            setting( "dbms.security.providers.ldap.authorization.user_search_base", STRING, NO_DEFAULT );
    ...
    public static Setting<String> ldap_authorization_user_search_filter =
            setting( "dbms.security.providers.ldap.authorization.user_search_filter", STRING, "(&(objectClass=*)(uid={0}))" );
    ...
    public static Setting<List<String>> ldap_authorization_group_membership_attribute_names =
            setting( "dbms.security.providers.ldap.authorization.group_membership_attributes", STRING_LIST, "memberOf" );
    ...
    public static Setting<String> ldap_authorization_group_to_role_mapping =
            setting( "dbms.security.providers.ldap.authorization.group_to_role_mapping", STRING, NO_DEFAULT );
    ...
    public static Setting<Long> auth_cache_ttl =
            setting( "dbms.security.providers.auth_cache_ttl", DURATION, "10m" );
    ...
    public static Setting<Integer> auth_cache_max_capacity =
            setting( "dbms.security.providers.auth_cache_max_capacity", INTEGER, "10000" );
