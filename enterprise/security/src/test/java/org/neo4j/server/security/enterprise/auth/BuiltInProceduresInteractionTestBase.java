...
public abstract class BuiltInProceduresInteractionTestBase<S> extends ProcedureInteractionTestBase<S>
{
    ...
    public void shouldCreateLabel()
    {
        ...
        assertFail( writeSubject, "CALL db.createLabel('MySpecialLabel')", SCHEMA_OPS_NOT_ALLOWED );
    ...
    public void shouldCreateRelationshipType()
    {
        ...
        assertFail( writeSubject, "CALL db.createRelationshipType('MySpecialRelationship')", SCHEMA_OPS_NOT_ALLOWED );
    ...
    public void shouldCreateProperty()
    {
        ...
        assertFail( writeSubject, "CALL db.createProperty('MySpecialProperty')", SCHEMA_OPS_NOT_ALLOWED );
