...
class NeoShallowEmbeddedTestBase extends AuthProcedureTestBase<EnterpriseAuthSubject>
{
    @Override
    ...
    class Interaction implements NeoInteractionLevel<EnterpriseAuthSubject>
    {
        private GraphDatabaseAPI db;
        private MultiRealmAuthManager manager;
        private EnterpriseUserManager userManager;

        Interaction() throws Throwable
        {
