...
public class MultiRealmAuthManagerTest
{
    ...
    public void setUp() throws Throwable
    {
        ...
        InternalFlatFileRealm internalFlatFileRealm =
                new InternalFlatFileRealm( users, roles, passwordPolicy, authStrategy );
        logProvider = new AssertableLogProvider();
        Log log = logProvider.getLog( this.getClass() );
        manager = new MultiRealmAuthManager( internalFlatFileRealm, singleton( internalFlatFileRealm ), log );
        manager.init();
    ...
    public void shouldReturnTooManyAttemptsWhenThatIsAppropiate() throws Throwable
    {
        ...
        logProvider.assertExactly( error( "Login failed for user `%s` - too many failed attempts.", "jake" ) );
    }
    ...
    public void shouldFailAuthenticationIfUserIsNotFound() throws Throwable
    {
        ...
        logProvider.assertExactly( error( "Login failed for user `%s`", "unknown" ) );
    }
    ...
    public void shouldSetPasswordThroughAuthSubject() throws Throwable
    {
        ...
        assertThat( authSubject.getAuthenticationResult(), equalTo( AuthenticationResult.SUCCESS ) );
        logProvider.assertExactly( info( "Login success for user `%s`", "neo" ) );
    }
