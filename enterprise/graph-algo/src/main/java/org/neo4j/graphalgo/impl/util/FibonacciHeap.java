...
public class FibonacciHeap<KeyType>
{
    ...
    // debug
    // public void validateDegrees( FibonacciHeapNode node )
    // {
    // FibonacciHeapNode listNode;
    // if ( node == null )
    // {
    // listNode = minimum;
    // }
    ...
    // }
    // int d = 1;
    // for ( FibonacciHeapNode n = listNode.right; !listNode.equals( n ); n =
    // n.right )
    // {
    // ++d;
    // }
    // if ( node.degree != d )
    // {
    // System.out.println( "Inconsistent degree: " + node.degree + " "
    // + d );
    // }
    // }
    // // validate list
