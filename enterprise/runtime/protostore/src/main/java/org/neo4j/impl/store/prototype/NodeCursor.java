...
public abstract class NodeCursor<Store extends Read> extends ReadCursor implements org.neo4j.impl.kernel.api.NodeCursor
{
    protected final Store store;

    protected NodeCursor( Store store )
    {
        this.store = store;
    }
