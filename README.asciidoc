...
NOTE: This GitHub repository contains mixed licenses. Our Community edition (in the link:community/[community/] directory) is GPLv3. Our Enterprise edition (link:enterprise/[enterprise/]) is differently licensed under the Neo4j Sweden Software License.
