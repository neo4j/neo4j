...
* You may need to increase the memory available to Maven: `export MAVEN_OPTS="-Xmx512m -XX:MaxPermSize=256m"` - please note that does _not_ give extra memory to test runners.
