...
public class TraverserFunctionalTest extends FunctionalTestBase
{
    ...
    {
        return Client.create().resource( nodeUri( node ) + "/traverse/node" ).accept( MediaType.APPLICATION_JSON_TYPE ).entity(
