...
public class IndexNodeFunctionalityTest {
    ...
    public void shouldRespondWith201CreatedWhenIndexingNode() throws DatabaseBlockedException {
        ...
        String key = "key";
        String value = "value";
        ClientResponse response = Client.create().resource(FunctionalTestUtil.indexUri() + "/node/" + key + "/" + value).type(MediaType.TEXT_PLAIN_TYPE)
                .entity(FunctionalTestUtil.nodeUri(nodeId)).post(ClientResponse.class);
    ...
    public void shouldGetNodeRepresentationFromIndexUri() throws DatabaseBlockedException {
        ...
        ClientResponse response = Client.create().resource(FunctionalTestUtil.indexUri() + "/node/" + key + "/" + value).type(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON).entity(JsonHelper.createJsonFrom(FunctionalTestUtil.nodeUri(nodeId))).post(ClientResponse.class);
    ...
    public void shouldGet404WhenRequestingIndexUriWhichDoesntExist() throws DatabaseBlockedException {
        ...
        String key = "key3";
        String value = "value";
        String indexUri = FunctionalTestUtil.indexUri() + "/node/" + key + "/" + value + "/" + nodeId;
    ...
    public void shouldGet404WhenRequestingIndexUriForNonExistingNode() {
        String key = "key3";
        String value = "value";
        String indexUri = FunctionalTestUtil.indexUri() + "/node/" + key + "/" + value + "/" + 999999;
        ClientResponse response = Client.create().resource(indexUri).accept(MediaType.APPLICATION_JSON).get(ClientResponse.class);
        assertEquals(Status.NOT_FOUND.getStatusCode(), response.getStatus());
    }
    ...
    public void shouldGet200AndArrayOfNodeRepsWhenGettingFromIndex() {
        ...
        String location1 = Client.create().resource(FunctionalTestUtil.nodeUri()).accept(MediaType.APPLICATION_JSON).entity("{\"name\":\"" + name1 + "\"}",
                MediaType.APPLICATION_JSON).post(ClientResponse.class).getHeaders().getFirst(HttpHeaders.LOCATION);
        String location2 = Client.create().resource(FunctionalTestUtil.nodeUri()).accept(MediaType.APPLICATION_JSON).entity("{\"name\":\"" + name2 + "\"}",
                MediaType.APPLICATION_JSON).post(ClientResponse.class).getHeaders().getFirst(HttpHeaders.LOCATION);
        String indexLocation1 = Client.create().resource(FunctionalTestUtil.indexUri() + "/node/" + key + "/" + value).entity(
        ...
        String indexLocation2 = Client.create().resource(FunctionalTestUtil.indexUri() + "/node/" + key + "/" + value).entity(
        ...
        ClientResponse response = Client.create().resource(FunctionalTestUtil.indexUri() + "/node/" + key + "/" + value).accept(MediaType.APPLICATION_JSON)
    ...
    public void shouldGet200WhenGettingNodesFromIndexWithNoHits() {
        ClientResponse response = Client.create().resource(FunctionalTestUtil.indexUri() + "/node/non-existent-key/non-existent-value").accept(
    ...
    public void shouldGet200AndBeAbleToRemoveIndexing() throws DatabaseBlockedException {
        ClientResponse response = Client.create().resource(FunctionalTestUtil.nodeUri()).type(MediaType.APPLICATION_FORM_URLENCODED).accept(
                MediaType.APPLICATION_JSON).post(ClientResponse.class);
        String nodeUri = response.getHeaders().getFirst(HttpHeaders.LOCATION);
        String key = "key_remove";
        String value = "value";
        String indexUri = Client.create().resource(FunctionalTestUtil.indexUri() + "/node/" + key + "/" + value).entity(JsonHelper.createJsonFrom(nodeUri),
                MediaType.APPLICATION_JSON).post(ClientResponse.class).getHeaders().getFirst(HttpHeaders.LOCATION);
    ...
    public void shouldBeAbleToIndexValuesContainingSpaces() throws Exception {
        ...
        ClientResponse response = Client.create().resource(FunctionalTestUtil.indexUri("node", key, value)).entity(
                JsonHelper.createJsonFrom(FunctionalTestUtil.nodeUri(nodeId)), MediaType.APPLICATION_JSON).post(ClientResponse.class);
