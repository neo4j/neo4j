...
:console
"%_WRAPPER_EXE%" -c %_WRAPPER_CONF% wrapper.app.parameter.1=%2 wrapper.app.parameter.2={{TestWrapperBat}}
goto :eof

:start
"%_WRAPPER_EXE%" -t %_WRAPPER_CONF% wrapper.app.parameter.1=%2 wrapper.app.parameter.2={{TestWrapperBat}}
goto :eof

:pause
"%_WRAPPER_EXE%" -a %_WRAPPER_CONF% wrapper.app.parameter.1=%2 wrapper.app.parameter.2={{TestWrapperBat}}
goto :eof

:resume
"%_WRAPPER_EXE%" -e %_WRAPPER_CONF% wrapper.app.parameter.1=%2 wrapper.app.parameter.2={{TestWrapperBat}}
goto :eof

:stop
"%_WRAPPER_EXE%" -p %_WRAPPER_CONF% wrapper.app.parameter.1=%2 wrapper.app.parameter.2={{TestWrapperBat}}
goto :eof

:install
"%_WRAPPER_EXE%" -i %_WRAPPER_CONF% wrapper.app.parameter.1=%2 wrapper.app.parameter.2={{TestWrapperBat}}
goto :eof

:remove
"%_WRAPPER_EXE%" -r %_WRAPPER_CONF% wrapper.app.parameter.1=%2 wrapper.app.parameter.2={{TestWrapperBat}}
goto :eof
