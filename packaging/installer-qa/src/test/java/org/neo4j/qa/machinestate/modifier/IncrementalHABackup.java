...
public class IncrementalHABackup implements MachineModifier {

    private String name;
    private ZookeeperClusterDescription zkCluster;

    public IncrementalHABackup(String name,
            ZookeeperClusterDescription zkCluster)
    {
        this.name = name;
    ...
    public void modify(Neo4jDriver driver, StateRegistry state)
    {
        ...
        {
            ((EnterpriseDriver) driver).performIncrementalHABackup(name,
