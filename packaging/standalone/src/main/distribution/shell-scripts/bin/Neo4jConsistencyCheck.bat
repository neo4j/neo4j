...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="neo4j-consistency-check" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" org.neo4j.consistency.ConsistencyCheckTool %CMD_LINE_ARGS%
