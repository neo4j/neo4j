...
.EXAMPLE
'C:\Neo4j\neo4j-community' | Set-Neo4jSetting -ConfigurationFile 'neo4j.conf' -Name 'dbms.auto_index.nodes.enabled' -Value 'false'

Set dbms.auto_index.nodes.enabled=false in the neo4j.conf file for the Neo4j installation at C:\Neo4j\neo4j-community
