...
Per default, the Neo4j Enterprise Server edition do not allow remote JMX connections, since the relevant options in the 'conf/neo4j-wrapper.conf' configuration file are commented out.
...
.Neo4j MBeans View
image::jconsole_beans.png[scaledwidth="100%",alt="Neo4j MBeans view"]
