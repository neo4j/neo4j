...
public class SetNodePropertiesFunctionalTest extends FunctionalTestBase
{
    ...
    private ClientResponse updateNodePropertiesOnServer(
    ...
    private ClientResponse setNodePropertyOnServer( String key,
