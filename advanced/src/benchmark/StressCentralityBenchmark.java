...
public class StressCentralityBenchmark extends NeoAlgoBenchmark
{
    public static void main( String args[] )
    {
        // hack to avoid static
        new StressCentralityBenchmark().neoAlgoBenchMarkRun();
    }
    ...
    {
        return "StressCentralityBenchmark";
    }
    ...
    protected void runBenchMark()
    {
        ...
        new StressCentrality<Integer>( singleSourceShortestPath, graph2
            .getNodes() ).calculate();
        tx.finish();
    }
