...
public class TestNeoConstrains extends AbstractNeoTestCase
{
	...
	public void setUp()
	{
		...
		Logger log = Logger.getLogger( 
			"org.neo4j.impl.persistence.PersistenceLayerMonitor" );
		level1 = log.getLevel();
	...
	public void testDeleteNodeWithRel3()
	{
		...
		Node node1 = getNeo().createNode();
		Node node2 = getNeo().createNode();
		Relationship rel0 = node0.createRelationshipTo( node1, 
			MyRelTypes.TEST );
		Relationship rel1 = node0.createRelationshipTo( node2, 
				MyRelTypes.TEST );
		node1.delete();
		rel0.delete();
		Transaction tx = getTransaction();
