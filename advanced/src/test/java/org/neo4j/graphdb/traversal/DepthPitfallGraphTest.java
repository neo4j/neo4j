...
public class DepthPitfallGraphTest extends AbstractTestBase
{
    ...
    {
        Traverser traversal = new TraversalDescription().traverse( referenceNode() );
        int count = 0;
    ...
    {
        testAllNodesAreReturnedOnce( new TraversalDescription().depthFirst() );
    }

    @Test
    public void testAllNodesAreReturnedOnceBreadthFirst() throws Exception
    {
        testAllNodesAreReturnedOnce( new TraversalDescription().breadthFirst() );
    }
            ...
            throws Exception
    {
        testNodesAreReturnedOnceWhenSufficientRecentlyUnique(
                new TraversalDescription().depthFirst() );
    }
    ...
    {
        testNodesAreReturnedOnceWhenSufficientRecentlyUnique(
                new TraversalDescription().breadthFirst() );
    }
    ...
    public void testAllRelationshipsAreReturnedOnceDepthFirst()
            throws Exception
    {
        testAllRelationshipsAreReturnedOnce( new TraversalDescription().depthFirst() );
    }
    ...
    public void testAllRelationshipsAreReturnedOnceBreadthFirst()
            throws Exception
    {
        testAllRelationshipsAreReturnedOnce( new TraversalDescription().breadthFirst() );
    }

    private void testAllRelationshipsAreReturnedOnce(
            TraversalDescription description ) throws Exception
    {
        Traverser traverser = new TraversalDescription().uniqueness(
    ...
    {
        testAllUniqueNodePathsAreReturned( new TraversalDescription().depthFirst() );
    }

    @Test
    public void testAllUniqueNodePathsAreReturnedBreadthFirst() throws Exception
    {
        testAllUniqueNodePathsAreReturned( new TraversalDescription().breadthFirst() );
    }
    ...
    {
        testAllUniqueRelationshipPathsAreReturned( new TraversalDescription().depthFirst() );
    }

    @Test
    public void testAllUniqueRelationshipPathsAreReturnedBreadthFirst() throws Exception
    {
        testAllUniqueRelationshipPathsAreReturned( new TraversalDescription().breadthFirst() );
    }
    ...
    {
        canPruneTraversalAtSpecificDepth( new TraversalDescription().depthFirst() );
    }

    @Test
    public void canPruneTraversalAtSpecificDepthBreadthFirst()
    {
        canPruneTraversalAtSpecificDepth( new TraversalDescription().breadthFirst() );
    }
    
    private void canPruneTraversalAtSpecificDepth( TraversalDescription description )
    {
        Traverser traverser = description.uniqueness(
                Uniqueness.NONE ).prune( new PruneAfterDepth( 1 ) ).traverse(
                referenceNode() );
    ...
    {
        canPreFilterNodes( new TraversalDescription().depthFirst() );
    }

    @Test
    public void canPreFilterNodesBreadthFirst()
    {
        canPreFilterNodes( new TraversalDescription().breadthFirst() );
    }
    
    private void canPreFilterNodes( TraversalDescription description )
    {
        Traverser traverser = description.uniqueness(
                Uniqueness.NONE ).prune( new PruneAfterDepth( 2 ) ).filter(
                new ReturnFilter()
                {
