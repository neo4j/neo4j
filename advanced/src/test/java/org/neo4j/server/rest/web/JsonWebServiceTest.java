...
public class JsonWebServiceTest
{
    ...
    public void shouldBeAbleToIndexNode() throws DatabaseBlockedException, BadInputException
    {
        ...
        String key = "key";
        String value = "value";
        response = service.jsonAddToNodeIndex( "node", key, value, JsonHelper.createJsonFrom( nodeUri.toString() ) );
        assertEquals( 201, response.getStatus() );
    ...
    public void shouldBeAbleToGetRelationshipRepresentationFromIndexUri() throws DatabaseBlockedException, JsonParseException
    {
        ...
        Response response = service.jsonAddToRelationshipIndex( indexName, key, value, JsonHelper.createJsonFrom( BASE_URI + "node/"
                + relationshipId ) );
    ...
    public void shouldBeAbleToGetNodeRepresentationFromIndexUri() throws DatabaseBlockedException, JsonParseException
    {
        ...
        String value = "value";
        long nodeId = helper.createNode();
        Response response = service.jsonAddToNodeIndex( "node", key, value, JsonHelper.createJsonFrom( BASE_URI + "node/"
                + nodeId ) );
        response = service.jsonGetObjectFromNodeIndexUri( "node", key, value, nodeId );
        assertEquals( 200, response.getStatus() );
        assertEquals( response.getMetadata().getFirst( HttpHeaders.CONTENT_ENCODING ), "UTF-8" );
        assertNull( response.getMetadata().get( "Location" ) );
        Map<String, Object> map = JsonHelper.jsonToMap( entityAsString( response ) );
    ...
    public void shouldBeAbleToGetListOfNodeRepresentationsFromIndexLookup() throws DatabaseBlockedException, BadInputException
    {
        ...
        URI indexLocation1 = (URI) service.jsonAddToNodeIndex( indexName, key, value, JsonHelper.createJsonFrom( location1.toString() ) ).getMetadata().getFirst(
                "Location" );
        URI indexLocation2 = (URI) service.jsonAddToNodeIndex( indexName, key, value, JsonHelper.createJsonFrom( location2.toString() ) ).getMetadata().getFirst(
                "Location" );
    ...
    public void shouldGet200AndEmptyListWhenNothingFoundInIndexLookup() throws DatabaseBlockedException, BadInputException
    {
        ...
        Response response = service.jsonGetIndexedNodes( indexName, "fooo", "baaar" );
        assertEquals( Status.OK.getStatusCode(), response.getStatus() );
        assertEquals( response.getMetadata().getFirst( HttpHeaders.CONTENT_ENCODING ), "UTF-8" );
        String entity = entityAsString( response );
    ...
    public void shouldBeAbleToRemoveNodeFromIndex() throws DatabaseBlockedException
    {
        ...
        Response response = service.jsonRemoveFromNodeIndex( "node", key, value, nodeId );
    ...
    public void shouldBeAbleToRemoveRelationshipFromIndex() throws DatabaseBlockedException
    {
        long startNodeId = helper.createNode();
        long endNodeId = helper.createNode();
        String relationshipName = "special";
        String indexName = "friendships";
        long relationshipId = helper.createRelationship( relationshipName, startNodeId, endNodeId );
        ...
        Response response = service.jsonRemoveFromRelationshipIndex( indexName, key, value, relationshipId );
        assertEquals( Status.NO_CONTENT.getStatusCode(), response.getStatus() );
    ...
    {
        Response response = service.jsonRemoveFromNodeIndex( "node", "bogus", "bogus", 999999 );
    ...
    {
        Response response = service.jsonRemoveFromRelationshipIndex( "rel", "bogus", "bogus", 999999 );
        assertEquals( Status.NOT_FOUND.getStatusCode(), response.getStatus() );
    }
    ...
    public void shouldBeAbleToParseJsonEvenWithUnicodeMarkerAtTheStart() throws DatabaseBlockedException, BadInputException
    {
        ...
        assertEquals( Status.CREATED.getStatusCode(), service.jsonAddToNodeIndex( "node", "foo", "bar",
