...
(function() {
  ...
  */  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
  ...
  define(['neo4j/webadmin/data/ItemUrlResolver', 'neo4j/webadmin/templates/databrowser/createRelationship', 'lib/backbone'], function(ItemUrlResolver, template) {
    ...
    return CreateRelationshipDialog = (function() {
      ...
      CreateRelationshipDialog.prototype.save = function() {
        var fromId, fromUrl, toId, toUrl, type;
        ...
        return this.server.rel(fromUrl, type, toUrl).then(__bind(function(relationship) {
          var id;
