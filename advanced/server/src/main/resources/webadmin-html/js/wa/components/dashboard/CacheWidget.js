 ...
 *            10000.
 */
wa.components.dashboard.CacheWidget = function(server,
		interval) {
	...
	me.api = {
		...
		render : function() {
			...
			if ( ! me.uiLoaded ) {
				me.uiLoaded = true;
				me.ui.setTemplateURL("templates/components/monitor/CacheWidget.tp");
			}
	...
	me.tracker = wa.components.dashboard.JmxValueTracker(me.server,
			"neo4j","Cache", me.extractor, me.valueChanged,
			interval || 10000);
