...
To build the Neo4j Browser module, you need to have Node.js installed. For skipping that part of the build, see below.
...
* To skip building the browser module, use `-DskipBrowser`
