...
|Upgrading
|
With Neo4j 2.0 several Cypher features in ersion 1.9 have been deprecated or removed.
...
* To still use the older syntax, prepend you Cypher statement with `CYPHER 1.9`.
|===
