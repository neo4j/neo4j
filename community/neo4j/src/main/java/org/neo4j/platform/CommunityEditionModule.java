...
import static org.neo4j.server.security.auth.CommunitySecurityModule.COMMUNITY_SECURITY_MODULE_ID;
...
public class CommunityEditionModule extends EditionModule
{
    ...
    public static Predicate<String> communityFileWatcherFileNameFilter()
    {
