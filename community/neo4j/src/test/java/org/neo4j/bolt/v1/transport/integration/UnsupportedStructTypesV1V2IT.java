...
public class UnsupportedStructTypesV1V2IT extends AbstractBoltTransportsTest
{
    ...
    public void shouldFailWhenNullKeyIsSentWithInit() throws Exception
    {
        ...
        MatcherAssert.assertThat( connection, util.eventuallyReceives(
                MessageMatchers.msgFailure( Status.Request.Invalid, "Value `null` is not supported as key in maps, must be a non-nullable string." ) ) );
    ...
    public void shouldFailWhenDuplicateKeyIsSentWithInit() throws Exception
    {
        ...
        MatcherAssert.assertThat( connection, util.eventuallyReceives( MessageMatchers.msgFailure( Status.Request.Invalid, "Duplicate map key `key1`." ) ) );
        MatcherAssert.assertThat( connection, TransportTestUtil.eventuallyDisconnects() );
    }
    ...
    private void testFailureWithV1Value( AnyValue value, String description ) throws Exception
    {
        ...
        MatcherAssert.assertThat( connection, util.eventuallyReceives(
                MessageMatchers.msgFailure( Status.Statement.TypeError, description + " values cannot be unpacked with this version of bolt." ) ) );
        MatcherAssert.assertThat( connection, TransportTestUtil.eventuallyDisconnects() );
    }
