...
public class BoltConnectionAuthIT
{
    ...
    public void shouldGiveCredentialsExpiredStatusOnExpiredCredentials() throws Throwable
    {
        ...
        // Then
        MatcherAssert.assertThat( recorder.nextResponse(), BoltMatchers.succeededWithMetadata( "credentials_expired", TRUE ) );
        MatcherAssert.assertThat( recorder.nextResponse(), BoltMatchers.failedWithStatus( Status.Security.CredentialsExpired ) );
    }
    ...
    public void shouldGiveKernelVersionOnInit() throws Throwable
    {
        ...
        // Then
        MatcherAssert.assertThat( recorder.nextResponse(), BoltMatchers.succeededWithMetadata( "server", stringValue( version ) ) );
    }
    ...
    public void shouldCloseConnectionAfterAuthenticationFailure() throws Throwable
    {
        ...
        // ...and
        MatcherAssert.assertThat( recorder.nextResponse(), BoltMatchers.failedWithStatus( Status.Security.Unauthorized ) );
    }
