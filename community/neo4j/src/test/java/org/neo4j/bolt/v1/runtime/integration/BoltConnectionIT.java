...
public class BoltConnectionIT
{
    ...
    public void shouldCloseConnectionAckFailureBeforeInit() throws Throwable
    {
        ...
        BoltMatchers.verifyKillsConnection( () -> machine.ackFailure( recorder ) );

        // then
        MatcherAssert.assertThat( recorder.nextResponse(), BoltMatchers.failedWithStatus( Status.Request.Invalid ) );
    }
    ...
    public void shouldCloseConnectionResetBeforeInit() throws Throwable
    {
        ...
        // when
        BoltResponseRecorder recorder = new BoltResponseRecorder();
        BoltMatchers.verifyKillsConnection( () -> machine.reset( recorder ) );
    ...
    public void shouldCloseConnectionOnRunBeforeInit() throws Throwable
    {
        ...
        // when
        BoltResponseRecorder recorder = new BoltResponseRecorder();
        BoltMatchers.verifyKillsConnection( () -> machine.run( "RETURN 1", map(), recorder ) );
    ...
    public void shouldCloseConnectionOnDiscardAllBeforeInit() throws Throwable
    {
        ...
        // when
        BoltResponseRecorder recorder = new BoltResponseRecorder();
        BoltMatchers.verifyKillsConnection( () -> machine.discardAll( recorder ) );
    ...
    public void shouldCloseConnectionOnPullAllBeforeInit() throws Throwable
    {
        ...
        // when
        BoltResponseRecorder recorder = new BoltResponseRecorder();
        BoltMatchers.verifyKillsConnection( () -> machine.pullAll( recorder ) );
    ...
    public void shouldSucceedOn__run__pullAll__run() throws Throwable
    {
        ...
        machine.run( "RETURN 1", EMPTY_PARAMS, NullResponseHandler.nullResponseHandler() );
        machine.pullAll( NullResponseHandler.nullResponseHandler() );
    ...
    public void shouldSucceedOn__run__discardAll__run() throws Throwable
    {
        ...
        // And Given that I've ran and pulled one stream
        machine.run( "RETURN 1", EMPTY_PARAMS, NullResponseHandler.nullResponseHandler() );
        machine.discardAll( NullResponseHandler.nullResponseHandler() );
    ...
    public void shouldFailOn__run__run() throws Throwable
    {
        ...
        BoltResponseRecorder recorder = new BoltResponseRecorder();
        BoltMatchers.verifyKillsConnection( () -> machine.run( "RETURN 1", EMPTY_PARAMS, recorder ) );
    ...
    public void shouldHandleImplicitCommitFailure() throws Throwable
    {
        ...
        BoltStateMachine machine = env.newMachine( boltChannel );
        machine.init( USER_AGENT, emptyMap(), null );
        machine.run( "CREATE (n:Victim)-[:REL]->()", EMPTY_PARAMS, NullResponseHandler.nullResponseHandler() );
        machine.discardAll( NullResponseHandler.nullResponseHandler() );
        ...
        MatcherAssert.assertThat( recorder.nextResponse(), BoltMatchers.failedWithStatus( Status.Schema.ConstraintValidationFailed ) );
    ...
    public void shouldAllowUserControlledRollbackOnExplicitTxFailure() throws Throwable
    {
        ...
        machine.run( "BEGIN", EMPTY_PARAMS, NullResponseHandler.nullResponseHandler() );
        machine.discardAll( NullResponseHandler.nullResponseHandler() );
        machine.run( "CREATE (n:Victim)-[:REL]->()", EMPTY_PARAMS, NullResponseHandler.nullResponseHandler() );
        machine.discardAll( NullResponseHandler.nullResponseHandler() );
        ...
        MatcherAssert.assertThat( recorder.nextResponse(), BoltMatchers.failedWithStatus( Status.Statement.SyntaxError ) );
    ...
    public void shouldNotSupportUsingPeriodicCommitInTransaction() throws Exception
    {
        ...
        // Then
        MatcherAssert.assertThat( recorder.nextResponse(), BoltMatchers.failedWithStatus( Status.Statement.SemanticError ) );
    ...
    public void shouldCloseTransactionEvenIfCommitFails() throws Exception
    {
        ...
        machine.ackFailure( NullResponseHandler.nullResponseHandler() );
    ...
    public void shouldAllowNewTransactionAfterFailure() throws Throwable
    {
        ...
        runAndPull( machine, "BEGIN" );
        machine.run( "invalid", EMPTY_PARAMS, NullResponseHandler.nullResponseHandler() );
        machine.reset( NullResponseHandler.nullResponseHandler() );
    ...
    {
        BoltResponseRecorder recorder = new BoltResponseRecorder();
        machine.run( statement, params, NullResponseHandler.nullResponseHandler() );
        machine.pullAll( recorder );
