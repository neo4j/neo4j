...
public class AuthenticationIT extends AbstractBoltTransportsTest
{
    ...
    public void shouldRespondWithCredentialsExpiredOnFirstUse() throws Throwable
    {
        ...
        MatcherAssert.assertThat( connection,
                util.eventuallyReceives( MessageMatchers.msgSuccess( map( "credentials_expired", true, "server", version ) ) ) );
    ...
    public void shouldFailIfWrongCredentials() throws Throwable
    {
        ...
        // Then
        MatcherAssert.assertThat( connection, util.eventuallyReceivesSelectedProtocolVersion() );
        MatcherAssert.assertThat( connection, util.eventuallyReceives( MessageMatchers.msgFailure( Status.Security.Unauthorized,
    ...
    public void shouldFailDifferentlyIfTooManyFailedAuthAttempts() throws Exception
    {
        ...
        MatcherAssert.assertThat( failureMessage.status(), equalTo( Status.Security.AuthenticationRateLimit ) );
        MatcherAssert.assertThat( failureMessage.message(),
    ...
    public void shouldBeAuthenticatedAfterUpdatingCredentials() throws Throwable
    {
        ...
        // Then
        MatcherAssert.assertThat( connection, util.eventuallyReceives( MessageMatchers.msgSuccess(), MessageMatchers.msgSuccess() ) );
    }
    ...
    public void shouldBeAbleToChangePasswordUsingBuiltInProcedure() throws Throwable
    {
        ...
        // Then
        MatcherAssert.assertThat( connection, util.eventuallyReceivesSelectedProtocolVersion() );
        MatcherAssert.assertThat( connection, util.eventuallyReceives( MessageMatchers.msgSuccess( map( "credentials_expired", true, "server", version ) ) ) );
    ...
    public void shouldFailWhenReusingTheSamePassword() throws Throwable
    {
        ...
        // Then
        MatcherAssert.assertThat( connection, util.eventuallyReceives( MessageMatchers.msgFailure( Status.General.InvalidArguments,
        ...
        connection.send( util.chunk(
                ...
                PullAllMessage.pullAll() ) );
        MatcherAssert.assertThat( connection, util.eventuallyReceives( MessageMatchers.msgIgnored(), MessageMatchers.msgSuccess(), MessageMatchers.msgSuccess(),
    ...
    public void shouldNotBeAbleToReadWhenPasswordChangeRequired() throws Throwable
    {
        ...
        // Then
        MatcherAssert.assertThat( connection, util.eventuallyReceives( MessageMatchers.msgFailure( Status.Security.CredentialsExpired,
    ...
    private FailureMessage collectAuthFailureOnFailedAuth()
    {
        ...
        try
        {
            ...
            MatcherAssert.assertThat( connection, util.eventuallyReceivesSelectedProtocolVersion() );
            MatcherAssert.assertThat( connection, util.eventuallyReceives( failureRecorder ) );
            MatcherAssert.assertThat( connection, TransportTestUtil.eventuallyDisconnects() );
        }
        catch ( Exception ex )
        {
