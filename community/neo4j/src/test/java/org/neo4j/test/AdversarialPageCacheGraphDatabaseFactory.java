...
import org.neo4j.platform.CommunityEditionModule;
...
public class AdversarialPageCacheGraphDatabaseFactory
{
    ...
    public static GraphDatabaseFactory create( FileSystemAbstraction fs, Adversary adversary )
    {
        ...
        {
            @Override
            protected GraphDatabaseService newEmbeddedDatabase( File dir, Config config, GraphDatabaseFacadeFactory.Dependencies
                    dependencies )
            {
