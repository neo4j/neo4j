...
public class LabelsAcceptanceTest
{
    ...
    public void addingALabelUsingAValidIdentifierShouldSucceed()
    {
        ...
        assertThat( "Label should have been added to node", myNode,
                Neo4jMatchers.inTx( graphDatabase, Neo4jMatchers.hasLabel( Labels.MY_LABEL ) ) );
    }
    ...
    public void removingCommittedLabel()
    {
        ...
        // Then
        assertThat( myNode, Matchers.not( Neo4jMatchers.inTx( graphDatabase, Neo4jMatchers.hasLabel( label ) ) ) );
    }
    ...
    public void createNodeWithLabels()
    {
        ...
        assertThat( node, Neo4jMatchers.inTx( db, Neo4jMatchers.hasLabels( names ) ) );
    }
    ...
    public void removingNonExistentLabel()
    {
        ...
        // THEN
        assertThat( myNode, Matchers.not( Neo4jMatchers.inTx( beansAPI, Neo4jMatchers.hasLabel( label ) ) ) );
    }
    ...
    public void shouldBeAbleToListLabelsForANode()
    {
        ...
        assertThat( node, Neo4jMatchers.inTx( beansAPI, Neo4jMatchers.hasLabels( expected ) ) );
    }
    ...
    public void shouldReturnEmptyListIfNoLabels()
    {
        ...
        // WHEN THEN
        assertThat( node, Neo4jMatchers.inTx( beansAPI, Neo4jMatchers.hasNoLabels() ) );
    }
    ...
    public void getNodesWithLabelCommitted()
    {
        ...
        // THEN
        assertThat( beansAPI, Neo4jMatchers.inTx( beansAPI, Neo4jMatchers.hasNodes( Labels.MY_LABEL, node ) ) );
        assertThat( beansAPI, Neo4jMatchers.inTx( beansAPI, Neo4jMatchers.hasNoNodes( Labels.MY_OTHER_LABEL ) ) );
    }
    ...
    public void shouldListAllExistingLabels()
    {
        ...
        assertThat( map( Label::name, labels ), Matchers.hasItems( Labels.MY_LABEL.name(), Labels.MY_OTHER_LABEL.name() ) );
    }
    ...
    public void shouldListAllLabelsInUse()
    {
        ...
        assertThat( map( Label::name, labels ), Matchers.hasItems( Labels.MY_LABEL.name() ) );
    }
