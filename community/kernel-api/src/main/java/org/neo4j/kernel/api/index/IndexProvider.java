 ...
 * {@link #getPopulator(IndexDescriptor, IndexSamplingConfig, ByteBufferFactory, TokenNameLookup) batch index writer}.
 *
...
public abstract class IndexProvider extends LifecycleAdapter implements IndexConfigCompleter
{
    ...
    {
        return getPopulator( descriptor, new IndexSamplingConfig( 1, 0.1, false ), ByteBufferFactory.heapBufferFactory( 0 ), tokenNameLookup );
    }
    ...
    public static class Delegating extends IndexProvider
    {
        ...
        public IndexPopulator getPopulator( IndexDescriptor descriptor, IndexSamplingConfig samplingConfig, ByteBufferFactory bufferFactory,
                TokenNameLookup tokenNameLookup )
        {
            return provider.getPopulator( descriptor, samplingConfig, bufferFactory, tokenNameLookup );
        }
