...
class NativeRelationshipTypeScanStore extends NativeTokenScanStore implements RelationshipTypeScanStore
{
    NativeRelationshipTypeScanStore( PageCache pageCache, DatabaseLayout directoryStructure, FileSystemAbstraction fs,
            FullStoreChangeStream fullStoreChangeStream, DatabaseReadOnlyChecker readOnlyChecker, Config config, Monitors monitors,
    ...
    {
        super( pageCache, directoryStructure, fs, fullStoreChangeStream, readOnlyChecker, config, monitors, recoveryCleanupWorkCollector, entityType,
                cacheTracer, memoryTracker, "Relationship Type Scan Store" );
    }
}
