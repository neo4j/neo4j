...
public class GenericIndexValidationIT
{
    ...
    {
        string( Byte.BYTES, 8172, i -> random.randomValues().nextAlphaNumericTextValue( i, i ).stringValue() ),
        byteArray( SIZE_NUMBER_BYTE, 8171, i -> random.randomValues().nextByteArrayRaw( i, i ) ),
        shortArray( SIZE_NUMBER_SHORT, 4085, i -> random.randomValues().nextShortArrayRaw( i, i ) ),
        intArray( SIZE_NUMBER_INT, 2042, i -> random.randomValues().nextIntArrayRaw( i, i ) ),
        longArray( SIZE_NUMBER_LONG, 1021, i -> random.randomValues().nextLongArrayRaw( i, i ) ),
        floatArray( SIZE_NUMBER_FLOAT, 2042, i -> random.randomValues().nextFloatArrayRaw( i, i ) ),
        doubleArray( SIZE_NUMBER_DOUBLE, 1021, i -> random.randomValues().nextDoubleArrayRaw( i, i ) ),
        booleanArray( SIZE_BOOLEAN, 8172, i -> random.randomValues().nextBooleanArrayRaw( i, i ) ),
        charArray( Byte.BYTES, 2724, i -> random.randomValues().nextAlphaNumericTextValue( i, i ).stringValue().toCharArray() ),
        stringArray1( SIZE_STRING_LENGTH + 1, 2724, i -> random.randomValues().nextAlphaNumericStringArrayRaw( i, i, 1, 1 ) ),
        stringArray10( SIZE_STRING_LENGTH + 10, 681, i -> random.randomValues().nextAlphaNumericStringArrayRaw( i, i, 10, 10 ) ),
        ...
        dateArray( SIZE_DATE, 1021, i -> random.randomValues().nextDateArrayRaw( i, i ) ),
        timeArray( SIZE_ZONED_TIME, 681, i -> random.randomValues().nextTimeArrayRaw( i, i ) ),
        localTimeArray( SIZE_LOCAL_TIME, 1021, i -> random.randomValues().nextLocalTimeArrayRaw( i, i ) ),
        dateTimeArray( SIZE_ZONED_DATE_TIME, 510, i -> random.randomValues().nextDateTimeArrayRaw( i, i ) ),
        localDateTimeArray( SIZE_LOCAL_DATE_TIME, 681, i -> random.randomValues().nextLocalDateTimeArrayRaw( i, i ) ),
