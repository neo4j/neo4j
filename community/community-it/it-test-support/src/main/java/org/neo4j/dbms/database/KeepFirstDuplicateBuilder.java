...
/**
 * This class allows system graph components to be overridden in tests, by allowing the test to register one with a
 * duplicate name *first*, then ignoring subsequent registrations.
 */
