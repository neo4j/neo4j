...
class QueryResourceTypedV1x2ParametersIT extends AbstractQueryResourceTypedParametersIT {

    QueryResourceTypedV1x2ParametersIT(QueryAPITestClient testClient) {
        super(testClient);
    }
