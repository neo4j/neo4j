...
import static org.neo4j.server.httpv2.response.format.Fieldnames._ELEMENT_ID;
import static org.neo4j.server.httpv2.response.format.Fieldnames._END_NODE_ELEMENT_ID;
import static org.neo4j.server.httpv2.response.format.Fieldnames._LABELS;
import static org.neo4j.server.httpv2.response.format.Fieldnames._PROPERTIES;
import static org.neo4j.server.httpv2.response.format.Fieldnames._RELATIONSHIP_TYPE;
import static org.neo4j.server.httpv2.response.format.Fieldnames._START_NODE_ELEMENT_ID;
...
public class QueryResourceTypedJsonIT {
    ...
    public void basicTypes() throws IOException, InterruptedException {
        ...
        assertThat(parsedJson
                        ...
                        .asBoolean())
                .isEqualTo(true);
        HttpV2Assertions.assertThat(parsedJson).hasTypedResultAt(1, "Integer", "1");
        assertThat(parsedJson
                        .get(DATA_KEY)
                        .get(VALUES_KEY)
                        .get(2)
        ...
        assertThat(parsedJson
                        ...
                        .isNull())
                .isEqualTo(true);
        HttpV2Assertions.assertThat(parsedJson).hasTypedResultAt(3, "Float", "1.23");
        HttpV2Assertions.assertThat(parsedJson).hasTypedResultAt(4, "String", "hello");
    }
    ...
    public void temporalTypes() throws IOException, InterruptedException {
        ...
        HttpV2Assertions.assertThat(parsedJson).hasTypedResultAt(0, "OffsetDateTime", "2015-06-24T12:50:35.556+01:00");
        HttpV2Assertions.assertThat(parsedJson)
                .hasTypedResultAt(1, "ZonedDateTime", "2015-11-21T21:40:32.142Z[Antarctica/Troll]");
        HttpV2Assertions.assertThat(parsedJson).hasTypedResultAt(2, "LocalDateTime", "2015-07-04T19:32:24");
        HttpV2Assertions.assertThat(parsedJson).hasTypedResultAt(3, "Date", "2015-03-26");
        HttpV2Assertions.assertThat(parsedJson).hasTypedResultAt(4, "Time", "12:50:35.556+01:00");
        HttpV2Assertions.assertThat(parsedJson).hasTypedResultAt(5, "LocalTime", "12:50:35.556");
    }
    ...
    public void duration() throws IOException, InterruptedException {
        ...
        HttpV2Assertions.assertThat(parsedJson).hasTypedResultAt(0, "Duration", "P14DT16H12M");
    }
    ...
    public void map() throws IOException, InterruptedException {
        ...
        HttpV2Assertions.assertThat(map.get(CYPHER_VALUE).get("key")).hasTypedResult("String", "Value");
        HttpV2Assertions.assertThat(map.get(CYPHER_VALUE)
                        .get("listKey")
                        .get(CYPHER_VALUE)
                        .get(0)
                        .get(CYPHER_VALUE)
    ...
    public void list() throws IOException, InterruptedException {
        ...
        HttpV2Assertions.assertThat(resultArray.get(0)).hasTypedResult("Integer", "1");
        ...
        HttpV2Assertions.assertThat(resultArray.get(2)).hasTypedResult("String", "hello");
        HttpV2Assertions.assertThat(resultArray.get(3)).hasTypedResult("Date", "2015-03-26");
    }
    ...
    public void node() throws IOException, InterruptedException {
        ...
        HttpV2Assertions.assertThat(node.get(CYPHER_VALUE).get(_PROPERTIES).get("aNumber"))
    ...
    public void relationship() throws IOException, InterruptedException {
        ...
        HttpV2Assertions.assertThat(rel.get(CYPHER_VALUE).get(_PROPERTIES).get("onFire"))
                .hasTypedResult("String", "owch!");
    }

    @Test
    public void simplePath() throws IOException, InterruptedException {
        var createPathReq =
