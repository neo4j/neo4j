...
class RollbackIdLeakIT
{
    ...
    private DbRestarter clean()
    {
        return new DbRestarter()
        {
            ...
            {
                dbms = new TestDatabaseManagementServiceBuilder( directory.directory() ).build();
    ...
    private DbRestarter nonClean()
    {
        return new DbRestarter()
        {
            ...
            {
                dbms = new TestDatabaseManagementServiceBuilder( directory.directory() ).setFileSystem( fs ).build();
                return dbms.database( DEFAULT_DATABASE_NAME );
            }
        };
    }
