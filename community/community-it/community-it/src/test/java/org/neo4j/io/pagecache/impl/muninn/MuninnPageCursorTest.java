...
class MuninnPageCursorTest
{
    ...
    private PageSwapperFactory customSwapper( PageSwapperFactory actual, Runnable onRead )
    {
        ...
        {
            @Override
            public PageSwapper createPageSwapper( File file, int filePageSize, PageEvictionCallback onEviction, boolean createIfNotExist, boolean useDirectIO )
                    throws IOException
            {
                PageSwapper actualSwapper = actual.createPageSwapper( file, filePageSize, onEviction, createIfNotExist, useDirectIO );
