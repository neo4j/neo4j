...
public class FailedIndexRestartIT
{
    ...
    void failedIndexUpdatesAfterRestart()
    {
        TestDatabaseManagementServiceBuilder builder = new TestDatabaseManagementServiceBuilder()
                                                            .setDatabaseRootDirectory( databaseLayout.databaseDirectory() );
        ...
        var e = assertThrows( RuntimeException.class, () -> awaitIndexesOnline( managementService.database( DEFAULT_DATABASE_NAME ) ) );
        assertThat( getRootCause( e ).getMessage(), containsString( "Max supported key size is" ) );
