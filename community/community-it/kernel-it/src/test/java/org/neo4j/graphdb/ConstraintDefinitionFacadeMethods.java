...
public enum ConstraintDefinitionFacadeMethods implements Consumer<ConstraintDefinition> {
    ...
    GET_RELATIONSHIP_TYPE(
            new FacadeMethod<>("RelationshipType getRelationshipType()", ConstraintDefinition::getRelationshipType)),
    DROP(new FacadeMethod<>("void drop()", ConstraintDefinition::drop)),
    IS_CONSTRAINT_TYPE(new FacadeMethod<>(
            "boolean isConstraintType( ConstraintType type )",
            self -> self.isConstraintType(ConstraintType.UNIQUENESS))),
