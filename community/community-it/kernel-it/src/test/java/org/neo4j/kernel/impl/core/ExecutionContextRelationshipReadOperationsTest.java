...
public class ExecutionContextRelationshipReadOperationsTest extends RelationshipReadOperationsTest {
    ...
    protected Relationship lookupRelationship(Transaction tx, String id) {
        ...
        var internalId = executionContext.elementIdMapper().relationshipId(id);
