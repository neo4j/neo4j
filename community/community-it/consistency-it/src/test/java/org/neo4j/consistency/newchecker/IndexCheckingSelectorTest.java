...
class IndexCheckingSelectorTest
{
    ...
    private ConsistencySummaryStatistics checkIndex() throws ConsistencyCheckIncompleteException
    {
        ...
        IndexAccessors.IndexAccessorLookup indexAccessorLookup = new LookupAccessorsFromRunningDb( indexingService, false );
        ...
        return checker.execute( pageCache, directStoreAccess, () -> (CountsStore) countsStore, indexAccessorLookup,
