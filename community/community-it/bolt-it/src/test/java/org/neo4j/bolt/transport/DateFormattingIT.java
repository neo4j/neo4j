...
public class DateFormattingIT
{
            ...
            throws Exception
    {
        ...
        negotiateBoltV43WithPatch( packV3Util );
            ...
            throws Exception
    {
        ...
        negotiateBoltV43WithPatch( packV2Util );
            ...
            throws Exception
    {
        ...
        var packV3Util = new TransportTestUtil( new Neo4jPackV3() );
        negotiateBoltV43WithoutPatch( packV3Util );
    ...
    private void negotiateBoltV43WithPatch( TransportTestUtil util ) throws Exception
    {
    ...
    private void negotiateBoltV43WithoutPatch( TransportTestUtil util ) throws Exception
    {
        connection.connect( address ).send( util.acceptedVersions( BoltProtocolV43.VERSION.toInt(), 0, 0, 0 ) );
        assertThat( connection ).satisfies( eventuallyReceives( new byte[]{0, 0, 3, 4} ) );
