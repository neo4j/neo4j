...
public class EnableAuthenticationSettingCustomizer implements SettingCustomizer {

    @Override
    public void customize(Context ctx, SettingBuilder settings) {
        settings.set(GraphDatabaseSettings.auth_enabled, true).set(BoltConnector.enable_unix_socket_auth, true);
    }
}
