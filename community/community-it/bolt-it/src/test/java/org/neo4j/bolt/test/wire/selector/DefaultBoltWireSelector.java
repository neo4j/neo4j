...
/**
 * Provides a wire selector implementation which always selects the current default wire version.
 */
public class DefaultBoltWireSelector implements BoltWireSelector {
