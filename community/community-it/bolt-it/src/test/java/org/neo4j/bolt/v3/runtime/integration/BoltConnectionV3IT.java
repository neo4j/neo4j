...
public class BoltConnectionV3IT
{
    ...
    @Test
    public void shouldCloseConnectionOnInit() throws Throwable
    {
        // Given
        BoltStateMachine machine = newStateMachine();

        // when
        NullResponseHandler handler = nullResponseHandler();

        assertThrows( BoltConnectionFatality.class, () -> machine.process( new InitMessage( USER_AGENT, emptyMap() ), handler ) );
        // then
        verifyKillsConnection( () -> machine.process( ResetMessage.INSTANCE, handler ) );
    }

    @Test
    public void shouldCloseConnectionResetBeforeHello() throws Throwable
    {
        // Given
        BoltStateMachine machine = newStateMachine();
    ...
    @Test
    public void shouldCloseConnectionOnRunBeforeHello() throws Throwable
    {
        // Given
        BoltStateMachine machine = newStateMachine();
    ...
    @Test
    public void shouldCloseConnectionOnDiscardAllBeforeHello() throws Throwable
    {
        // Given
        BoltStateMachine machine = newStateMachine();
    ...
    @Test
    public void shouldCloseConnectionOnPullAllBeforeHello() throws Throwable
    {
        // Given
        BoltStateMachine machine = newStateMachine();
    ...
    {
        // Given
        BoltStateMachine firstMachine = newStateMachine();
        firstMachine.process( newHelloMessage(), null );
        BoltStateMachine secondMachine = newStateMachine();
        secondMachine.process( newHelloMessage(), null );
    ...
    public void shouldSupportUsingPeriodicCommitInSession() throws Exception
    {
        ...
        // When
        Object[] result = runAndPull( machine,
    ...
    private BoltStateMachine newStateMachine()
    {
        return env.newMachine( BoltProtocolV3.VERSION, boltChannel );
    }
