...
import static org.neo4j.bolt.testing.messages.BoltV40Wire.begin;
import static org.neo4j.bolt.testing.messages.BoltV40Wire.commit;
import static org.neo4j.bolt.testing.messages.BoltV40Wire.hello;
import static org.neo4j.bolt.testing.messages.BoltV40Wire.pull;
import static org.neo4j.bolt.testing.messages.BoltV40Wire.rollback;
import static org.neo4j.bolt.testing.messages.BoltV40Wire.run;
...
public class BoltV4TransportIT extends AbstractBoltITBase {
    ...
    protected void negotiateBolt() throws Exception {
        connection.send(BoltProtocolV40.VERSION);
        assertThat(connection).negotiates(BoltProtocolV40.VERSION);
