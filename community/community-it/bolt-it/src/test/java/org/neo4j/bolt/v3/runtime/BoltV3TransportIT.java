...
public class BoltV3TransportIT extends BoltV3TransportBase {
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("argumentsProvider")
    public void shouldNegotiateProtocolV3WhenClientSupportsBothV1V2AndV3(
    ...
    public void shouldRunSimpleStatement(Class<? extends TransportConnection> connectionClass) throws Exception {
        ...
        connection.send(util.chunk(
                new RunMessage("UNWIND [1,2,3] AS a RETURN a, a * a AS a_squared"), PullAllMessage.INSTANCE));
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("argumentsProvider")
    public void shouldRespondWithMetadataToDiscardAll(Class<? extends TransportConnection> connectionClass)
            throws Exception {
        init(connectionClass);
        ...
        negotiateBoltV3();
        connection.send(util.chunk(
                new RunMessage("UNWIND [1,2,3] AS a RETURN a, a * a AS a_squared"), DiscardAllMessage.INSTANCE));
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("argumentsProvider")
    public void shouldAllowRollbackSimpleStatementInTx(Class<? extends TransportConnection> connectionClass)
            throws Exception {
        init(connectionClass);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("argumentsProvider")
    public void shouldBeAbleToRunQueryAfterReset(Class<? extends TransportConnection> connectionClass)
            throws Exception {
        init(connectionClass);
        ...
        assertThat(connection)
                .satisfies(util.eventuallyReceives(
                        msgFailure(Status.Statement.SyntaxError, String.format("line 1, column 1")), msgIgnored()));
    ...
    public void shouldRunProcedure(Class<? extends TransportConnection> connectionClass) throws Exception {
        ...
        negotiateBoltV3();
        connection.send(
                util.chunk(new RunMessage("CREATE (n:Test {age: 2}) RETURN n.age AS age"), PullAllMessage.INSTANCE));
        ...
        // Then
        final Condition<AnyValue> stringEquality =
                new Condition<>(value -> value.equals(stringValue("Test")), "String equals");
        assertThat(connection)
                .satisfies(util.eventuallyReceives(
                        msgSuccess(message -> assertThat(message)
                                .containsKey("t_first")
    ...
    public void shouldHandleDeletedNodes(Class<? extends TransportConnection> connectionClass) throws Exception {
        ...
        // Then
        assertThat(connection)
                .satisfies(util.eventuallyReceives(msgSuccess(message ->
                        assertThat(message).containsKey("t_first").containsEntry("fields", singletonList("n")))));
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("argumentsProvider")
    public void shouldHandleDeletedRelationships(Class<? extends TransportConnection> connectionClass)
            throws Exception {
        init(connectionClass);
        ...
        negotiateBoltV3();
        connection.send(util.chunk(
                new RunMessage("CREATE ()-[r:T {prop: 42}]->() DELETE r RETURN r"), PullAllMessage.INSTANCE));

        // Then
        assertThat(connection)
                .satisfies(util.eventuallyReceives(msgSuccess(message ->
                        assertThat(message).containsKey("t_first").containsEntry("fields", singletonList("r")))));
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("argumentsProvider")
    public void shouldNotLeakStatsToNextStatement(Class<? extends TransportConnection> connectionClass)
            throws Exception {
        init(connectionClass);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("argumentsProvider")
    public void shouldFailNicelyWhenDroppingUnknownIndex(Class<? extends TransportConnection> connectionClass)
            throws Exception {
        init(connectionClass);

        // When
        negotiateBoltV3();
        connection.send(util.chunk(new RunMessage("DROP INDEX my_index"), PullAllMessage.INSTANCE));
    ...
    public void shouldSetTxMetadata(Class<? extends TransportConnection> connectionClass) throws Exception {
        ...
        Set<KernelTransactionHandle> txHandles = gdb.getDependencyResolver()
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("argumentsProvider")
    public void shouldSendFailureMessageForBeginWithInvalidBookmark(
            Class<? extends TransportConnection> connectionClass) throws Exception {
        init(connectionClass);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("argumentsProvider")
    public void shouldSendFailureMessageForBeginWithInvalidTransactionTimeout(
            Class<? extends TransportConnection> connectionClass) throws Exception {
        init(connectionClass);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("argumentsProvider")
    public void shouldSendFailureMessageForBeginWithInvalidTransactionMetadata(
            Class<? extends TransportConnection> connectionClass) throws Exception {
        init(connectionClass);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("argumentsProvider")
    public void shouldSendFailureMessageForRunWithInvalidBookmark(Class<? extends TransportConnection> connectionClass)
            throws Exception {
        init(connectionClass);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("argumentsProvider")
    public void shouldSendFailureMessageForRunWithInvalidTransactionTimeout(
            Class<? extends TransportConnection> connectionClass) throws Exception {
        init(connectionClass);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("argumentsProvider")
    public void shouldSendFailureMessageForRunWithInvalidTransactionMetadata(
            Class<? extends TransportConnection> connectionClass) throws Exception {
        init(connectionClass);
