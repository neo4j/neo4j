...
public class SupportedStructTypesV2IT {
    ...
    @ParameterizedTest(name = "{displayName} {0}")
    @MethodSource("classProvider")
    public void shouldNegotiateProtocolV4WhenClientSupportsBothV4AndV3(
    ...
    @ParameterizedTest(name = "{displayName} {0}")
    @MethodSource("classProvider")
    public void shouldSendAndReceiveLocalDateTime(Class<? extends TransportConnection> connectionClass)
            throws Exception {
        initConnection(connectionClass);
    ...
    @ParameterizedTest(name = "{displayName} {0}")
    @MethodSource("classProvider")
    public void shouldSendDateTimeWithTimeZoneName(Class<? extends TransportConnection> connectionClass)
            throws Exception {
        initConnection(connectionClass);
    ...
    @ParameterizedTest(name = "{displayName} {0}")
    @MethodSource("classProvider")
    public void shouldReceiveDateTimeWithTimeZoneName(Class<? extends TransportConnection> connectionClass)
            throws Exception {
        initConnection(connectionClass);
    ...
    @ParameterizedTest(name = "{displayName} {0}")
    @MethodSource("classProvider")
    public void shouldSendAndReceiveDateTimeWithTimeZoneName(Class<? extends TransportConnection> connectionClass)
            throws Exception {
        initConnection(connectionClass);
    ...
    @ParameterizedTest(name = "{displayName} {0}")
    @MethodSource("classProvider")
    public void shouldSendDateTimeWithTimeZoneOffset(Class<? extends TransportConnection> connectionClass)
            throws Exception {
        initConnection(connectionClass);
    ...
    @ParameterizedTest(name = "{displayName} {0}")
    @MethodSource("classProvider")
    public void shouldReceiveDateTimeWithTimeZoneOffset(Class<? extends TransportConnection> connectionClass)
            throws Exception {
        initConnection(connectionClass);
    ...
    @ParameterizedTest(name = "{displayName} {0}")
    @MethodSource("classProvider")
    public void shouldSendAndReceiveDateTimeWithTimeZoneOffset(Class<? extends TransportConnection> connectionClass)
            throws Exception {
        initConnection(connectionClass);
    ...
    private <T extends AnyValue> void testSendingOfBoltV2Value(T value) throws Exception {
        ...
        connection.send(util.defaultRunAutoCommitTx(
                "CREATE (n:Node {value: $value}) RETURN 42", map(new String[] {"value"}, new AnyValue[] {value})));
    ...
    private <T extends AnyValue> void testSendingAndReceivingOfBoltV2Value(T value) throws Exception {
        ...
        connection.send(
                util.defaultRunAutoCommitTx("RETURN $value", map(new String[] {"value"}, new AnyValue[] {value})));
