...
public @interface Resolver {
    ...
    /**
     * Identifies the resolver which is to be instantiated and invoked for the targeted connection.
     *
     * @return a connection resolver implementation.
     */
    Class<? extends AddressResolver> value();
}
