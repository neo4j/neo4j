...
public class BoltV44TransportIT {
    ...
    public void shouldReturnTheRoutingTableInTheSuccessMessageWhenItReceivesTheRouteMessageWithBookmark(
        ...
        connection.send(
                util.chunk(new RouteMessage(new MapValueBuilder().build(), List.of(routeBookmark), null, null)));
    ...
    public void shouldReturnFailureIfRoutingTableFailedToReturn(Class<? extends TransportConnection> connectionClass)
        ...
        connection.send(util.chunk(new RouteMessage(new MapValueBuilder().build(), List.of(), "DOESNT_EXIST!", null)));
