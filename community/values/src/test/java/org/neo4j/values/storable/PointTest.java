...
class PointTest
{
    ...
    {
        assertEqual( pointValue( WGS_84, 1.0, 2.0 ), pointValue( WGS_84, 1.0, 2.0 ) );
        assertEqual( pointValue( WGS_84, -1.0, 2.0 ), pointValue( WGS_84, -1.0, 2.0 ) );
        assertEqual( pointValue( WGS_84, -1.0, -2.0 ), pointValue( WGS_84, -1.0, -2.0 ) );
        assertEqual( pointValue( WGS_84, 0.0, 0.0 ), pointValue( WGS_84, 0.0, 0.0 ) );
    }

    @Test
    void geographicShouldNotEqualOtherPoint()
    {
        assertNotEqual( pointValue( WGS_84, 1.0, 2.0 ), pointValue( WGS_84, 3.0, 4.0 ) );
        assertNotEqual( pointValue( WGS_84, 1.0, 2.0 ), pointValue( WGS_84, -1.0, 2.0 ) );
    }

    @Test
    void geographicShouldNotEqualCartesian()
    {
        assertNotEqual( pointValue( WGS_84, 1.0, 2.0 ), pointValue( CARTESIAN, 1.0, 2.0 ) );
    }
    ...
    void geometricInvalid2DPointsShouldBehave()
    {
        ...
        // valid ones for x
        assertArrayEquals( pointValue( WGS_84, 0, 0 ).coordinate(), new double[]{0, 0} );
        assertArrayEquals( pointValue( WGS_84, 180, 0 ).coordinate(), new double[]{180, 0} );
        assertArrayEquals( pointValue( WGS_84, -180, 0 ).coordinate(), new double[]{-180, 0} );

        // valid ones for x that should wrap around
        assertArrayEquals( pointValue( WGS_84, 190, 0 ).coordinate(), new double[]{-170, 0} );
        assertArrayEquals( pointValue( WGS_84, -190, 0 ).coordinate(), new double[]{170, 0} );
        assertArrayEquals( pointValue( WGS_84, 360, 0 ).coordinate(), new double[]{0, 0} );
        assertArrayEquals( pointValue( WGS_84, -360, 0 ).coordinate(), new double[]{0, 0} );
        assertArrayEquals( pointValue( WGS_84, 350, 0 ).coordinate(), new double[]{-10, 0} );
        assertArrayEquals( pointValue( WGS_84, -350, 0 ).coordinate(), new double[]{10, 0} );
        assertArrayEquals( pointValue( WGS_84, 370, 0 ).coordinate(), new double[]{10, 0} );
        assertArrayEquals( pointValue( WGS_84, -370, 0 ).coordinate(), new double[]{-10, 0} );
        assertArrayEquals( pointValue( WGS_84, 540, 0 ).coordinate(), new double[]{180, 0} );
        assertArrayEquals( pointValue( WGS_84, -540, 0 ).coordinate(), new double[]{-180, 0} );

        // valid ones for y
        assertArrayEquals( pointValue( WGS_84, 0, 90 ).coordinate(), new double[]{0, 90} );
        assertArrayEquals( pointValue( WGS_84, 0, -90 ).coordinate(), new double[]{0, -90} );

        // invalid ones for y
        assertThrows( InvalidArgumentException.class, () -> pointValue( WGS_84, 0, 91 ),
    ...
    void geometricInvalid3DPointsShouldBehave()
    {
        ...
        // valid ones for x
        assertArrayEquals( pointValue( WGS_84_3D, 0, 0, 0 ).coordinate(), new double[]{0, 0, 0} );
        assertArrayEquals( pointValue( WGS_84_3D, 180, 0, 0 ).coordinate(), new double[]{180, 0, 0} );
        assertArrayEquals( pointValue( WGS_84_3D, -180, 0, 0 ).coordinate(), new double[]{-180, 0, 0} );

        // valid ones for x that should wrap around
        assertArrayEquals( pointValue( WGS_84_3D, 190, 0, 0 ).coordinate(), new double[]{-170, 0, 0} );
        assertArrayEquals( pointValue( WGS_84_3D, -190, 0, 0 ).coordinate(), new double[]{170, 0, 0} );
        assertArrayEquals( pointValue( WGS_84_3D, 360, 0, 0 ).coordinate(), new double[]{0, 0, 0} );
        assertArrayEquals( pointValue( WGS_84_3D, -360, 0, 0 ).coordinate(), new double[]{0, 0, 0} );
        assertArrayEquals( pointValue( WGS_84_3D, 350, 0, 0 ).coordinate(), new double[]{-10, 0, 0} );
        assertArrayEquals( pointValue( WGS_84_3D, -350, 0, 0 ).coordinate(), new double[]{10, 0, 0} );
        assertArrayEquals( pointValue( WGS_84_3D, 370, 0, 0 ).coordinate(), new double[]{10, 0, 0} );
        assertArrayEquals( pointValue( WGS_84_3D, -370, 0, 0 ).coordinate(), new double[]{-10, 0, 0} );
        assertArrayEquals( pointValue( WGS_84_3D, 540, 0, 0 ).coordinate(), new double[]{180, 0, 0} );
        assertArrayEquals( pointValue( WGS_84_3D, -540, 0, 0 ).coordinate(), new double[]{-180, 0, 0} );

        // valid ones for y
        assertArrayEquals( pointValue( WGS_84_3D, 0, 90, 0 ).coordinate(), new double[]{0, 90, 0} );
        assertArrayEquals( pointValue( WGS_84_3D, 0, -90, 0 ).coordinate(), new double[]{0, -90, 0} );

        // invalid ones for y
        assertThrows( InvalidArgumentException.class, () -> pointValue( WGS_84_3D, 0, 91, 0 ),
    ...
    void shouldHaveValueGroup()
    {
        ...
        assertNotNull( pointValue( WGS_84, 1, 2 ).valueGroup() );
    }
    ...
    public void shouldCompareTwoPoints()
    {
        ...
        assertThat( pointValue( CARTESIAN, 1, 2 ).compareTo( pointValue( WGS_84, 1, 2 ) ) ).as( "Different CRS should compare CRS codes" ).isEqualTo( 1 );
    ...
    public void shouldTernaryCompareTwoPoints()
    {
        ...
        assertThat( pointValue( CARTESIAN, 1, 2 ).unsafeTernaryCompareTo( pointValue( WGS_84, 1, 2 ) ) ).as( "Different CRS should be incomparable" ).isEqualTo(
    ...
    public void shouldComparePointWithin()
    {
        ...
        assertThat( pointValue( CARTESIAN, 1, 2 ).withinRange( pointValue( WGS_84, 1, 2 ), true, null, false ) ).as(
                "Different CRS for lower bound should be undefined" ).isEqualTo( null );
        assertThat( pointValue( CARTESIAN, 1, 2 ).withinRange( null, false, pointValue( WGS_84, 1, 2 ), true ) ).as(
    ...
    {
        assertEqual( pointValue( WGS_84, 13.2, 56.7 ),
                PointValue.parse( "{latitude: 56.7, longitude: 13.2}" ) );
        assertEqual( pointValue( WGS_84, -74.0060, 40.7128 ),
        ...
        assertEqual( pointValue( WGS_84, -21, -45.3 ),
        ...
        assertEqual( pointValue( WGS_84_3D, 13.2, 56.7, 123.4 ),
        ...
        assertEqual( pointValue( WGS_84_3D, -74.0060, 40.7128, 567.8 ),
    ...
    {
        assertEqual( pointValue( WGS_84, 1.0, 2.0 ), PointValue.parse( " \t\n { latitude : 2.0  ,longitude :1.0  } \t" ) );
