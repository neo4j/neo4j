...
public class ValueComparisonTest
{
    ...
    private Object[] objs = new Object[]{
            ...
            new DurationValue[] { duration(0, 0, 0, 1000) },
            new DurationValue[] { duration(0, 0, 0, 1000), duration(0, 0, 1, 0) },
            new String[]{},
            new String[]{"a"},
            new String[]{"a", "aa"},
            new char[]{'a', 'b'},
            ...
            localDateTime(2018, 2, 2, 0, 0, 0, 1000),
            ...
            duration(0, 146_097, 0, 1000),
            duration(9999999999L * 12, 0, 0, 0),
            duration(9999999999L * 12, 0, 0, 1000),
            duration(9999999999L * 12, 0, 0, 2000),
