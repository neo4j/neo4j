...
public interface Table<VALUE>
{
    ...
    /**
     * @return key representing an index that has not been assigned. Why is this a method? Since it's based
     * on {@link #h()}, which although is final per table instance, changes from table to table.
     */
    long nullKey();
