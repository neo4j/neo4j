...
public class PrimitiveLongHashSet extends AbstractHopScotchCollection<Object> implements PrimitiveLongSet
{
    ...
    public PrimitiveLongHashSet( int h, HashFunction hashFunction, Monitor monitor )
    {
        super( new LongKeyTable<>( h, THE_VALUE ) );
        this.hashFunction = hashFunction;
        this.monitor = monitor;
    }

    public PrimitiveLongHashSet()
    {
        this( HopScotchHashingAlgorithm.DEFAULT_H, DEFAULT_HASHING, NO_MONITOR );
    }
