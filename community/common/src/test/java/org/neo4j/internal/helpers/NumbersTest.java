...
class NumbersTest {
    ...
    void failSafeCastLongToInt() {
        ArithmeticException exception =
                assertThrows(ArithmeticException.class, () -> Numbers.safeCastLongToInt(Integer.MAX_VALUE + 1L));
    ...
    void failSafeCastLongToShort() {
        ArithmeticException exception =
                assertThrows(ArithmeticException.class, () -> Numbers.safeCastLongToShort(Short.MAX_VALUE + 1L));
    ...
    void failSafeCastIntToUnsignedShort() {
        ArithmeticException exception =
                assertThrows(ArithmeticException.class, () -> Numbers.safeCastIntToUnsignedShort(Short.MAX_VALUE << 2));
    ...
    void failSafeCastLongToByte() {
        ArithmeticException exception =
                assertThrows(ArithmeticException.class, () -> Numbers.safeCastLongToByte(Byte.MAX_VALUE + 1));
    ...
    void failSafeCastIntToShort() {
        ArithmeticException exception =
                assertThrows(ArithmeticException.class, () -> Numbers.safeCastIntToShort(Short.MAX_VALUE + 1));
        assertEquals("Value 32768 is too big to be represented as short", exception.getMessage());
    }
