...
public abstract class SpaceFillingCurve {
    ...
    List<LongRange> getTilesIntersectingEnvelope(
            Envelope referenceEnvelope, SpaceFillingCurveConfiguration config, SpaceFillingCurveMonitor monitor) {
        ...
        addTilesIntersectingEnvelopeAt(
                config,
                monitor,
                0,
                config.maxDepth(referenceEnvelope, this.range, nbrDim, maxLevel),
                search,
                wholeExtent,
                rootCurve(),
                0,
    ...
    private void addTilesIntersectingEnvelopeAt(
            SpaceFillingCurveConfiguration config,
            SpaceFillingCurveMonitor monitor,
            int depth,
            int maxDepth,
            SearchEnvelope search,
            SearchEnvelope currentExtent,
            CurveRule curve,
            long left,
            long right,
    ...
    private static void computeTilesIntersectionEnvelopeAt(
            SpaceFillingCurveMonitor monitor,
            int depth,
            SearchEnvelope currentExtent,
            long left,
