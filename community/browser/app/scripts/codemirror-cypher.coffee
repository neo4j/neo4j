...
CodeMirror.defineMode "cypher", (config) ->
  ...
  curPunc = undefined
  funcs = wordRegexp(["abs", "acos", "allShortestPaths", "asin", "atan", "atan2", "avg", "ceil", "coalesce", "collect", "cos", "cot", "count", "degrees", "e", "endnode", "exp", "extract", "filter", "floor", "haversin", "head", "id", "labels", "last", "left", "length", "log", "log10", "lower", "ltrim", "max", "min", "node", "nodes", "percentileCont", "percentileDisc", "pi", "radians", "rand", "range", "reduce", "rel", "relationship", "relationships", "replace", "right", "round", "rtrim", "shortestPath", "sign", "sin", "sqrt", "startnode", "stdev", "stdevp", "str", "substring", "sum", "tail", "tan", "timestamp", "trim", "type", "upper"])
  preds = wordRegexp(["all", "and", "any", "has", "in", "none", "not", "or", "single", "xor"])
  keywords = wordRegexp(["as", "asc", "ascending", "assert", "by", "case", "constraint", "create", "csv", "cypher", "delete", "desc", "descending", "distinct", "drop", "else", "end", "false", "foreach", "in", "index", "is", "limit", "load", "match", "merge", "null", "on", "optional", "order", "remove", "return", "scan", "set", "skip", "start", "then", "true", "union", "unique", "using", "when", "where", "with"])
  operatorChars = /[*+\-<>=&|~%^]/
  startState: (base) ->
    tokenize: tokenBase
    context: null
