...
public class FabricSocketNettyConnectorTest extends AbstractNettyConnectorTest<FabricSocketNettyConnector> {
    private static final String CONNECTOR_ID = "bolt-intra-socket-test";
    ...
    @Test
    void shouldHavaFabricProtocolCapability() {
        connector = createConnector();

        Assertions.assertThat(connector.supportedProtocolCapabilities()).contains(ProtocolCapability.FABRIC);
    }
    ...
    void shouldRegisterWithPortRegister() throws Exception {
        ...
        Mockito.verify(connectorPortRegister).register(ConnectorType.INTRA_BOLT, (InetSocketAddress) address);
    }
