...
class DiscardMessageTest {
    ...
    void shouldThrowExceptionIfFailedToParseTransactionMetadataCorrectly() throws Throwable {
        ...
        assertThat(exception.getMessage())
                .startsWith("Expecting DISCARD size n to be a Long value, but got: String(\"invalid value type\")");
    }
    ...
    void shouldThrowExceptionIfZero(long value) throws Throwable {
        ...
        BoltIOException exception =
                assertThrows(BoltIOException.class, () -> new DiscardMessage(asMapValue(singletonMap("n", value))));
