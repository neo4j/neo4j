...
class BeginMessageDecoderV44Test extends AbstractBeginMessageDecoderTest<BeginMessageDecoderV44> {

    @Override
    public BeginMessageDecoderV44 getDecoder() {
        return BeginMessageDecoderV44.getInstance();
    }
    ...
    @Test
    void shouldIgnoreType() throws PackstreamReaderException {
        var buf = PackstreamBuf.allocUnpooled();
        var reader = Mockito.mock(PackstreamValueReader.class);
