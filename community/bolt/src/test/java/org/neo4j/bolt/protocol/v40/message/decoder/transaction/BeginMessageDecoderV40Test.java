...
class BeginMessageDecoderV40Test extends AbstractBeginMessageDecoderTest<BeginMessageDecoderV40> {

    @Override
    public BeginMessageDecoderV40 getDecoder() {
        return BeginMessageDecoderV40.getInstance();
    }
    ...
    void shouldIgnoreImpersonatedUser() throws PackstreamReaderException {
        ...
        Assertions.assertThat(msg)
                .isNotNull()
                .extracting(BeginMessage::impersonatedUser)
                .isNull();
    }

    @Test
    void shouldIgnoreTransactionType() throws PackstreamReaderException {
        var buf = PackstreamBuf.allocUnpooled();
        var reader = Mockito.mock(PackstreamValueReader.class);
