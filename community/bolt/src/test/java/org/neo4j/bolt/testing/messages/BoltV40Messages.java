...
public class BoltV40Messages {
    ...
    public static RequestMessage begin() {
        return begin(null, null, AccessMode.WRITE, null, null);
    }

    public static RequestMessage begin(String databaseName) {
        return begin(null, null, AccessMode.WRITE, null, databaseName);
    }
    ...
    public static RequestMessage begin(
        ...
        return new BeginMessage(MapValue.EMPTY, bookmarks, txTimeout, accessMode, txMetadata, databaseName);
    }
