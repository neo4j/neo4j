...
class BoltStateMachineFactoryImplTest {
    ...
    void shouldCreateBoltStateMachinesV3() {
        ...
        BoltStateMachine boltStateMachine =
                factory.newStateMachine(new BoltProtocolVersion(3, 0), CHANNEL, MapValue.EMPTY, memoryTracker);
    ...
    void shouldCreateBoltStateMachinesV4() {
        ...
        BoltStateMachine boltStateMachine =
                factory.newStateMachine(new BoltProtocolVersion(4, 0), CHANNEL, MapValue.EMPTY, memoryTracker);
    ...
    void shouldCreateBoltStateMachinesV41() {
        ...
        BoltStateMachine boltStateMachine =
                factory.newStateMachine(new BoltProtocolVersion(4, 1), CHANNEL, MapValue.EMPTY, memoryTracker);
    ...
    void shouldCreateBoltStateMachinesV42() {
        ...
        BoltStateMachine boltStateMachine =
                factory.newStateMachine(new BoltProtocolVersion(4, 2), CHANNEL, MapValue.EMPTY, memoryTracker);
    ...
    void shouldCreateBoltStateMachinesV43() {
        ...
        BoltStateMachine boltStateMachine =
                factory.newStateMachine(new BoltProtocolVersion(4, 3), CHANNEL, MapValue.EMPTY, memoryTracker);
    ...
    void shouldThrowExceptionIfVersionIsUnknown(int protocolVersion) {
        ...
        IllegalArgumentException error = assertThrows(
                ...
                () -> factory.newStateMachine(boltProtocolVersion, CHANNEL, MapValue.EMPTY, memoryTracker));
