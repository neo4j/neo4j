...
class RunMessageDecoderV44Test extends AbstractRunMessageDecoderTest<RunMessageDecoderV44> {
    ...
    @Override
    public RunMessageDecoderV44 getDecoder() {
        return RunMessageDecoderV44.getInstance();
    }
    ...
    void shouldReadMessage() throws PackstreamReaderException {
        ...
        meta.add("imp_user", Values.stringValue("Nodie"));
        ...
        Assertions.assertThat(msg.impersonatedUser()).isEqualTo("Nodie");
