...
import org.neo4j.bolt.protocol.common.transaction.AbstractCypherAdapterStreamTest;
...
class CypherAdapterStreamV44Test extends AbstractCypherAdapterStreamTest {
    ...
    void shouldIncludeQueryStatisticContainsSystemUpdates() throws Throwable {
        ...
        assertThat(meta.get("type")).isEqualTo(stringValue("rw"));
        assertThat(meta.get("stats"))
                .isEqualTo(mapValues("system-updates", intValue(1), "contains-system-updates", booleanValue(true)));
    }

    private static class TestAbstractCypherAdapterStream extends CypherAdapterStreamV44 {
        TestAbstractCypherAdapterStream(
                QueryExecution queryExecution, AdaptingBoltQuerySubscriber querySubscriber, Clock clock) {
