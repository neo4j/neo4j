...
public class SessionWorkerFacade implements Session
{
    ...
    @Override
    public <A> void create( final String clientName, final A attachment, final Callback<Void, A> callback )
    {
        queue( session -> session.create( clientName, attachment, callback ) );
    }
