...
public abstract class BookmarkParserException extends BoltRequestReaderException implements Status.HasStatus {
    ...
    public BookmarkParserException(String message) {
        super(message);
    }

    public BookmarkParserException(String message, Throwable cause) {
        super(message, cause);
    }

    public BookmarkParserException(Throwable cause) {
        super(cause);
    }
