...
public final class DiscardMessageDecoder implements StructReader<DiscardMessage> {
    ...
    @Override
    public DiscardMessage read(PackstreamBuf buffer, StructHeader header) throws PackstreamReaderException {
        if (header.length() != 1) {
