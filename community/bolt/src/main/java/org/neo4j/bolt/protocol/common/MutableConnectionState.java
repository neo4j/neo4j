...
public class MutableConnectionState implements ResponseHandler {
    ...
    /**
     * This is incremented each time {@link StateMachine#interrupt()} is called, and decremented each time a {@code RESET} message arrives. When this is above
     * 0, all messages will be ignored. This way, when a reset message arrives on the network, interrupt can be called to "purge" all the messages ahead of the
     * reset message.
     */
