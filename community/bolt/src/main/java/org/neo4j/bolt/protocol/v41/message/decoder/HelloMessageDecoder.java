...
public final class HelloMessageDecoder extends org.neo4j.bolt.protocol.v40.messaging.decoder.HelloMessageDecoder {
    ...
    public HelloMessage read(PackstreamBuf buffer, StructHeader header) throws PackstreamReaderException {
        ...
        Map<String, Object> meta = readMetaDataMap(buffer);
    ...
    private static RoutingContext parseRoutingContext(Map<String, Object> meta) throws PackstreamReaderException {
        var property = meta.getOrDefault(HelloMessage.ROUTING, null);
        ...
        var routingObjectMap = (Map<String, Object>) meta.getOrDefault(HelloMessage.ROUTING, null);
    ...
    private Map<String, Object> extractAuthToken(Map<String, Object> meta) {
        ...
        return meta.entrySet().stream()
                .filter(e -> !HelloMessage.ROUTING.equals(e.getKey()))
