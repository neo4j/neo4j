...
import static org.neo4j.bolt.v1.runtime.bookmarking.BookmarkWithPrefix.BOOKMARK_KEY;
import static org.neo4j.bolt.v1.runtime.bookmarking.BookmarkWithPrefix.BOOKMARK_TX_PREFIX;

public final class BookmarksParserV1 implements BookmarksParser
{
    public static final BookmarksParserV1 INSTANCE = new BookmarksParserV1();

    private static final String BOOKMARKS_KEY = "bookmarks";
    private static final Long ABSENT_BOOKMARK_ID = -1L;

    private BookmarksParserV1()
    {
    }
