...
public class UnsupportedUUIDTypeVersionedValueWriter extends AbstractUnknownTypeVersionedValueWriter {
    ...
    private static final UnsupportedUUIDTypeVersionedValueWriter INSTANCE =
            new UnsupportedUUIDTypeVersionedValueWriter();

    public static UnsupportedUUIDTypeVersionedValueWriter getInstance() {
        return INSTANCE;
    }
