...
To create a new database or ópen an existing one you instantiate an +link:javadocs/org/neo4j/kernel/EmbeddedGraphDatabase.html[EmbeddedGraphDatabase]+.
...
Or you could of course create you own +Map<String, String>+ programmatically and use that instead, like so:
