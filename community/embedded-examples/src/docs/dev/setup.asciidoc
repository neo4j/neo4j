...
To create a new database or ópen an existing one you instantiate a
+http://components.neo4j.org/neo4j/{neo4j-version}/apidocs/org/neo4j/graphdb/GraphDatabaseService.html[GraphDatabaseService]+.
