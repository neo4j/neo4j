...
.Quick info
***********
* Neo4j's configuration is found in _conf/neo4j.conf_.
...
The main configuration file for Neo4j is _conf/neo4j.conf_.
...
To enable HTTP logging, edit the _conf/neo4j.conf_ file to resemble the following:
