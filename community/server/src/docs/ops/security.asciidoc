...
To facilitate domain-specific authorization policies in Neo4j Server, +link:javadocs/org/neo4j/server/rest/security/SecurityRule.html[SecurityRules]+ can be implemented and
