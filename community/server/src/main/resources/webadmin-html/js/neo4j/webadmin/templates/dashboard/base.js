 ...
 */
define(function(){return function(vars){ with(vars||{}) { return "<div class=\"sidebar\"><h1 class=\"pad\">Neo4j web administration</h1><ul class=\"info_list\"><li><h3>Data url</h3><p>" + 
server.url + 
