(function() {
  ...
  */  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
  ...
  define(['neo4j/webadmin/models/VisualizationSettings', 'lib/backbone'], function(VisualizationSettings) {
    ...
    return ApplicationState = (function() {
      ...
      ApplicationState.prototype.getVisualizationSettings = function() {
        if (!(this.visualizationSettings != null)) {
          this.visualizationSettings = new VisualizationSettings();
          this.visualizationSettings.fetch();
        }
