...
import static org.neo4j.server.rest.dbms.AuthenticationService.AUTHENTICATE_PATH;
...
public class AuthorizationFilter implements Filter
{
    enum ErrorType
    {
        ...
        synchronized void reply( HttpServletResponse response, HttpServletRequest req ) throws IOException
        {
            ...
            String authUrl = req.getScheme() + "://" + req.getHeader( HttpHeaders.HOST ) + AUTHENTICATE_PATH;
