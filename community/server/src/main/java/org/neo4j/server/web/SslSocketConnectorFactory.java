...
public class SslSocketConnectorFactory extends HttpConnectorFactory
{
    ...
    private SslConnectionFactory createSslConnectionFactory( KeyStoreInformation config )
    {
        ...
        sslContextFactory.setKeyStorePath( config.path() );
        sslContextFactory.setKeyStorePassword( String.valueOf( config.password() ) );
        sslContextFactory.setKeyManagerPassword( String.valueOf( config.keyPassword() ) );
