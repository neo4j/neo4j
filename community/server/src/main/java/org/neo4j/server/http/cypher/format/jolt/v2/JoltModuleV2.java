...
/**
 * Differs in JoltV1 by string elementId only.
 */
enum JoltModuleV2 {
    ...
    JoltModuleV2(SimpleModule instance) {
    ...
    private static class JoltModuleImpl extends AbstractJoltModule {
        private JoltModuleImpl(boolean strictModeEnabled) {
            ...
            this.addSerializer(new JoltNodeSerializerV2());
            this.addSerializer(new JoltRelationshipSerializerV2());
            this.addSerializer(new JoltRelationshipReversedSerializerV2());
            this.addSerializer(new JoltPathSerializerV2());
        }
    }
}
