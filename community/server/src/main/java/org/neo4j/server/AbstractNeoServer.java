...
public abstract class AbstractNeoServer implements NeoServer
{
            ...
            GraphDatabaseFacadeFactory.Dependencies dependencies, LogProvider logProvider )
    {
        ...
        HttpConnector httpConnector = GraphDatabaseSettings.httpConnector( config, HttpConnector.Encryption.NONE )
                .orElseThrow( () ->
        ...
        Optional<HttpConnector> httpsConnector =
                GraphDatabaseSettings.httpConnector( config, HttpConnector.Encryption.TLS );
