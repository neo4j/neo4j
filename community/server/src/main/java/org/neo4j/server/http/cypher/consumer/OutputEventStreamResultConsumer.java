...
public class OutputEventStreamResultConsumer implements ResultConsumer {
    ...
    public OutputEventStreamResultConsumer(
    ...
    public void consume(BoltResult t) throws Throwable {
        outputEventStream.writeStatementStart(
                statement, Arrays.asList(statementMetadata.fieldNames().clone()));
        ...
        QueryExecutionType queryExecutionType =
                extractQueryExecutionType(outputEventStreamRecordConsumer.metadataMap());
        QueryStatistics queryStatistics =
                fromAnyValue(outputEventStreamRecordConsumer.metadataMap().getOrDefault(STATS, null));
        ...
        Iterable<Notification> notifications = iterableFromAnyValue(
                outputEventStreamRecordConsumer.metadataMap().getOrDefault(NOTIFICATIONS, null));
        outputEventStream.writeStatementEnd(
                queryExecutionType, queryStatistics, executionPlanDescription, notifications);
    }
