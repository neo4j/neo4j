...
/**
 * An extended SecurityRule which can also check for whether access is forbidden, despite proper authentication.
 *
 */
public interface ForbiddenSecurityRule extends SecurityRule {
