...
public class TypedJsonlTxManagingResultWriterV11 extends AbstractJsonlTxManagingResultWriter {
    public TypedJsonlTxManagingResultWriterV11(
            @Context InternalLog logger, @Context TransactionManager transactionManager) {
        super(logger, View.TYPED_JSON_V11, transactionManager);
    }
}
