...
public class FileUserRepository extends LifecycleAdapter implements UserRepository
{
    ...
    private volatile Map<String, User> usersByName = new ConcurrentHashMap<>();
    ...
    @Override
    public synchronized void save( User user ) throws IllegalTokenException, IOException
    {
        // Verify no other user has the same access token
