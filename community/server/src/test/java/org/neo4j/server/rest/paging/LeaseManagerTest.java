...
class LeaseManagerTest
{
    ...
    @Test
    void shouldNotAcceptLeasesWithNegativeTTL()
    {
    ...
    @Test
    void shouldRetrieveAnExistingLeaseImmediatelyAfterCreation()
    {
        FakeClock fakeClock = Clocks.fakeClock();
        LeaseManager manager = new LeaseManager( fakeClock );
    ...
    @Test
    void shouldRetrieveAnExistingLeaseSomeTimeAfterCreation()
    {
        FakeClock fakeClock = Clocks.fakeClock();
        LeaseManager manager = new LeaseManager( fakeClock );
    ...
    @Test
    void shouldNotRetrieveALeaseAfterItExpired()
    {
        FakeClock fakeClock = Clocks.fakeClock();
        LeaseManager manager = new LeaseManager( fakeClock );
    ...
    @Test
    void shouldNotBarfWhenAnotherThreadOrRetrieveRevokesTheLease()
    {
        FakeClock fakeClock = Clocks.fakeClock();
        LeaseManager manager = new LeaseManager( fakeClock );
