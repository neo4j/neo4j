...
class OutputEventStreamRecordConsumerTest {
    ...
    void setup() {
        ...
        results = new HashMap<>();
        subject = new OutputEventStreamRecordConsumer(
                boltResult, outputEventStream, transactionIndependentValueMapper, () -> results);
    }
    ...
    private static Stream<Map<String, AnyValue>> addMetadataValues() {
        return Stream.of(
                ...
                Map.of(
                        "floatList",
                        Values.floatArray(new float[] {3, 4.0f, 5.4f}),
                        "stringList",
