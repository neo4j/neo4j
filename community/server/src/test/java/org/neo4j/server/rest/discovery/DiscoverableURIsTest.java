...
{
    private final BoltConnector bolt = new BoltConnector( "bolt" );

    @Test
    public void shouldAdvertiseDataAndManagementURIs() throws Exception
    {
        DiscoverableURIs uris = DiscoverableURIs.defaults( Config.defaults(), null );
    ...
    {
        DiscoverableURIs uris = DiscoverableURIs.defaults(
    ...
    public void shouldLookupBoltPortInRegisterIfConfiguredTo0() throws Exception
    {
        ...
        DiscoverableURIs uris = DiscoverableURIs.defaults(
                Config.builder().withSetting( bolt.advertised_address, "apple.com:0" ).withSetting( bolt.enabled,
                        "true" ).build(), register );
    ...
    {
        DiscoverableURIs uris = DiscoverableURIs.defaults( Config.builder().build(), null );
