Feature: Webadmin data browser allows me to see and change details of a relationship
  ...
  Scenario: Create relationhips in webadmin
    ...
    Then The data browser item headline should change to http://localhost:7474/db/data/relationship/[0-9]+
  ...
  Scenario: Find relationnship by id in webadmin
    ...
    Then The data browser item headline should be http://localhost:7474/db/data/relationship/0
