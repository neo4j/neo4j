...
class CallInTransactionsExecutor extends SingleQueryFragmentExecutor {
    ...
    private final Fragment.CallInTransactions callInTransactions;

    CallInTransactionsExecutor(
            Fragment.CallInTransactions callInTransactions,
    ...
    Flux<Record> run(Record argument) {
        // TODO: A place holder for CALL IN TRANSACTION execution logic.
        return null;
    }
