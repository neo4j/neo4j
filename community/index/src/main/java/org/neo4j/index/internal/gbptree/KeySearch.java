...
class KeySearch
{
     ...
     * @param bTreeNode {@link TreeNodeV1} that knows how to operate on KEY and VALUE
     ...
     */
    static <KEY,VALUE> int search( PageCursor cursor, Content<KEY,VALUE> bTreeNode, KEY key,
    ...
    /**
     * Extracts the position from a search result from {@link #search(PageCursor, Content, Object, Object, int)}.
     *
     * @param searchResult search result from {@link #search(PageCursor, Content, Object, Object, int)}.
     ...
     * {@link #search(PageCursor, Content, Object, Object, int)}.
     *
     * @param searchResult search result form {@link #search(PageCursor, Content, Object, Object, int)}.
