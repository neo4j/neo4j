...
class LongSpinLatch
{
    ...
    private static final LongToLongFunction ACQUIRE_WRITE_LOCK_CLEAR_READ_LOCKS = bits -> (bits & TREE_NODE_ID_MASK) | WRITE_LOCK_MASK;
    private static final LongToLongFunction RELEASE_WRITE_LOCK = bits -> markAsDeadIfNoLocksLeft( bits & ~WRITE_LOCK_MASK );
    ...
    public String toString()
    {
        ...
        return format( "Lock[%d,w:%b,r:%d]", treeNodeIdFromBits( bits ), (bits & WRITE_LOCK_MASK) != 0, bits & READ_LOCK_MASK );
    }
}
