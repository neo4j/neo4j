...
public class IndexTest
{
    ...
    public void shouldReadWrittenMetaData() throws Exception
    {
        // GIVEN
        int pageSize = 1024;
        SCIndexDescription expectedDescription = new SCIndexDescription( "a", "b", "c", OUTGOING, "d", null );
        File indexFile = folder.newFile( "index" );
        try ( Index index = new Index( pageCache, indexFile, expectedDescription, pageSize ) )
        ...
        try ( Index index = new Index( pageCache, indexFile ) )
        {
            ...
            // THEN
            assertEquals( expectedDescription, readDescription );
        }
    }
}
