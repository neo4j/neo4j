...
public class MyCoreAPI
{
    ...
    {
        long result;
        try ( Transaction tx = graph.beginTransaction( KernelTransaction.Type.explicit, SecurityContext.Static.WRITE ) )
        {
    ...
    {
        long result;
        try ( Transaction tx = graph.beginTransaction( KernelTransaction.Type.explicit, SecurityContext.Static.READ ) )
        {
            Statement statement = this.txBridge.get();
