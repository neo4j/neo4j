...
class WithinBBoxTest
{
    ...
    void handleCrossing0thMeridian()
    {
        ...
        assertThat( withinBBox( pointValue( WGS_84, -1.5, 63 ), lowerLeft, upperRight )).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, -1, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, 0.5, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
    ...
    void handleCrossing180thMeridian()
    {
        ...
        assertThat( withinBBox( pointValue( WGS_84, 178.5, 63 ), lowerLeft, upperRight )).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 179, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, 179.5, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, 180, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, -179.5, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, -179, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, -178.5, 63 ), lowerLeft, upperRight )).isEqualTo( FALSE );
    }
    ...
    void handleCrossingTheEquator()
    {
        ...
        assertThat( withinBBox( pointValue( WGS_84, 15, -1.5 ), lowerLeft, upperRight )).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 15, -1 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, 15, -0.5 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, 15, 0 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, 15, 0.5 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, 15, 1.0 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, 15, 1.5 ), lowerLeft, upperRight )).isEqualTo( FALSE );
    }
    ...
    void handleLowerLeftWestOfUpperRightWesternHemisphere()
    {
        ...
        assertThat( withinBBox( pointValue( WGS_84, 11, 63 ), lowerLeft, upperRight )).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 10, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
    ...
    void handleLowerLeftEastOfUpperRightWesternHemisphere()
    {
        ...
        assertThat( withinBBox( pointValue( WGS_84, 11, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, 10, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
    ...
    void handleLowerWestOfUpperRightEasternHemisphere()
    {
        ...
        assertThat( withinBBox( pointValue( WGS_84, -140, 63 ), lowerLeft, upperRight )).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, -150, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, -151, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, -155, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, -159, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, -160, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, -170, 63 ), lowerLeft, upperRight )).isEqualTo( FALSE );
    }
    ...
    void handleLowerLeftEastOfUpperRightEasternHemisphere()
    {
        ...
        assertThat( withinBBox( pointValue( WGS_84, -140, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, -150, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, -151, 63 ), lowerLeft, upperRight )).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, -155, 63 ), lowerLeft, upperRight )).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, -159, 63 ), lowerLeft, upperRight )).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, -160, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, -170, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
    }
    ...
    void handleLowerWestOfUpperRightCrossingHemispheres()
    {
        ...
        assertThat( withinBBox( pointValue( WGS_84, 170, 63 ), lowerLeft, upperRight )).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 175, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, 180, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, -175, 63 ), lowerLeft, upperRight )).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, -170, 63 ), lowerLeft, upperRight )).isEqualTo( FALSE );
    }
    ...
    void handleLowerLeftEastOfUpperRightCrossingHemispheres()
    {
        ...
        assertThat( withinBBox( pointValue( WGS_84, 170, 63 ), lowerLeft, upperRight ) ).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, 175, 63 ), lowerLeft, upperRight ) ).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, 180, 63 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, -175, 63 ), lowerLeft, upperRight ) ).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, -170, 63 ), lowerLeft, upperRight ) ).isEqualTo( TRUE );
    }
    ...
    void handleLowerLeftSouthOfUpperRightNorthernHemisphere()
    {
        ...
        assertThat( withinBBox( pointValue( WGS_84, 35, 55 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 35, 60 ), lowerLeft, upperRight ) ).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, 35, 65 ), lowerLeft, upperRight ) ).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, 35, 70 ), lowerLeft, upperRight ) ).isEqualTo( TRUE );
        assertThat( withinBBox( pointValue( WGS_84, 35, 75 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
    }
    ...
    void handleLowerLeftNorthOfUpperNorthernHemisphere()
    {
        ...
        assertThat( withinBBox( pointValue( WGS_84, 35, 55 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 35, 60 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 35, 65 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 35, 70 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 35, 75 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
    }
    ...
    void handleLowerLeftSouthOfUpperRightCrossingEquator()
    {
        ...
        assertThat( withinBBox( pointValue( WGS_84, 35, -15 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 35, -10 ), lowerLeft, upperRight ) ).isEqualTo( TRUE );
    ...
    void handleLowerLeftNorthOfUpperRightCrossingEquator()
    {
        ...
        assertThat( withinBBox( pointValue( WGS_84, 35, -15 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 35, -10 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
    ...
    void handleBothDirectionsShifted()
    {
        ...
        assertThat( withinBBox( pointValue( WGS_84, 45, 30 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 40, 30 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 35, 30 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 30, 30 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 25, 30 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );

        assertThat( withinBBox( pointValue( WGS_84, 30, 45 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 30, 40 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 30, 35 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 30, 30 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
        assertThat( withinBBox( pointValue( WGS_84, 30, 25 ), lowerLeft, upperRight ) ).isEqualTo( FALSE );
    }
}
