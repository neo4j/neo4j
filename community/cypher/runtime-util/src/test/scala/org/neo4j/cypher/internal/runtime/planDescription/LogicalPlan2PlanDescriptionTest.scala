...
class LogicalPlan2PlanDescriptionTest extends CypherFunSuite with TableDrivenPropertyChecks {
  ...
  test("tests") {
    ...
    val lhsLP = AllNodesScan("a", Set.empty)
    ...
    val rhsLP = AllNodesScan("b", Set.empty)
    ...
    val modeCombinations = Table(
      ...
      , NodeByLabelScan("node", AstLabelName("X")(DummyPosition(0)), Set.empty) ->
      ...
      , NodeIndexSeek("x", LabelToken("Label", LabelId(0)), Seq(PropertyKeyToken("Prop", PropertyKeyId(0))), ManyQueryExpression(ListLiteral(Seq(StringLiteral("Andres")(pos)))(pos)), Set.empty) ->
      ...
      , NodeUniqueIndexSeek("x", LabelToken("Lebal", LabelId(0)), Seq(PropertyKeyToken("Porp", PropertyKeyId(0))), ManyQueryExpression(ListLiteral(Seq(StringLiteral("Andres")(pos)))(pos)), Set.empty) ->
      ...
      , Expand(lhsLP, "a", SemanticDirection.OUTGOING, Seq.empty, "b", "r1", ExpandAll) ->
      ...
      , Expand(lhsLP, "a", SemanticDirection.OUTGOING, Seq.empty, "a", "r1", ExpandInto) ->
      ...
      , NodeHashJoin(Set("a"), lhsLP, rhsLP) ->
