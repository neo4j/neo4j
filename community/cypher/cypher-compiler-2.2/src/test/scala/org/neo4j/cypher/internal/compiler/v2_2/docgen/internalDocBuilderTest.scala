...
//
//import org.neo4j.cypher.internal.compiler.v2_2.ast.{AllNodes, ASTNode}
...
//
//class InternalDocBuilderTest extends DocBuilderTestSuite[Any] {
//
//  val docBuilder = internalDocBuilder
//
//  case class Container(v: Any)
//
//  test("should render logical plans inside containers") {
//    val result = format(Container(AllNodesScan(IdName("a"), Set.empty)))
//    result should equal("Container(AllNodesScan[a](a, Set()))")
//  }
//
//}
