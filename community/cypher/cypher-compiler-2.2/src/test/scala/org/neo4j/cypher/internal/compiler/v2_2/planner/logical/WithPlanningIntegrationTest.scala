...
class WithPlanningIntegrationTest extends CypherFunSuite with LogicalPlanningTestSupport2 {
  ...
  test("should build plans that contain multiple WITH") {
    ...
    resultText should equal(
      ...
      "Projection(Limit(Expand(Apply(Limit(AllNodesScan(IdName(a),Set()),UnsignedDecimalIntegerLiteral(1)),Argument(Set(IdName(a)))),IdName(a),OUTGOING,OUTGOING,List(),IdName(b),IdName(r1),ExpandAll,List()),UnsignedDecimalIntegerLiteral(1)),Map(b -> Identifier(b)))")
  }
  ...
  test("should build plans for two matches separated by WITH") {
    ...
    result.toString should equal(
      "Projection(Expand(Apply(Limit(AllNodesScan(IdName(a),Set()),UnsignedDecimalIntegerLiteral(1)),Argument(Set(IdName(a)))),IdName(a),OUTGOING,OUTGOING,List(),IdName(b),IdName(r),ExpandAll,List()),Map(b -> Identifier(b)))")
  }
  ...
  test("should build plans that project endpoints of re-matched directed relationship arguments") {
    ...
    plan.toString should equal(
      "Projection(Selection(List(Equals(Identifier(u),Identifier(u$$$_))),Apply(Limit(Expand(AllNodesScan(IdName(b),Set()),IdName(b),INCOMING,OUTGOING,List(),IdName(a),IdName(r),ExpandAll,List()),UnsignedDecimalIntegerLiteral(1)),ProjectEndpoints(AllNodesScan(IdName(u),Set(IdName(r))),IdName(r),IdName(u$$$_),IdName(v),true,SimplePatternLength))),Map(r -> Identifier(r)))")
  }
  ...
  test("should build plans that project endpoints of re-matched reversed directed relationship arguments") {
    ...
    plan.toString should equal(
      "Projection(Selection(List(Equals(Identifier(a),Identifier(a$$$_))),Apply(Limit(Expand(AllNodesScan(IdName(b),Set()),IdName(b),INCOMING,OUTGOING,List(),IdName(a),IdName(r),ExpandAll,List()),UnsignedDecimalIntegerLiteral(1)),ProjectEndpoints(Argument(Set(IdName(a), IdName(r))),IdName(r),IdName(a$$$_),IdName(b2),true,SimplePatternLength))),Map(r -> Identifier(r)))")
  }
  ...
  test("should build plans that verify endpoints of re-matched directed relationship arguments") {
    ...
    plan.toString should equal(
      "Projection(Selection(List(Equals(Identifier(a),Identifier(a$$$_)), Equals(Identifier(b),Identifier(b$$$_))),Apply(Limit(Expand(AllNodesScan(IdName(b),Set()),IdName(b),INCOMING,OUTGOING,List(),IdName(a),IdName(r),ExpandAll,List()),UnsignedDecimalIntegerLiteral(1)),ProjectEndpoints(Argument(Set(IdName(a), IdName(b), IdName(r))),IdName(r),IdName(a$$$_),IdName(b$$$_),true,SimplePatternLength))),Map(r -> Identifier(r)))")
  }
