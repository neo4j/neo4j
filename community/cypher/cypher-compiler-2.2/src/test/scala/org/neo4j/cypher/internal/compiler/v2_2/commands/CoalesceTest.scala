...
import org.neo4j.cypher.internal.compiler.v2_2.commands.expressions.{CoalesceFunction, Expression, Literal, Null}
import org.neo4j.cypher.internal.compiler.v2_2.pipes.{QueryState, QueryStateHelper}
