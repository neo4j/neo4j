...
import org.neo4j.cypher.internal.compiler.v2_2.planner.logical.cardinality.assumeDependence.groupPredicates._

object combinePredicates {
  def default: (Set[(PredicateCombination, Selectivity)]) => (Set[Predicate], Selectivity) = assumeDependence
