...
import org.neo4j.cypher.internal.compiler.v2_2.{PropertyKeyId, ast}
import org.neo4j.cypher.internal.compiler.v2_2.ast.{PropertyKeyName, LabelName}
...
case class SingleExpression(lhs: ast.Expression) extends PredicateCombination {
  def containedPredicates = Set(ExpressionPredicate(lhs))
}
