...
abstract class LogicalPlan extends Product with internalDocBuilder.GeneratorToString[LogicalPlan] {
...
final case class PatternRelationship(name: IdName, nodes: (IdName, IdName), dir: Direction, types: Seq[RelTypeName], length: PatternLength)
  extends internalDocBuilder.GeneratorToString[PatternRelationship] {
...
trait PatternLength extends internalDocBuilder.GeneratorToString[PatternLength] {
