...
sealed trait ReturnItems extends ASTNode with ASTTerm with SemanticCheckable {
...
sealed trait ReturnItem extends ASTNode with ASTTerm with SemanticCheckable {
