...
import org.neo4j.cypher.internal.runtime.interpreted.commands.expressions.{Length3_5Function, Variable}
import org.neo4j.cypher.internal.runtime.{ExecutionContext, PathImpl}
...
class Length3_5FunctionTest extends CypherFunSuite {
  ...
  test("length3_5 cannot be used on numbers") {
    //given
    val n = 123
    val m = ExecutionContext.from("n" -> intValue(n))
