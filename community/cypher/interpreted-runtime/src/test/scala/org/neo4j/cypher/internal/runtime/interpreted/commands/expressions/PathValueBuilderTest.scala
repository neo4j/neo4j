...
class PathValueBuilderTest extends CypherFunSuite {
  ...
  test("p = (a)") {
    ...
    builder.result() should equal(fromPath(PathImpl(A)))
  }
  ...
  test("p = (a)-[r:X]->(b)") {
    ...
    builder.result() should equal(fromPath(PathImpl(A, rel1, B)))
  }
  ...
  test("p = (b)<-[r:X]-(a)") {
    ...
    builder.result() should equal(fromPath(PathImpl(B, rel1, A)))
  }
  ...
  test("p = (a)-[r:X*]->(b)") {
    ...
    builder.result() should equal(fromPath(PathImpl(A, rel1, B, rel2, C)))
  }
  ...
  test("p = (b)<-[r:X*]-(a)") {
    ...
    builder.result() should equal(fromPath(PathImpl(C, rel2, B, rel1, A)))
  }
  ...
  test("p = (a)-[r1*]-()-[r2*]-()") {
    ...
    builder.result() should equal(fromPath(PathImpl(A, rel1, B, rel2, C, rel3, D, rel4, E)))
  }
  ...
  test("p = (b)-[r:X*0]-(a)") {
    ...
    builder.result() should equal(fromPath(PathImpl(C)))
  }
