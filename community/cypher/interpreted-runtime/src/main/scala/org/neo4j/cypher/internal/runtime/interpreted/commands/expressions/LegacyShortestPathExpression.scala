...
case class LegacyShortestPathExpression(
  ...
  override def rewrite(f: Expression => Expression): Expression =
    f(LegacyShortestPathExpression(shortestPathPattern.rewrite(f), operatorId = operatorId))
...
object LegacyShortestPathExpression {
