...
import org.neo4j.cypher.internal.compiler.v3_2.commands.{Pattern, RelatedTo, VarLengthRelatedTo}
import org.neo4j.cypher.internal.compiler.v3_2.pipes.matching.{PatternGraph, PatternNode, PatternRelationship}
