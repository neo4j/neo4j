...
import org.neo4j.cypher.internal.compiler.v3_2.commands.expressions.{CachedExpression, Add, Literal, Variable}
...
import org.neo4j.cypher.internal.compiler.v3_2.pipes.{PipeMonitor, Top1Pipe, TopNPipe}
