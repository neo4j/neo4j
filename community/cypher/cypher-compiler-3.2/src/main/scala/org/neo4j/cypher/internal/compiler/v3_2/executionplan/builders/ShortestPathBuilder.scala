...
import org.neo4j.cypher.internal.compiler.v3_2.commands.{Pattern, ShortestPath}
import org.neo4j.cypher.internal.compiler.v3_2.executionplan.{PlanBuilder, ExecutionPlanInProgress}
import org.neo4j.cypher.internal.compiler.v3_2.pipes.{PipeMonitor, ShortestPathPipe, Pipe}
