...
import org.neo4j.cypher.internal.compiler.v3_2.pipes.{EagerPipe, LoadCSVPipe, Pipe}
import org.neo4j.cypher.internal.frontend.v3_2.notification.{InternalNotification, EagerLoadCsvNotification}
