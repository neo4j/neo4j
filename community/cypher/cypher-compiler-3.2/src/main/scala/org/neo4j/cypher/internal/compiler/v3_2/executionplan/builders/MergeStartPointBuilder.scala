...
import org.neo4j.cypher.internal.compiler.v3_2.commands.predicates.{Equals, HasLabel}
import org.neo4j.cypher.internal.compiler.v3_2.executionplan.{PartiallySolvedQuery, PlanBuilder}
...
import org.neo4j.cypher.internal.compiler.v3_2.commands.expressions.{Variable, Property}
import org.neo4j.cypher.internal.compiler.v3_2.commands.values.KeyToken
import org.neo4j.cypher.internal.compiler.v3_2.mutation.UniqueMergeNodeProducers
import org.neo4j.cypher.internal.compiler.v3_2.mutation.MergeNodeAction
import org.neo4j.cypher.internal.compiler.v3_2.executionplan.ExecutionPlanInProgress
import org.neo4j.cypher.internal.compiler.v3_2.commands.SchemaIndex
import org.neo4j.cypher.internal.compiler.v3_2.mutation.PlainMergeNodeProducer
