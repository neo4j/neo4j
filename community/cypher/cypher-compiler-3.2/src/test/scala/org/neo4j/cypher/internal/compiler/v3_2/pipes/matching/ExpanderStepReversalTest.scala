...
import org.neo4j.cypher.internal.compiler.v3_2.commands.expressions.{Expression, Variable, Literal, Property}
import org.neo4j.cypher.internal.compiler.v3_2.commands.predicates.{Equals, True, Predicate}
