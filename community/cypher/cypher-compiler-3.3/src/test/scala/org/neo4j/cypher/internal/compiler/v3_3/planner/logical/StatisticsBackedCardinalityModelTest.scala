...
import org.neo4j.cypher.internal.compiler.v3_3.planner.logical.cardinality.CardinalityModelTestHelper
import org.neo4j.cypher.internal.compiler.v3_3.planner.logical.cardinality.assumeIndependence.AssumeIndependenceQueryGraphCardinalityModel
import org.neo4j.cypher.internal.compiler.v3_3.spi.GraphStatistics
import org.neo4j.cypher.internal.frontend.v3_3.test_helpers.CypherFunSuite

class StatisticsBackedCardinalityModelTest
  ...
  test("query containing a WITH and aggregation vol. 2") {
    ...
    givenPattern("MATCH (a:Person)-[:REL2]->(b) WITH a, count(*) as c MATCH (a)-[:REL]->()")
      ...
      .shouldHavePlannerQueryCardinality(produceCardinalityModel)(
        aggregation * allNodes * relCount / (personCount * allNodes))
  }
