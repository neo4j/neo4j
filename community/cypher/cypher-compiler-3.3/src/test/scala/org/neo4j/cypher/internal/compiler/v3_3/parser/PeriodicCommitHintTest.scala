...
import org.neo4j.cypher.internal.frontend.v3_3.parser.Query
...
class PeriodicCommitHintTest extends ParserTest[ast.PeriodicCommitHint, Any] with Query {
  ...
  test("tests") {
    ...
    parsing("USING PERIODIC COMMIT 300") shouldGive ast.PeriodicCommitHint(
      Some(ast.SignedDecimalIntegerLiteral("300")(t)))(t)
  }
