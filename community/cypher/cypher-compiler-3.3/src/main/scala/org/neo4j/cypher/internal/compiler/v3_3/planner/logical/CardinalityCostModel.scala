...
object CardinalityCostModel extends CostModel {
  ...
  private def costPerRow(plan: LogicalPlan): CostPerRow = plan match {
    ...
    case _: NodeByLabelScan | _: NodeIndexScan | _: ProjectEndpoints => 1.0
    ...
    case _: Expand | _: VarExpand => 1.5

    case _: NodeUniqueIndexSeek | _: NodeIndexSeek | _: NodeIndexContainsScan | _: NodeIndexEndsWithScan => 1.9

    case _: NodeByIdSeek | _: DirectedRelationshipByIdSeek | _: UndirectedRelationshipByIdSeek => 6.2

    case _: NodeHashJoin | _: Aggregation | _: AbstractLetSemiApply | _: Limit | _: Optional | _: SingleRow |
        _: Argument | _: OuterHashJoin | _: AbstractSemiApply | _: Skip | _: Sort | _: Union | _: Selection |
        _: ValueHashJoin | _: UnwindCollection | _: ProcedureCall =>
      DEFAULT_COST_PER_ROW

    case _: FindShortestPaths | _: DirectedRelationshipByIdSeek | _: UndirectedRelationshipByIdSeek => 12.0
