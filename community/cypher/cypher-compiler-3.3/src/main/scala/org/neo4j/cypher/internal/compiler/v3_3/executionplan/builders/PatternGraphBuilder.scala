...
import org.neo4j.cypher.internal.compiler.v3_3.commands.{Pattern, RelatedTo, VarLengthRelatedTo}
import org.neo4j.cypher.internal.compiler.v3_3.pipes.matching.{PatternGraph, PatternNode, PatternRelationship}
