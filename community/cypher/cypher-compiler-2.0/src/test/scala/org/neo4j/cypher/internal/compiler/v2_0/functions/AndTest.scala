...
class AndTest extends FunctionTestBase("AND") {

  @Test
  def shouldFailIfWrongArguments() {
    testInvalidApplication(CTBoolean)("Insufficient parameters for function 'AND'")
    testInvalidApplication(CTBoolean, CTBoolean, CTBoolean)("Too many parameters for function 'AND'")
  }
