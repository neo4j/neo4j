...
import org.neo4j.cypher.internal.compiler.v2_0.pipes.matching.{PatternGraph, PatternRelationship, PatternNode}
import org.neo4j.cypher.internal.compiler.v2_0.commands.{Pattern, VarLengthRelatedTo, RelatedTo}
