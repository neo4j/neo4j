...
case class RightOuterHashJoin(nodes: Set[String],
  ...
  /**
    * Cached properties from lhs cannot be used if they refer to a join key node. This is because outer
