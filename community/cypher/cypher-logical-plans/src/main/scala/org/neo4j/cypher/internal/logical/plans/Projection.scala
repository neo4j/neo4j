 ...
 * the expression.
 */
case class Projection(override val source: LogicalPlan, projectExpressions: Map[String, Expression])(implicit
idGen: IdGen) extends LogicalUnaryPlan(idGen) with ProjectingPlan {
