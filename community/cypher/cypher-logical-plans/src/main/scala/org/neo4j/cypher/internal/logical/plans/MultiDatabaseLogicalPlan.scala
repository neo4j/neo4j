...
case class CreateUser(userName: String, initialStringPassword: Option[Array[Byte]], initialParameterPassword: Option[Parameter],
                      requirePasswordChange: Boolean, suspended: Option[Boolean], allowExistingUser: Boolean)(implicit idGen: IdGen) extends SecurityAdministrationLogicalPlan
...
case class CreateRole(source: Option[SecurityAdministrationLogicalPlan], roleName: String, allowExistingRole: Boolean)(implicit idGen: IdGen) extends SecurityAdministrationLogicalPlan(source)
...
case class CreateDatabase(normalizedName: NormalizedDatabaseName, allowExistingDatabase: Boolean)(implicit idGen: IdGen) extends DatabaseAdministrationLogicalPlan
