...
case class AssertValidRevoke(source: Option[PrivilegePlan], action: AdminAction, scope: GraphScope, roleName: String)(implicit idGen: IdGen) extends PrivilegePlan
