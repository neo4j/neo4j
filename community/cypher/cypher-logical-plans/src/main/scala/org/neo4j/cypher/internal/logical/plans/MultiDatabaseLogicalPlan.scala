...
case class CreateDatabase(normalizedName: NormalizedDatabaseName, replace: Boolean, allowExistingDatabase: Boolean)(implicit idGen: IdGen) extends DatabaseAdministrationLogicalPlan
