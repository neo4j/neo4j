...
import org.neo4j.cypher.internal.runtime.interpreted.pipes.AbstractConcurrentTransactionApplyPipe
...
case class ConcurrentTransactionApplySlottedPipe(
  ...
  statusSlot: Option[Slot]
    ...
    extends AbstractConcurrentTransactionApplyPipe(source, inner, batchSize, concurrency, onErrorBehaviour) {
