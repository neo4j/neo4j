...
import org.neo4j.cypher.internal.frontend.v3_5.ast.{Statement, UnaliasedReturnItem}
import org.neo4j.cypher.internal.frontend.v3_5.helpers.rewriting.{RewriterCondition, RewriterStepSequencer}
...
class ASTRewriter(rewriterSequencer: (String) => RewriterStepSequencer,
  ...
  import org.neo4j.cypher.internal.frontend.v3_5.helpers.rewriting.RewriterStep._
