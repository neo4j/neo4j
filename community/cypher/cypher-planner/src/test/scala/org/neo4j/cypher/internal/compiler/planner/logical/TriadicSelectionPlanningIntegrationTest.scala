...
class TriadicSelectionPlanningIntegrationTest extends CypherFunSuite with LogicalPlanningIntegrationTestSupport {
  ...
  private val planner = plannerBuilder()
    ...
    .setLabelCardinality("Y", 100)
    .setLabelCardinality("Z", 100)
    ...
    .setRelationshipCardinality("(:X)-[:A]->()", 10)
    .setRelationshipCardinality("()-[:A]->(:X)", 10)
    .setRelationshipCardinality("()-[:B]->()", 10)
    .setRelationshipCardinality("(:X)-[]->(:Y)", 10)
    .setRelationshipCardinality("(:Y)-[]->(:Y)", 10)
    .setRelationshipCardinality("(:Y)-[]->(:Z)", 10)
    .setRelationshipCardinality("(:X)-[]->(:Z)", 10)
    .setRelationshipCardinality("(:Z)-[]->(:Z)", 10)
    .setRelationshipCardinality("()-[]->(:Y)", 10)
    .setRelationshipCardinality("()-[]->(:Z)", 10)
    .build()
