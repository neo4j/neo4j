...
class EagerWhereNeededRewriterTest extends CypherPlannerTestSuite with LogicalPlanTestOps
  ...
  test("inserts eager between property set and all properties read in nested plan expression") {
    ...
    rewrittenPlan should equal(
      new LogicalPlanBuilder()
        ...
        .projection(Map("ps" -> nestedPlanExpression))
        .eager(ListSet(
          PropertyReadSetConflict(propName("prop")).withConflict(Conflict(Id(2), Id(0))),
          PropertyReadSetConflict(propName("prop")).withConflict(Conflict(Id(2), Id(1)))
        ))
        .setNodeProperty("n", "prop", "5")
        .allNodeScan("n")
        .build()
  ...
  test("inserts eager between label set and all labels read in nested plan expression") {
    ...
    rewrittenPlan should equal(
      new LogicalPlanBuilder()
        ...
        .projection(Map("lbs" -> nestedPlanExpression))
        .eager(ListSet(
          LabelReadSetConflict(labelName("N")).withConflict(Conflict(Id(2), Id(0))),
          LabelReadSetConflict(labelName("N")).withConflict(Conflict(Id(2), Id(1)))
        ))
        .setLabels("n", "N")
        .allNodeScan("n")
        .build()
  ...
  test("inserts eager between conflicting plans at the cardinality minimum between the two plans") {
    val planBuilder = new LogicalPlanBuilder()
      ...
      .expand("(n)-[r]->(m)").withCardinality(50)
  ...
  test(
    ...
    val planBuilder = new LogicalPlanBuilder()
      ...
      .expand("(n)-[r2]->(o)").withCardinality(20) // Minimum of both conflicts
      .expand("(n)-[r1]->(m)").withCardinality(50)
  ...
  test(
    ...
    val planBuilder = new LogicalPlanBuilder()
      ...
      .expand("(n)-[r3]->(p)").withCardinality(50)
      .projection("n.prop AS prop").withCardinality(50)
      .expand("(n)-[r2]->(o)").withCardinality(10) // Minimum of both conflicts
      .setNodeProperty("n", "foo", "5").withCardinality(50)
      .expand("(n)-[r1]->(m)").withCardinality(50)
      .setNodeProperty("n", "prop", "5").withCardinality(100)
      .unwind("[1,2] AS x").newVar("x", CTInteger).withCardinality(100)
  ...
  test(
    ...
    val planBuilder = new LogicalPlanBuilder()
      .produceResults("foo").withCardinality(25)
      .projection("n.foo AS foo").withCardinality(100)
      .expand("(n)-[r3]->(p)").withCardinality(5) // Minimum of foo conflict
      .projection("n.prop AS prop").withCardinality(50)
      .expand("(n)-[r2]->(o)").withCardinality(10) // Minimum of prop conflict (in intersection)
      .setNodeProperty("n", "foo", "5").withCardinality(50)
      .expand("(n)-[r1]->(m)").withCardinality(50)
      .setNodeProperty("n", "prop", "5").withCardinality(100)
      .unwind("[1,2] AS x").newVar("x", CTInteger).withCardinality(100)
  ...
  test(
    ...
    val planBuilder = new LogicalPlanBuilder()
      .produceResults("foo").withCardinality(25)
      .projection("n.foo AS foo").withCardinality(100)
      .expand("(n)-[r3]->(p)").withCardinality(15)
      .projection("n.prop AS prop").withCardinality(50)
      .expand("(n)-[r2]->(o)").withCardinality(10) // Minimum of foo conflict (in intersection)
      .setNodeProperty("n", "foo", "5").withCardinality(50)
      .expand("(n)-[r1]->(m)").withCardinality(5) // Minimum of prop conflict
      .setNodeProperty("n", "prop", "5").withCardinality(100)
      .unwind("[1,2] AS x").newVar("x", CTInteger).withCardinality(100)
      .allNodeScan("n").withCardinality(50)
    val plan = planBuilder.build()
  ...
  test(
    ...
    val planBuilder = new LogicalPlanBuilder()
      ...
      .expand("(n)-[r2]->(o)").withCardinality(8) // Minimum of intersection
