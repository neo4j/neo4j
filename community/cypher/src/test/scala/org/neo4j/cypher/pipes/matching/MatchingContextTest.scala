...
//    val matchingContext = new MatchingContext(patterns)
//
//    assert(matchingContext.getMatches(Map("a" -> a)).toSet === Set(Map("a" -> a, "r1" -> r1, "b" -> b, "c" -> c), Map("a" -> a, "r1" -> r1, "b" -> b, "c" -> d)))
//  }
//
...
//    val matchingContext = new MatchingContext(patterns)
//
//    assert(matchingContext.getMatches(Map("a" -> a)).toSet === Set(Map("a" -> a, "r1" -> r1, "b" -> b, "c" -> c)))
//  }
//
...
//    val matchingContext = new MatchingContext(patterns)
//
//    assert(matchingContext.getMatches(Map("a" -> a)).toSet === Set(Map("a" -> a, "x" -> b),Map("a" -> a, "x" -> c),Map("a" -> a, "x" -> d)))
//  }
//
...
//    val matchingContext = new MatchingContext(patterns)
//
//    assert(matchingContext.getMatches(Map("a" -> a, "x" -> d)).toSet === Set(Map("a" -> a, "x" -> d)))
//  }
  ...
  @Test def variableLengthPathInDiamond() {
    ...
    assert(matchingContext.getMatches(Map("a" -> a)).toSet ===
      Set(Map("a" -> a, "r1" -> r1, "b" -> b, "c" -> c, "r2" -> r2), Map("a" -> a, "r1" -> r2, "b" -> c, "c" -> b, "r2" -> r1)))
  }
