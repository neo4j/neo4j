...
class SyntaxExceptionTest extends JUnitSuite with Assertions {
  @Test def shouldRaiseErrorWhenMissingIndexValue() {
    test("start s = node:index(key=) return s",
      ...
      v2_0peg -> "Invalid input ')': expected whitespace, \"...string...\" or a parameter (line 1, column 26)"
    )
  }
  ...
  @Test def shouldGiveNiceErrorWhenMissingEqualsSign() {
    test("start n=node:customer(id : {id}) return n",
      v2_0    -> "`=` expected",
      v2_0peg -> "Invalid input ':': expected whitespace, comment or '=' (line 1, column 26)"
    )
  }
  ...
  @Test def shouldRaiseErrorWhenMissingIndexKey() {
    test("start s = node:index(=\"value\") return s",
      v2_0    -> "Need index key",
      v2_0peg -> "Invalid input '=': expected whitespace, an identifier, \"...string...\" or a parameter (line 1, column 22)"
    )
  }
  ...
  @Test def startWithoutNodeOrRel() {
    test("start s return s",
      ...
      v2_0peg -> "Invalid input 'r': expected whitespace, comment or '=' (line 1, column 9)"
    )
  }
  ...
  @Test def shouldRaiseErrorWhenMissingReturn() {
    test("start s = node(0)",
      ...
      v2_0peg -> "Query must conclude with RETURN, WITH or an update clause (line 1, column 18)"
    )
  }
  ...
  @Test def shouldWarnAboutMissingStart() {
    test("where s.name = 'Name' and s.age = 10 return s",
      ...
      v2_0peg -> "Query must begin with START, MATCH or CREATE (line 1, column 1)"
    )
  }
  ...
  @Test def shouldComplainAboutWholeNumbers() {
    test("start s=node(0) return s limit -1",
      ...
      v2_0peg -> "Invalid input '-': expected whitespace, comment, an unsigned integer or a parameter (line 1, column 32)"
    )
  }
  ...
  @Test def matchWithoutIdentifierHasToHaveParenthesis() {
    test("start a = node(0) match a--b, --> a return a",
      ...
      v2_0peg -> "Invalid input '-': expected whitespace, comment or a pattern (line 1, column 31)"
    )
  }
  ...
  @Test def matchWithoutIdentifierHasToHaveParenthesis2() {
    test("start a = node(0) match (a) -->, a-->b return a",
      v2_0    -> "expected an expression that is a node",
      v2_0peg -> "Invalid input ',': expected whitespace or a node pattern (line 1, column 32)"
    )
  }
  ...
  @Test def shouldComplainAboutAStringBeingExpected() {
    test("start s=node:index(key = value) return s",
      v2_0    -> "string literal or parameter expected",
      v2_0peg -> "Invalid input 'v': expected whitespace, comment, \"...string...\" or a parameter (line 1, column 26)"
    )
  }
  ...
  @Test def shortestPathCanNotHaveMinimumDepth() {
    test("start a=node(0), b=node(1) match p=shortestPath(a-[*2..3]->b) return p",
      ...
      v2_0peg -> "shortestPath does not support a minimal length (line 1, column 36)"
    )
  }
  ...
  @Test def shortestPathCanNotHaveMultipleLinksInIt() {
    test("start a=node(0), b=node(1) match p=shortestPath(a-->()-->b) return p",
      ...
      v2_0peg -> "shortestPath requires a pattern containing a single relationship (line 1, column 36)"
    )
  }
  ...
  @Test def oldNodeSyntaxGivesHelpfulError() {
    test("start a=(0) return a",
      ...
      v2_0peg -> "Invalid input '(': expected whitespace, NODE or RELATIONSHIP (line 1, column 9)"
    )
  }
  ...
  @Test def weirdSpelling() {
    test("start a=ndoe(0) return a",
      v2_0    -> "expected either node or relationship here",
      v2_0peg -> "Invalid input 'd': expected 'o/O' (line 1, column 10)"
    )
  }
  ...
  @Test def unclosedParenthesis() {
    test("start a=node(0 return a",
      ...
      v2_0peg -> "Invalid input 'r': expected whitespace, comment, ',' or ')' (line 1, column 16)"
    )
  }
  ...
  @Test def trailingComa() {
    test("start a=node(0,1,) return a",
      v2_0    -> "trailing coma",
      v2_0peg -> "Invalid input ')': expected whitespace or an unsigned integer (line 1, column 18)"
    )
  }
  ...
  @Test def unclosedCurly() {
    test("start a=node({0) return a",
      ...
      v2_0peg -> "Invalid input ')': expected an identifier character, whitespace or '}' (line 1, column 16)"
    )
  }
  ...
  @Test def twoEqualSigns() {
    test("start a==node(0) return a",
      v2_0    -> "expected either node or relationship here",
      v2_0peg -> "Invalid input '=' (line 1, column 9)"
    )
  }
  ...
  @Test def forgetByInOrderBy() {
    test("start a=node(0) return a order a.name",
      v2_0    -> "expected by",
      v2_0peg -> "Invalid input 'a': expected whitespace, comment or BY (line 1, column 32)"
    )
  }
  ...
  @Test def unknownFunction() {
    test("start a=node(0) return foo(a)",
      ...
      v2_0peg -> "Unknown function 'foo' (line 1, column 24)"
    )
  }
  ...
  @Test def handlesMultiLineQueries() {
    test(
      ...
      v2_0    -> "string literal or parameter expected",
      v2_0peg -> "Invalid input 'v': expected whitespace, comment, \"...string...\" or a parameter (line 9, column 29)"
    )
  }
