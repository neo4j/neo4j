...
import org.neo4j.cypher.internal.compiler.ActualParser

sealed trait CypherVersion {
  def name: String
  def compiler: ActualParser
}

object CypherVersion {
  case object v1_9 extends CypherVersion {
    val name = "1.9"
    val compiler = new internal.compiler.v1_9.CypherParserImpl
  }
  case object v2_0 extends CypherVersion {
    val name = "2.0"
    val compiler = new internal.compiler.v2_0.CypherParserImpl
  }
  case object vLegacy extends CypherVersion {
    val name = "legacy"
    val compiler = new internal.compiler.legacy.CypherParserImpl
  }
  val vDefault = v2_0
}
import CypherVersion._

class CypherCompiler(version: String) {
