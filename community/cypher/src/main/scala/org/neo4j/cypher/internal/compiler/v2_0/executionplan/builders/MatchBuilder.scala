...
import org.neo4j.cypher.internal.compiler.v2_0.pipes.{MatchPipe, Pipe}
...
import org.neo4j.cypher.internal.compiler.v2_0.pipes.matching.{PatternRelationship, PatternNode, PatternGraph}
