...
import org.neo4j.cypher.internal.compiler.v2_3.perty.format.{quoteChar, quoteString}
import org.neo4j.cypher.internal.compiler.v2_3.perty.helpers.{HasContainerType, HasMapType, HasType}
...
case object scalaDocGen extends CustomDocGen[Any] {
  ...
  import org.neo4j.cypher.internal.compiler.v2_3.perty.recipe.Pretty._
