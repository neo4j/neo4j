...
final case class LowerBounded[V](lowerBound: Bound[V]) extends SeekRange[V]
final case class Between[V](lowerBound: Bound[V], upperBound: Bound[V]) extends SeekRange[V]
