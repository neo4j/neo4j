...
class CodeGenExpressionCompilationTest extends CypherFunSuite with Matchers with CodeGenSugar {
  ...
  val multiplicationOperation = Operation("Multiplication", Multiplication.apply, Seq(
    (0, 0, Left(0)),
    (0, 42, Left(0)),
    (1, 1, Left(1)),
    (5, 20, Left(100)),
  ...
  val operationsToTest = Seq(additionOperation, subtractionOperation, multiplicationOperation)
