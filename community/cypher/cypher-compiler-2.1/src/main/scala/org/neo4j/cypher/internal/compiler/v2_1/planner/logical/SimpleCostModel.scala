...
class SimpleCostModel extends CostModel {
  ...
  def calculateProjectionCosts(cardinality: Int, numExpressions: Int): Int = cardinality/100 * numExpressions
  def calculateSingleRow(cardinality: Int): Int = cardinality
}
