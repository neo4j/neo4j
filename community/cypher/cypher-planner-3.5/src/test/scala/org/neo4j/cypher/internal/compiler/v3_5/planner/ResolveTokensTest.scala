...
import org.neo4j.cypher.internal.frontend.v3_5.ast.{Match, Query, SingleQuery, Where, _}
...
class ResolveTokensTest extends CypherFunSuite {
  ...
  import org.neo4j.cypher.internal.compiler.v3_5.parser.ParserFixture._
