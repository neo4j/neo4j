...
trait QueryGraphSolver {
  ...
  def planPatternExpression(planArguments: Set[IdName], expr: PatternExpression, context: LogicalPlanningContext, solveds: Solveds, cardinalities: Cardinalities): (LogicalPlan, PatternExpression)
  def planPatternComprehension(planArguments: Set[IdName], expr: PatternComprehension, context: LogicalPlanningContext, solveds: Solveds, cardinalities: Cardinalities): (LogicalPlan, PatternComprehension)
}
