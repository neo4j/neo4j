...
object PatternExpressionSolver {
  ...
  def solvePatternExpressions(availableSymbols: Set[IdName], context: LogicalPlanningContext, solveds: Solveds, cardinalities: Cardinalities,
  ...
  def solvePatternComprehensions(availableSymbols: Set[IdName], context: LogicalPlanningContext, solveds: Solveds, cardinalities: Cardinalities,
