        ...
        Selection(
          ...
          NodeHashJoin(
            ...
            Expand(
              ...
              IdName("a"), SemanticDirection.INCOMING, Seq.empty, IdName("b"), IdName("r1"), ExpandAll),
            Expand(
              NodeByLabelScan(IdName("c"), lblName("X"), Set.empty),
              IdName("c"), SemanticDirection.INCOMING, Seq.empty, IdName("b"), IdName("r2"), ExpandAll)
          )
        ),
        ShortestPathPattern(Some(IdName("p")), PatternRelationship("r", ("a", "c"), SemanticDirection.OUTGOING, Seq.empty, SimplePatternLength), single = true)(null))
