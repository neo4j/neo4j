...
import org.neo4j.cypher.internal.compiler.v3_1.planner.{Predicate, Selections}
...
import org.neo4j.cypher.internal.frontend.v3_1.{InputPosition, LabelId, PropertyKeyId, SemanticTable}
