...
import org.neo4j.cypher.internal.ir.v3_1.logical.plans.{NodeIndexContainsScan, NodeIndexScan}
import org.neo4j.cypher.internal.ir.v3_1.{IdName, Predicate, QueryGraph, RegularPlannerQuery, Selections}
