...
import org.neo4j.cypher.internal.frontend.v3_1.{SemanticDirection, SemanticState, inSequence}
        ...
        Pattern(List(
          EveryPath(
            RelationshipChain(
              ...
              RelationshipPattern(Some(rId), optional = false, List(), None, None, SemanticDirection.OUTGOING)(pos), NodePattern(Some(bId), List(), None)(pos)
            )(pos))
        ))(pos), List(), None)(pos)
