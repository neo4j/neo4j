...
import org.neo4j.cypher.internal.compiler.v3_1.commands.{Pattern, RelatedTo, VarLengthRelatedTo}
import org.neo4j.cypher.internal.compiler.v3_1.pipes.matching.{PatternGraph, PatternNode, PatternRelationship}
