...
trait QueryContext extends TokenContext {
  ...
  def callReadOnlyProcedure(name: QualifiedProcedureName, args: Seq[Any], allowed: String): Iterator[Array[AnyRef]]

  def callReadWriteProcedure(name: QualifiedProcedureName, args: Seq[Any], allowed: String): Iterator[Array[AnyRef]]

  def callSchemaWriteProcedure(name: QualifiedProcedureName, args: Seq[Any], allowed: String): Iterator[Array[AnyRef]]

  def callDbmsProcedure(name: QualifiedProcedureName, args: Seq[Any], allowed: String): Iterator[Array[AnyRef]]
