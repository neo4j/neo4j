...
import org.neo4j.cypher.internal.compiler.v3_1.commands.expressions.{AggregationExpression, Expression}
import org.neo4j.cypher.internal.compiler.v3_1.commands.predicates.{Predicate, True}
import org.neo4j.cypher.internal.compiler.v3_1.executionplan.builders.{PatternGraphBuilder, QueryToken, Unsolved}
