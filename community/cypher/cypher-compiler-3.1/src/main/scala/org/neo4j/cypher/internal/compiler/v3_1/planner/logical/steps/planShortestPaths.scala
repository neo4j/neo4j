...
import org.neo4j.cypher.internal.compiler.v3_1.planner.logical.plans.{LogicalPlan, _}
...
import org.neo4j.cypher.internal.ir.v3_1.{IdName, Predicate, QueryGraph, ShortestPathPattern}
