...
import org.neo4j.cypher.internal.frontend.v3_1.ast.{AllIterablePredicate, FilterScope, Variable}
...
case class expandSolverStep(qg: QueryGraph) extends IDPSolverStep[PatternRelationship, LogicalPlan, LogicalPlanningContext] {
  ...
  import org.neo4j.cypher.internal.compiler.v3_1.planner.logical.idp.expandSolverStep._
