 ...
 */
public class NullAstFactory implements ASTFactory<NULL,
        NULL,
        NULL,
        NULL,
        NULL,
        ...
        NULL>
{
    ...
    @Override
    public NULL newReturnClause( NULL p, boolean distinct, NULL aNull, List<NULL> order, NULL orderPos, NULL skip, NULL skipPosition, NULL limit,
                                 NULL limitPosition )
    {
        return null;
    }
    ...
    @Override
    public NULL callClause( NULL p, NULL namespacePosition, NULL procedureNamePosition, NULL procedureResultPosition, List<String> namespace, String name,
                            List<NULL> arguments, boolean yieldAll, List<NULL> nulls, NULL aNull )
    {
        return null;
    }
    ...
    @Override
    public NULL relationshipPattern( NULL p, boolean left, boolean right, NULL v, List<StringPos<NULL>> relTypes, NULL aNull, NULL properties, NULL predicate,
    ...
    @Override
    public NULL yieldClause( NULL p, boolean returnAll, List<NULL> nulls, NULL returnItemsPosition, List<NULL> orderBy, NULL orderPos, NULL skip,
                             NULL skipPosition, NULL limit, NULL limitPosition, NULL aNull )
    {
        return null;
    }
    ...
    @Override
    public NULL createConstraint( NULL p, ConstraintType constraintType, boolean replace, boolean ifNotExists, String constraintName, NULL aNull,
                                  StringPos<NULL> label, List<NULL> nulls, SimpleEither<Map<String,NULL>,NULL> options, boolean containsOn,
    ...
    @Override
    public NULL createLookupIndex( NULL p, boolean replace, boolean ifNotExists, boolean isNode, String indexName, NULL aNull, StringPos<NULL> functionName,
                                   NULL functionParameter, SimpleEither<Map<String,NULL>,NULL> options )
    {
        return null;
    }

    @Override
    public NULL createIndex( NULL p, boolean replace, boolean ifNotExists, boolean isNode, String indexName, NULL aNull, StringPos<NULL> label,
                             List<NULL> nulls, SimpleEither<Map<String,NULL>,NULL> options, CreateIndexTypes indexType )
    {
        return null;
    }

    @Override
    public NULL createFulltextIndex( NULL p, boolean replace, boolean ifNotExists, boolean isNode, String indexName, NULL aNull, List<StringPos<NULL>> labels,
                                     List<NULL> nulls, SimpleEither<Map<String,NULL>,NULL> options )
    {
        return null;
    }
    ...
    @Override
    public NULL createUser( NULL p, boolean replace, boolean ifNotExists, SimpleEither<String,NULL> username, NULL password, boolean encrypted,
                            boolean changeRequired, Boolean suspended, SimpleEither<String,NULL> homeDatabase )
    {
        return null;
    }
    ...
    @Override
    public NULL alterUser( NULL p, boolean ifExists, SimpleEither<String,NULL> username, NULL password, boolean encrypted, Boolean changeRequired,
                           Boolean suspended, SimpleEither<String,NULL> homeDatabase, boolean removeHome )
    {
        return null;
    }
    ...
    @Override
    public NULL showRolePrivileges( NULL p, List<SimpleEither<String,NULL>> roles, boolean asCommand, boolean asRevoke, NULL yieldExpr, NULL returnWithoutGraph,
                                    NULL aNull )
    {
        return null;
    }
    ...
    @Override
    public NULL showUserPrivileges( NULL p, List<SimpleEither<String,NULL>> users, boolean asCommand, boolean asRevoke, NULL yieldExpr, NULL returnWithoutGraph,
                                    NULL aNull )
    {
        return null;
    }
    ...
    @Override
    public NULL createDatabase( NULL p, boolean replace, SimpleEither<String,NULL> databaseName, boolean ifNotExists, NULL aNull,
    ...
    @Override
    public NULL dropDatabase( NULL p, SimpleEither<String,NULL> databaseName, boolean ifExists, boolean dumpData, NULL wait )
    {
        return null;
    }

    @Override
    public NULL alterDatabase( NULL p, SimpleEither<String,NULL> databaseName, boolean ifExists, AccessType accessType )
    {
        return null;
    }
    ...
    @Override
    public NULL createDatabaseAlias( NULL p, boolean replace, SimpleEither<String,NULL> aliasName, SimpleEither<String,NULL> targetName, boolean ifNotExists )
    {
        return null;
    }

    @Override
    public NULL alterDatabaseAlias( NULL p, SimpleEither<String,NULL> aliasName, SimpleEither<String,NULL> targetName, boolean ifExists )
    {
        return null;
    }
