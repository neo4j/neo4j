...
final case class CreateUniqueConstraint(id: String,
                                        label: String,
...
final case class DropUniqueConstraint(id: String,
                                      label: String,
                                      idForProperty: String,
                                      propertyKey: String,
                                      queryString: QueryString = QueryString.empty)
...
final case class CreateNodePropertyExistenceConstraint(id: String,
                                                       label: String,
                                                       idForProperty: String,
                                                       propertyKey: String,
                                                       queryString: QueryString = QueryString.empty)
...
final case class DropNodePropertyExistenceConstraint(id: String,
                                                     label: String,
                                                     idForProperty: String,
                                                     propertyKey: String,
                                                     queryString: QueryString = QueryString.empty)
...
final case class CreateRelationshipPropertyExistenceConstraint(id: String,
                                                               relType: String,
                                                               idForProperty: String,
                                                               propertyKey: String,
                                                               queryString: QueryString = QueryString.empty)
...
final case class DropRelationshipPropertyExistenceConstraint(id: String,
                                                             relType: String,
                                                             idForProperty: String,
                                                             propertyKey: String,
                                                             queryString: QueryString = QueryString.empty)
