...
import org.opencypher.v9_0.ast.semantics.{ExpressionTypeInfo, SemanticTable => SemanticTablev4_0}
import org.opencypher.v9_0.expressions.{Expression => Expressionv4_0}
