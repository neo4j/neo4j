...
object helpers {
  ...
  def as3_5(notification: nfV3_3.InternalNotification): nfv3_5.InternalNotification = notification match {
    ...
    case nfV3_3.MissingLabelNotification(position, label) => nfv3_5.MissingLabelNotification(as3_5(position), label)
    case nfV3_3.MissingRelTypeNotification(position, relType) => nfv3_5.MissingRelTypeNotification(as3_5(position), relType)
    case nfV3_3.MissingPropertyNameNotification(position, name) => nfv3_5.MissingPropertyNameNotification(as3_5(position), name)
    case nfV3_3.UnboundedShortestPathNotification(position) => nfv3_5.UnboundedShortestPathNotification(as3_5(position))
    case nfV3_3.ExhaustiveShortestPathForbiddenNotification(position) => nfv3_5.ExhaustiveShortestPathForbiddenNotification(as3_5(position))
    ...
    case nfV3_3.DeprecatedProcedureNotification(position, oldName, newName) => nfv3_5.DeprecatedProcedureNotification(as3_5(position), oldName, newName)
    case nfV3_3.ProcedureWarningNotification(position, procedure, warning) => nfv3_5.ProcedureWarningNotification(as3_5(position), procedure, warning)
    case nfV3_3.DeprecatedFieldNotification(position, procedure, field) => nfv3_5.DeprecatedFieldNotification(as3_5(position), procedure, field)
