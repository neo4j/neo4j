...
import org.neo4j.cypher.internal.compatibility.{v2_3, v3_1, v3_3}
...
trait CompatibilityFactory {
  ...
  def create(spec: PlannerSpec_v3_3, config: CypherCompilerConfiguration): compatibility.v3_3.Compatibility[_,_]
...
class CompatibilityCache(factory: CompatibilityFactory) extends CompatibilityFactory {
  ...
  private val cache_v3_3 = new mutable.HashMap[PlannerSpec_v3_3, compatibility.v3_3.Compatibility[_,_]]
  private val cache_v3_4 = new mutable.HashMap[PlannerSpec_v3_4, Compatibility[_,_]]
  ...
  override def create(spec: PlannerSpec_v3_3, config: CypherCompilerConfiguration): compatibility.v3_3.Compatibility[_,_] =
