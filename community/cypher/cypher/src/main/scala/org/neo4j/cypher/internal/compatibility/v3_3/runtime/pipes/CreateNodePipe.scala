...
case class CreateNodePipe(src: Pipe, key: String, labels: Seq[LazyLabel], properties: Option[Expression])(val id: Id =
                                                                                                            new Id)
    extends BaseCreateNodePipe(src, key, labels, properties) {
