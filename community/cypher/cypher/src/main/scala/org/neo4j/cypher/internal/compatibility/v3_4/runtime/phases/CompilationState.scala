...
class CompilationState(ls: LogicalPlanState,
  ...
  extends LogicalPlanState(ls.queryText, ls.startPosition, ls.plannerName, ls.transactionLayers, ls.solveds, ls.cardinalities, ls.maybeStatement, ls.maybeSemantics,
