...
object SemanticTableConverter {
  ...
  astv3_5.ASTAnnotationMap[expressionsv3_5.Expression, frontendv3_5.semantics.ExpressionTypeInfo] = {
  ...
  private def convert(typeInfoV3_3: frontendV3_3.ExpressionTypeInfo): frontendv3_5.semantics.ExpressionTypeInfo = typeInfoV3_3 match {
    case frontendV3_3.ExpressionTypeInfo(specified, expected) =>
      frontendv3_5.semantics.ExpressionTypeInfo(convert(specified), expected.map(convert))
  }
