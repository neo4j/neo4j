...
object LogicalPlanConverter {
    ...
    private val rewriter: RewriterWithArgs = bottomUpWithArgs { before =>
      val rewritten = RewriterWithArgs.lift {
        case (plan: plansV3_3.Argument, children: Seq[AnyRef]) =>
          plansV3_4.Argument(children.head.asInstanceOf[Set[IdNameV3_4]])(SameId(Id(plan.assignedId.underlying)))
        ...
        case (plan: plansV3_3.TriadicSelection, children: Seq[AnyRef]) =>
          plansV3_4.TriadicSelection(left = children(1).asInstanceOf[LogicalPlanV3_4],
            ...
            targetId = children(4).asInstanceOf[IdNameV3_4])(SameId(Id(plan.assignedId.underlying)))
        ...
        case (spp: irV3_3.ShortestPathPattern, children: Seq[AnyRef]) =>
          val sp3_4 = convertASTNode[expressionsV3_4.ShortestPaths](spp.expr, expressionMap, readTxLayerAttribute, solveds, cardinalities, isImportant)
  ...
  def convertLogicalPlan[T <: LogicalPlanV3_4](logicalPlan: LogicalPlanV3_3,
    ...
    val rewriter = new LogicalPlanRewriter(transactionLayers, solveds, cardinalities, isImportant = isImportant)
  ...
  private[v3_3] def convertExpression[T <: ExpressionV3_4](expression: ExpressionV3_3, readTxLayerAttribute: TransactionLayers, solveds: Solveds, cardinalities: Cardinalities): T = {
    new RewritableAny[ExpressionV3_3](expression).rewrite(new LogicalPlanRewriter(readTxLayerAttribute, solveds, cardinalities), Seq.empty).asInstanceOf[T]
  }
  ...
  private def convertASTNode[T <: utilV3_4.ASTNode](ast: astV3_3.ASTNode,
    ...
    new RewritableAny[astV3_3.ASTNode](ast).rewrite(new LogicalPlanRewriter(readTxLayerAttribute, solveds, cardinalities, expressionMap, isImportant), Seq.empty).asInstanceOf[T]
  }
