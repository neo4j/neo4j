...
object CypherVersion {
  ...
  case object v2_2_rule extends CypherVersion("2.2-rule")
  case object v2_2_cost extends CypherVersion("2.2-cost")
  ...
  val vDefault = v2_2
  val allVersions = Seq(v1_9, v2_0, v2_1, v2_2, v2_2_cost, v2_2_rule)
}
