...
import org.neo4j.cypher.internal.compiler.v3_2.spi.StatisticsCompletingGraphStatistics
...
object TransactionBoundGraphStatistics {
  ...
  private class BaseTransactionBoundGraphStatistics(operations: ReadOperations)
