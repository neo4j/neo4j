...
import org.neo4j.cypher.{CypherPlannerOption, CypherRuntime, CypherVersion, InvalidArgumentException}
import org.opencypher.v9_0.util.test_helpers.CypherFunSuite

class PreParserTest extends CypherFunSuite {

  val preParser = new PreParser(CypherVersion.default, CypherPlannerOption.default, CypherRuntime.default, 0)
