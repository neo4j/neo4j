...
import org.neo4j.cypher.internal.logical.plans.{Aggregation, AllNodesScan, AllScope, AllowedNonAdministrationCommands, AlterDatabase, AlterLocalDatabaseAlias, AlterRemoteDatabaseAlias, AlterServer, AlterUser, Anti, AntiConditionalApply, AntiSemiApply, Apply, ArgumentTracker, Ascending, AssertAllowedDatabaseAction, AssertAllowedDbmsActions, AssertAllowedDbmsActionsOrSelf, AssertManagementActionNotBlocked, AssertNotBlockedDropAlias, AssertNotBlockedRemoteAliasManagement, AssertNotCurrentUser, AssertSameNode, AssertSameRelationship, BFSPruningVarExpand, BidirectionalRepeatTrail, CacheProperties, CartesianProduct, ConditionalApply, CopyRolePrivileges, Create, CreateConstraint, CreateDatabase, CreateFulltextIndex, CreateIndex, CreateLocalDatabaseAlias, CreateLookupIndex, CreateRemoteDatabaseAlias, CreateRole, CreateUser, DeallocateServer, DeleteExpression, DeleteNode, DeletePath, DeleteRelationship, DenyDatabaseAction, DenyDbmsAction, DenyGraphAction, DenyLoadAction, Descending, DetachDeleteExpression, DetachDeleteNode, DetachDeletePath, DirectedAllRelationshipsScan, DirectedRelationshipByElementIdSeek, DirectedRelationshipByIdSeek, DirectedRelationshipTypeScan, DirectedUnionRelationshipTypesScan, Distinct, DoNotGetValue, DoNothingIfExists, DoNothingIfExistsForConstraint, DoNothingIfExistsForFulltextIndex, DoNothingIfExistsForIndex, DoNothingIfExistsForLookupIndex, DoNothingIfNotExists, DropConstraintOnName, DropDatabase, DropDatabaseAlias, DropIndexOnName, DropRole, DropServer, DropUser, Eager, EmptyResult, EnableServer, EnsureNodeExists, EnsureValidNonSystemDatabase, EnsureValidNumberOfDatabases, ErrorPlan, Expand, FindShortestPaths, Foreach, ForeachApply, GetValue, GrantDatabaseAction, GrantDbmsAction, GrantGraphAction, GrantLoadAction, GrantRoleToUser, HomeScope, IndexOrderNone, IndexedProperty, Input, IntersectionNodeByLabelsScan, LeftOuterHashJoin, LetAntiSemiApply, LetSelectOrAntiSemiApply, LetSelectOrSemiApply, LetSemiApply, Limit, LoadCSV, LogSystemCommand, LogicalPlan, ManyQueryExpression, ManySeekableArgs, Merge, MultiNodeIndexSeek, NFABuilder, NamedScope, NodeByElementIdSeek, NodeByIdSeek, NodeByLabelScan, NodeCountFromCountStore, NodeHashJoin, NodeIndexSeek, NodeIndexSeekLeafPlan, NodeKey, NodePropertyExistence, NodePropertyType, NodeUniqueIndexSeek, NodeUniqueness, NonFuseable, Optional, OptionalExpand, OrderedAggregation, OrderedDistinct, PartialSort, PartialTop, PartitionedAllNodesScan, PartitionedDirectedRelationshipTypeScan, PartitionedDirectedUnionRelationshipTypesScan, PartitionedIntersectionNodeByLabelsScan, PartitionedNodeByLabelScan, PartitionedUndirectedRelationshipTypeScan, PartitionedUndirectedUnionRelationshipTypesScan, PartitionedUnionNodeByLabelsScan, PartitionedUnwindCollection, PointBoundingBoxRange, PointBoundingBoxSeekRangeWrapper, PointDistanceRange, PointDistanceSeekRangeWrapper, PreserveOrder, ProcedureCall, ProduceResult, ProjectEndpoints, Projection, PruningVarExpand, RangeQueryExpression, RelationshipCountFromCountStore, RelationshipKey, RelationshipPropertyExistence, RelationshipPropertyType, RelationshipUniqueness, RemoveLabels, RenameRole, RenameServer, RenameUser, RepeatOptions, RequireRole, RevokeDatabaseAction, RevokeDbmsAction, RevokeGraphAction, RevokeLoadAction, RevokeRoleFromUser, RightOuterHashJoin, RollUpApply, RunQueryAt, SelectOrAntiSemiApply, SelectOrSemiApply, Selection, SemiApply, SetLabels, SetNodeProperties, SetNodePropertiesFromMap, SetNodeProperty, SetOwnPassword, SetProperties, SetPropertiesFromMap, SetProperty, SetRelationshipPropertiesFromMap, SetRelationshipProperty, ShowAliases, ShowConstraints, ShowCurrentUser, ShowDatabase, ShowFunctions, ShowIndexes, ShowPrivilegeCommands, ShowPrivileges, ShowProcedures, ShowRoles, ShowServers, ShowSettings, ShowSupportedPrivileges, ShowTransactions, ShowUsers, SimulatedExpand, SimulatedNodeScan, SimulatedSelection, SingleSeekableArg, Skip, Sort, StartDatabase, StatefulShortestPath, StopDatabase, SubtractionNodeByLabelsScan, TerminateTransactions, Top, Trail, TransactionApply, TransactionConcurrency, TransactionForeach, TriadicBuild, TriadicFilter, TriadicSelection, UndirectedAllRelationshipsScan, UndirectedRelationshipByElementIdSeek, UndirectedRelationshipByIdSeek, UndirectedRelationshipTypeScan, UndirectedUnionRelationshipTypesScan, Union, UnionNodeByLabelsScan, UnwindCollection, ValueHashJoin, VarExpand, WaitForCompletion}
