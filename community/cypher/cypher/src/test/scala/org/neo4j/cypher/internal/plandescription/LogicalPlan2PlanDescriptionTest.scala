...
class LogicalPlan2PlanDescriptionTest extends CypherFunSuite with TableDrivenPropertyChecks {
  ...
  test("Create") {
    ...
    assertGood(
      attach(
        Create(
          lhsLP,
          Seq(CreateNode("x", Seq.empty, None)),
    ...
    assertGood(
      attach(
        Create(
          lhsLP,
          Seq(CreateNode("x", Seq(label("Label")), None)),
    ...
    assertGood(
      attach(
        Create(
          lhsLP,
          Seq(CreateNode("x", Seq(label("Label1"), label("Label2")), None)),
          Seq(CreateRelationship("r", "x", relType("R"), "y", SemanticDirection.INCOMING, None))
        ),
        32.2
      ),
    ...
    assertGood(
      attach(
        Create(
          lhsLP,
          Seq(CreateNode("x", Seq(label("Label")), Some(properties))),
  ...
  test("Merge") {
    ...
    assertGood(
      attach(
        Merge(
          lhsLP,
          Seq(CreateNode("x", Seq(label("L")), None)),
          Seq.empty,
    ...
    assertGood(
      attach(
        Merge(
          lhsLP,
          Seq(CreateNode("x", Seq.empty, Some(properties))),
          Seq(CreateRelationship("r", "x", relType("R"), "y", SemanticDirection.INCOMING, Some(properties))),
          Seq.empty,
          Seq.empty,
          Set.empty
    ...
    assertGood(
      attach(
        Merge(
          lhsLP,
          Seq(CreateNode("x", Seq(label("L")), Some(properties))),
          Seq(CreateRelationship("r", "x", relType("R"), "y", SemanticDirection.INCOMING, Some(properties))),
          Seq.empty,
          Seq.empty,
          Set.empty
  ...
  test("Projection") {
    ...
    assertGood(
      attach(Projection(lhsLP, Map("x" -> varFor("y"))), 2345.0),
      planDescription(id, "Projection", SingleChild(lhsPD), Seq(details("y AS x")), Set("a", "x"))
    )

    assertGood(
      attach(Projection(lhsLP, Map("x" -> pathExpression)), 2345.0),
      planDescription(
        id,
        "Projection",
        SingleChild(lhsPD),
    ...
    assertGood(
      attach(Projection(lhsLP, Map("x" -> varFor("  UNNAMED42"), "n.prop" -> prop("n", "prop"))), 2345.0),
      planDescription(
        id,
        "Projection",
        SingleChild(lhsPD),
    ...
    assertGood(
      attach(Projection(lhsLP, Map("n.prop" -> prop("n", "prop"), "x" -> varFor("y"))), 2345.0),
      planDescription(
        id,
        "Projection",
        SingleChild(lhsPD),
