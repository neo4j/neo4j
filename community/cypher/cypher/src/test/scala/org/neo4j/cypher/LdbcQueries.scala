...
object LdbcQueries {
  ...
  object Query2 extends LdbcQuery {
    ...
    val query =
      """MATCH (:Person {id:{1}})-[:KNOWS]-(friend:Person)<-[:POST_HAS_CREATOR|COMMENT_HAS_CREATOR]-(message)
  ...
  object Query3 extends LdbcQuery {
    ...
    def createParams =
      Map(
        ...
        "country5" ->
          Map("id" -> 15, "name" -> "country5"),
        "country2" ->
          Map("id" -> 12, "name" -> "country2"),
        "country3" ->
    ...
    val query =
      """MATCH (countryX:Country {name:{2}}), (countryY:Country {name:{3}}), (person:Person {id:{1}})
  ...
  object Query4 extends LdbcQuery {
    ...
    val query =
      """MATCH (person:Person {id:{1}})-[:KNOWS]-(:Person)<-[:POST_HAS_CREATOR]-(post:Post)-[:POST_HAS_TAG]->(tag:Tag)
    ...
    def expectedResult =
      List(Map("tagName" -> "tag2-ᚠさ丵פش", "postCount" -> 3),
  ...
  object Query5 extends LdbcQuery {
    ...
    def createParams =
      Map(
        ...
        "country1" ->
          Map("id" -> 11L, "name" -> "country1"),
        "forum1HasMemberPerson1" ->
          Map("joinDate" -> 946854000000L),
        "person1" ->
          Map(
            "id"           -> 1L,
        ...
        "forum2" ->
          Map("id" -> 2L, "title" -> "forum1-ᚠさ丵פش"),
        "forum3" ->
          Map("id" -> 3L, "title" -> "forum3-ᚠさ丵פش"),
        "forum4" ->
    ...
    def expectedResult =
      List(Map("forumName" -> "forum1-ᚠさ丵פش", "postCount" -> 1),
           Map("forumName" -> "forum3-ᚠさ丵פش", "postCount" -> 1),
           Map("forumName" -> "forum1-ᚠさ丵פش", "postCount" -> 0))
  ...
  object Query6 extends LdbcQuery {
    ...
    val query =
      """MATCH (person:Person {id:{1}})-[:KNOWS*1..2]-(friend:Person)<-[:POST_HAS_CREATOR]-(friendPost:Post)-[:POST_HAS_TAG]->(knownTag:Tag {name:{2}})
    ...
    def expectedResult =
      List(Map("tagName" -> "tag2-ᚠさ丵פش", "postCount" -> 2),
           Map("tagName" -> "tag5-ᚠさ丵פش", "postCount" -> 2),
           Map("tagName" -> "tag1-ᚠさ丵פش", "postCount" -> 1))
  ...
  object Query7 extends LdbcQuery {
    ...
    val query =
      """MATCH (person:Person {id:{1}})<-[:POST_HAS_CREATOR|COMMENT_HAS_CREATOR]-(message)<-[like:LIKES_POST|LIKES_COMMENT]-(liker:Person)
    ...
    def createParams =
      Map(
        ...
        "s8LikesF4Comment1" ->
          Map("creationDate" -> 946682400000L),
        "s8LikesPerson1Post2" ->
          Map("creationDate" -> 946681800000L),
        "s7LikesPerson1Post1" ->
          Map("creationDate" -> 946681320000L),
        "f4LikesPerson1Post3" ->
          Map("creationDate" -> 946681500000L),
        "f4LikesPerson1Post2" ->
          Map("creationDate" -> 946681440000L),
        "f4LikesPerson1Post1" ->
          Map("creationDate" -> 946681380000L),
        "person1LikesS7Post1" ->
          Map("creationDate" -> 946682400000L),
        "f2LikesPerson1Post1" ->
          Map("creationDate" -> 946681500000L),
        "ff6NewLikesPerson1Post1" ->
          Map("creationDate" -> 946681440000L),
        "ff6OldLikesPerson1Post1" ->
          Map("creationDate" -> 946681320000L)
      )
  ...
  object Query8 extends LdbcQuery {
    ...
    def createParams =
      Map(
        "person" ->
          Map("id" -> 0L, "lastName" -> "zero-ᚠさ丵פش", "firstName" -> "person"),
        "comment13" ->
          Map("content" -> "C13", "id" -> 13L, "creationDate" -> 3L),
        "comment12" ->
          Map("content" -> "C12", "id" -> 12L, "creationDate" -> 2L),
        "comment112" ->
          Map("content" -> "C112", "id" -> 16L, "creationDate" -> 6L),
        "comment111" ->
          Map("content" -> "C111", "id" -> 15L, "creationDate" -> 5L),
        "comment01" ->
          Map("content" -> "C01", "id" -> 10L, "creationDate" -> 1L),
        "comment131" ->
          Map("content" -> "C131", "id" -> 14L, "creationDate" -> 4L),
        "post3" ->
          Map("content" -> "P3", "id" -> 3L),
        "post2" ->
          Map("content" -> "P2", "id" -> 2L),
        "post1" ->
          Map("content" -> "P1", "id" -> 1L),
        "post0" ->
          Map("content" -> "P0", "id" -> 0L),
        "friend1" ->
          Map("id" -> 1L, "lastName" -> "one-ᚠさ丵פش", "firstName" -> "friend"),
        "comment2111" ->
          Map("content" -> "C2111", "id" -> 19L, "creationDate" -> 9L),
        "comment11" ->
          Map("content" -> "C11", "id" -> 11L, "creationDate" -> 1L),
        "comment21" ->
          Map("content" -> "C21", "id" -> 17L, "creationDate" -> 7L),
        "comment31" ->
          Map("content" -> "C31", "id" -> 20L, "creationDate" -> 10L),
        "comment32" ->
          Map("content" -> "C32", "id" -> 21L, "creationDate" -> 2L),
        "friend3" ->
          Map("id" -> 3L, "lastName" -> "three-ᚠさ丵פش", "firstName" -> "friend"),
        "comment211" ->
          Map("content" -> "C211", "id" -> 18L, "creationDate" -> 8L),
        "friend2" ->
          Map("id" -> 2L, "lastName" -> "two-ᚠさ丵פش", "firstName" -> "friend")
      )

    val query =
      """MATCH (start:Person {id:{1}})<-[:POST_HAS_CREATOR|COMMENT_HAS_CREATOR]-()<-[:REPLY_OF_POST|REPLY_OF_COMMENT]-(comment:Comment)-[:COMMENT_HAS_CREATOR]->(person:Person)
  ...
  object Query9 extends LdbcQuery {
    ...
    def createParams =
      Map(
        "friendfriend4" ->
          Map("id" -> 4L, "lastName" -> "four-ᚠさ丵פش", "firstName" -> "friendfriend"),
        "comment1211" ->
          Map("content" -> "C1211", "id" -> 1211L, "creationDate" -> 10L),
        "post21" ->
          Map("id" -> 21L, "creationDate" -> 6L, "imageFile" -> "P21 - image"),
        "comment121" ->
          Map("content" -> "C121", "id" -> 121L, "creationDate" -> 5L),
        "person0" ->
          Map("id" -> 0L, "lastName" -> "zero-ᚠさ丵פش", "firstName" -> "person"),
        "comment111" ->
          Map("content" -> "C111", "id" -> 111L, "creationDate" -> 12L),
        "post31" ->
          Map("content" -> "P31 - content", "id" -> 31L, "creationDate" -> 1L, "imageFile" -> "P31 - image"),
        "stranger3" ->
          Map("id" -> 3L, "lastName" -> "three-ᚠさ丵פش", "firstName" -> "stranger"),
        "comment311" ->
          Map("content" -> "C311", "id" -> 311L, "creationDate" -> 4L),
        "comment21111" ->
          Map("content" -> "C21111", "id" -> 21111L, "creationDate" -> 9L),
        "friend1" ->
          Map("id" -> 1L, "lastName" -> "one-ᚠさ丵פش", "firstName" -> "friend"),
        "comment2111" ->
          Map("content" -> "C2111", "id" -> 2111L, "creationDate" -> 8L),
        "post11" ->
          Map("content" -> "P11 - content", "id" -> 11L, "creationDate" -> 11L, "imageFile" -> "P11 - image"),
        "post12" ->
          Map("content" -> "P12 - content", "id" -> 12L, "creationDate" -> 4L, "imageFile" -> "P12 - image"),
        "post01" ->
          Map("content" -> "P01 - content", "id" -> 1L, "creationDate" -> 3L, "imageFile" -> "P01 - image"),
        "comment211" ->
          Map("content" -> "C211", "id" -> 211L, "creationDate" -> 7L),
        "friend2" ->
          Map("id" -> 2L, "lastName" -> "two-ᚠさ丵פش", "firstName" -> "friend")
      )

    val query =
      """MATCH (:Person {id:{1}})-[:KNOWS*1..2]-(friend:Person)<-[:POST_HAS_CREATOR|COMMENT_HAS_CREATOR]-(message)
    ...
    def createParams =
      Map(
        ...
        "city1" ->
          Map("name" -> "city1"),
        "post211" ->
          Map("content" -> "P211", "id" -> 211L),
        "post212" ->
          Map("content" -> "P212", "id" -> 212L),
        "post121" ->
          Map("content" -> "P121", "id" -> 121L),
        "post213" ->
          Map("content" -> "P213", "id" -> 213L),
        "commonTag4" ->
          Map("name" -> "common tag 4"),
        "uncommonTag1" ->
          Map("name" -> "uncommon tag 1"),
        "commonTag6" ->
        ...
        "uncommonTag3" ->
          Map("name" -> "common tag 3"),
        "post112" ->
          Map("content" -> "P112", "id" -> 112L),
        "uncommonTag2" ->
          Map("name" -> "uncommon tag 2"),
        "post113" ->
          Map("content" -> "P113", "id" -> 113L)
      )

    val query =
      """MATCH (person:Person {id:{1}})-[:KNOWS*2..2]-(friend:Person)-[:PERSON_IS_LOCATED_IN]->(city:City)
  ...
  object Query11 extends LdbcQuery {
    ...
    def createParams =
      Map(
        ...
        "country1" ->
          Map("name" -> "country1"),
        "stranger3WorkedAtCompany2" ->
          Map("workFrom" -> 1),
        "person0" ->
          Map("id" -> 0L, "lastName" -> "zero-ᚠさ丵פش", "firstName" -> "person"),
        "company2" ->
          Map("name" -> "company two"),
        "f1WorkedAtCompany1" ->
          Map("workFrom" -> 4),
        "company1" ->
          Map("name" -> "company one"),
        "f1WorkedAtCompany0" ->
          Map("workFrom" -> 2),
        "f2WorkedAtCompany2" ->
          Map("workFrom" -> 5),
        "stranger3" ->
          Map("id" -> 3L, "lastName" -> "three-ᚠさ丵פش", "firstName" -> "stranger"),
        "company0" ->
          Map("name" -> "company zero"),
        "ff11WorkedAtCompany0" ->
          Map("workFrom" -> 3),
        "f1" ->
          Map("id" -> 1L, "lastName" -> "one-ᚠさ丵פش", "firstName" -> "friend"),
        "f2" ->
    ...
    def createParams =
      Map(
        "tc1211" ->
          Map("name" -> "1211"),
        "t21" ->
          Map("name" -> "tag21-ᚠさ丵פش"),
        "tc12" ->
          Map("name" -> "12"),
        "t11" ->
          Map("name" -> "tag11-ᚠさ丵פش"),
        "person0" ->
          Map("id" -> 0L, "lastName" -> "0", "firstName" -> "person"),
        "t12111" ->
          Map("name" -> "tag12111-ᚠさ丵פش"),
        "t211" ->
          Map("name" -> "tag211-ᚠさ丵פش"),
        "tc121" ->
          Map("name" -> "121"),
        "tc21" ->
          Map("name" -> "21"),
        "t111" ->
          Map("name" -> "tag111-ᚠさ丵פش"),
        "tc11" ->
          Map("name" -> "11"),
        "f1" ->
          Map("id" -> 1L, "lastName" -> "1", "firstName" -> "f"),
        "t112" ->
          Map("name" -> "tag112-ᚠさ丵פش"),
        "tc2" ->
          Map("name" -> "2"),
        "f3" ->
          Map("id" -> 3L, "lastName" -> "3", "firstName" -> "f"),
        "tc1" ->
          Map("name" -> "1"),
        "f2" ->
          Map("id" -> 2L, "lastName" -> "2", "firstName" -> "f"),
        "ff11" ->
          Map("id" -> 11L, "lastName" -> "11", "firstName" -> "ff"),
        "f4" ->
  ...
  object Query14 extends LdbcQuery {
    ...
    val query =
      """MATCH path = allShortestPaths((person1:Person {id:{1}})-[:KNOWS*0..100]-(person2:Person {id:{2}}))
