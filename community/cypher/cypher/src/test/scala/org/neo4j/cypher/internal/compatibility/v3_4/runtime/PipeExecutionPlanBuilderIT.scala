...
class PipeExecutionPlanBuilderIT extends CypherFunSuite with LogicalPlanningTestSupport {
  ...
  test("simple label scan query") {
    val logicalPlan = NodeByLabelScan(IdName("n"), lblName("Foo"), Set.empty)
    val pipeInfo = build(logicalPlan)
  ...
  test("simple node by id seek query") {
    ...
    val logicalPlan = NodeByIdSeek(IdName("n"), ManySeekableArgs(astLiteral), Set.empty)
    val pipeInfo = build(logicalPlan)
  ...
  test("simple node by id seek query with multiple values") {
    ...
    val logicalPlan = NodeByIdSeek(IdName("n"), ManySeekableArgs(astCollection), Set.empty)
    val pipeInfo = build(logicalPlan)
  ...
  test("simple relationship by id seek query") {
    ...
    val fromNode = "from"
    val toNode = "to"
    val logicalPlan = DirectedRelationshipByIdSeek(IdName("r"), ManySeekableArgs(astLiteral), IdName(fromNode), IdName(toNode), Set.empty)
    val pipeInfo = build(logicalPlan)
  ...
  test("simple relationship by id seek query with multiple values") {
    ...
    val fromNode = "from"
    val toNode = "to"
    val logicalPlan = DirectedRelationshipByIdSeek(IdName("r"), ManySeekableArgs(astCollection), IdName(fromNode), IdName(toNode), Set.empty)
    val pipeInfo = build(logicalPlan)
  ...
  test("simple undirected relationship by id seek query with multiple values") {
    ...
    val fromNode = "from"
    val toNode = "to"
    val logicalPlan = UndirectedRelationshipByIdSeek(IdName("r"), ManySeekableArgs(astCollection), IdName(fromNode), IdName(toNode), Set.empty)
    val pipeInfo = build(logicalPlan)
