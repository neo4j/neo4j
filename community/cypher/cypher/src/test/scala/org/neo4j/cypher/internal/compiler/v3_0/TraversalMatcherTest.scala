...
import org.neo4j.cypher.internal.frontend.v3_0.SemanticDirection.{BOTH, OUTGOING}
import org.neo4j.cypher.internal.spi.v3_0.{BidirectionalTraversalMatcher, MonoDirectionalTraversalMatcher}
