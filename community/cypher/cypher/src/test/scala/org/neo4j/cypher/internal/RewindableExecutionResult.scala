...
import org.neo4j.cypher.internal.compatibility.v2_3.{ExecutionResultWrapper => ExecutionResultWrapperFor2_3}
import org.neo4j.cypher.internal.compatibility.v2_3.{exceptionHandler => exceptionHandlerFor2_3}
import org.neo4j.cypher.internal.compatibility.v3_1.{ExecutionResultWrapper => ExecutionResultWrapperFor3_1}
import org.neo4j.cypher.internal.compatibility.v3_1.{exceptionHandler => exceptionHandlerFor3_1}
import org.neo4j.cypher.internal.compatibility.v3_2.{ExecutionResultWrapper => ExecutionResultWrapperFor3_2}
import org.neo4j.cypher.internal.compatibility.v3_2.{exceptionHandler => exceptionHandlerFor3_2}
...
import org.neo4j.cypher.internal.frontend.v3_2.{SemanticDirection => SemanticDirection3_2}
import org.neo4j.cypher.internal.frontend.v3_2.{notification => notification_3_2}
import org.neo4j.cypher.internal.frontend.v3_2.{symbols => symbols3_2}
...
object RewindableExecutionResult {
    ...
    inner match {
      case other: PipeExecutionResult =>
        exceptionHandler.runSafely {
          new PipeExecutionResult(other.result.toEager,
  ...
  private def compatibility(inner: v2_3.executionplan.InternalExecutionResult,
    ...
    val result: v2_3.executionplan.InternalExecutionResult = inner match {
      case other: v2_3.PipeExecutionResult =>
        exceptionHandlerFor2_3.runSafely {
          new v2_3.PipeExecutionResult(other.result.toEager,
                                       other.columns,
                                       other.state,
                                       other.executionPlanBuilder,
                                       other.executionMode,
                                       QueryExecutionType.QueryType.READ_WRITE) {
            override def executionPlanDescription(): v2_3.planDescription.InternalPlanDescription =
              super
  ...
  private def compatibility(inner: v3_1.executionplan.InternalExecutionResult,
    ...
    val result: v3_1.executionplan.InternalExecutionResult = inner match {
      case other: v3_1.PipeExecutionResult =>
        exceptionHandlerFor3_1.runSafely {
          new v3_1.PipeExecutionResult(other.result.toEager,
                                       other.columns,
                                       other.state,
                                       other.executionPlanBuilder,
                                       other.executionMode,
                                       v3_1.executionplan.READ_WRITE) {
            override def executionPlanDescription(): v3_1.planDescription.InternalPlanDescription =
              super
                .executionPlanDescription()
  ...
  private def compatibility(inner: v3_2.executionplan.InternalExecutionResult,
                            planner: frontend.v3_2.PlannerName,
    ...
    val result: v3_2.executionplan.InternalExecutionResult = inner match {
      case other: v3_2.PipeExecutionResult =>
        exceptionHandlerFor3_2.runSafely {
          new v3_2.PipeExecutionResult(other.result.toEager,
                                       other.columns,
                                       other.state,
                                       other.executionPlanBuilder,
                                       other.executionMode,
                                       v3_2.executionplan.READ_WRITE) {
            override def executionPlanDescription(): v3_2.planDescription.InternalPlanDescription =
              super
                .executionPlanDescription()
  ...
  private case class InternalExecutionResultCompatibilityWrapperFor2_3(
      inner: v2_3.executionplan.InternalExecutionResult)
    ...
    override def queryStatistics(): QueryStatistics = {
      ...
      QueryStatistics(
        ...
        stats.uniqueConstraintsAdded,
        stats.uniqueConstraintsRemoved,
        stats.existenceConstraintsAdded,
        stats.existenceConstraintsRemoved
      )
    }
    ...
    private def lift(planDescription: v2_3.planDescription.InternalPlanDescription): InternalPlanDescription = {
      ...
      val arguments: Seq[Argument] = planDescription.arguments.map {
        ...
        case v2_3.planDescription.InternalPlanDescription.Arguments.UpdateActionName(value) =>
          Arguments
            .UpdateActionName(value)
        case v2_3.planDescription.InternalPlanDescription.Arguments.MergePattern(startPoint) =>
          Arguments
        ...
        case v2_3.planDescription.InternalPlanDescription.Arguments.Index(label, propertyKey) =>
          Arguments
            .Index(label, Seq(propertyKey))
        case v2_3.planDescription.InternalPlanDescription.Arguments.PrefixIndex(label, propertyKey, _) =>
          Arguments
            .PrefixIndex(label, propertyKey, null)
        case v2_3.planDescription.InternalPlanDescription.Arguments.InequalityIndex(label, propertyKey, bounds) =>
          Arguments
        ...
        case v2_3.planDescription.InternalPlanDescription.Arguments.EstimatedRows(value) =>
          Arguments
            .EstimatedRows(value)
        ...
        case v2_3.planDescription.InternalPlanDescription.Arguments
              .ExpandExpression(from, relName, relTypes, to, direction, varLength) =>
    ...
    override def notifications: Iterable[Notification] =
      inner.notifications.map(
        org.neo4j.cypher.internal.compatibility.v2_3.ExecutionResultWrapper.asKernelNotification(None))
  ...
  private case class InternalExecutionResultCompatibilityWrapperFor3_1(
      inner: v3_1.executionplan.InternalExecutionResult)
      extends InternalExecutionResult {
    ...
    private def lift(planDescription: v3_1.planDescription.InternalPlanDescription): InternalPlanDescription = {
      ...
      val arguments: Seq[Argument] = planDescription.arguments.map {
        ...
        case Arguments3_1.InequalityIndex(label, propertyKey, bounds) =>
          Arguments
            .InequalityIndex(label, propertyKey, bounds)
        ...
        case Arguments3_1.SourceCode(className, sourceCode) =>
          Arguments.SourceCode(className, sourceCode)
        case Arguments3_1.CountNodesExpression(ident, label) =>
          Arguments
            .CountNodesExpression(ident, List(label.map(_.name)))
        case Arguments3_1.CountRelationshipsExpression(ident, startLabel, typeNames, endLabel) =>
          Arguments
            .CountRelationshipsExpression(ident, startLabel.map(_.name), typeNames.names, endLabel.map(_.name))
        case Arguments3_1.LegacyExpressions(expressions) => Arguments.Expressions(expressions.mapValues(_ => null))
  ...
  private case class InternalExecutionResultCompatibilityWrapperFor3_2(
      inner: v3_2.executionplan.InternalExecutionResult)
      extends InternalExecutionResult {
    ...
    private def lift(planDescription: v3_2.planDescription.InternalPlanDescription): InternalPlanDescription = {
      ...
      val arguments: Seq[Argument] = planDescription.arguments.map {
        ...
        case Arguments3_2.InequalityIndex(label, propertyKey, bounds) =>
          Arguments
            .InequalityIndex(label, propertyKey, bounds)
        ...
        case Arguments3_2.CountRelationshipsExpression(ident, startLabel, typeNames, endLabel) =>
          Arguments
            .CountRelationshipsExpression(ident, startLabel, typeNames, endLabel)
        case Arguments3_2.LegacyExpressions(expressions) => Arguments.Expressions(expressions.mapValues(_ => null))
