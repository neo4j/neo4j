...
class LogicalPlanConverterTest extends FunSuite with Matchers {
  ...
  test("should convert an IntegerLiteral with its position") {
    ...
    val rewritten = LogicalPlanConverter.convertExpression[expressionsV3_4.SignedDecimalIntegerLiteral](i3_3, new TransactionLayers)
  ...
  test("should convert an Add with its position (recursively)") {
    ...
    val rewritten = LogicalPlanConverter.convertExpression[expressionsV3_4.Add](add3_3, new TransactionLayers)
  ...
  test("should convert Expression with Seq") {
    ...
    LogicalPlanConverter.convertExpression[expressionsV3_4.ListLiteral](l3_3, new TransactionLayers) should be(l3_4)
  }
  ...
  test("should convert Expression with Option") {
    ...
    LogicalPlanConverter.convertExpression[expressionsV3_4.FilterScope](f3_3, new TransactionLayers) should be(f3_4)
    LogicalPlanConverter.convertExpression[expressionsV3_4.FilterScope](f3_3b, new TransactionLayers) should be(f3_4b)
  }
  ...
  test("should convert Expression with Set") {
    ...
    LogicalPlanConverter.convertExpression[expressionsV3_4.Ands](l3_3, new TransactionLayers) should be(l3_4)
  }
  ...
  test("should convert Expression with Seq of Tuple") {
    ...
    LogicalPlanConverter.convertExpression[expressionsV3_4.CaseExpression](c3_3, new TransactionLayers) should be(c3_4)
  }
  ...
  test("should convert Expression with Seq of Tuple (MapExpression)") {
    ...
    LogicalPlanConverter.convertExpression[expressionsV3_4.CaseExpression](m3_3, new TransactionLayers) should be(m3_4)
  }
  ...
  test("should convert PathExpression") {
    ...
    LogicalPlanConverter.convertExpression[PathExpression](pexpv3_3, new TransactionLayers) should be(pexpv3_4)
  }
  ...
  test("should convert AndedPropertyInequalities") {
    ...
    LogicalPlanConverter.convertExpression[PathExpression](a3_3, new TransactionLayers) should be(a3_4)
  }
  ...
  test("should convert Parameter and CypherTypes") {
    ...
    LogicalPlanConverter.convertExpression[PathExpression](p3_3a, new TransactionLayers) should be(p3_4a)
    LogicalPlanConverter.convertExpression[PathExpression](p3_3b, new TransactionLayers) should be(p3_4b)
  }
  ...
  test("should not save expression mappings if isImportant always returns false") {
    ...
    val expressionMapping = LogicalPlanConverter.convertLogicalPlan[plansV3_4.NodeIndexSeek](l3_3, new TransactionLayers, isImportant)._2
  ...
  test("should save distinct expressions with different positions in expression mappings") {
    ...
    val expressionMapping = LogicalPlanConverter.convertLogicalPlan[plansV3_4.NodeIndexSeek](l3_3b, new TransactionLayers, isImportant)._2
  ...
  test("should provide minimal implementation of solved after plan conversion") {
    ...
    val rewrittenPlan = LogicalPlanConverter.convertLogicalPlan[plansV3_4.AllNodesScan](a3_3, new TransactionLayers)._1
  ...
  test("should convert Aggregation and keep ids") {
    ...
    val rewrittenPlan = LogicalPlanConverter.convertLogicalPlan[plansV3_4.Aggregation](ag3_3, new TransactionLayers)._1
  ...
  test("should convert ProduceResult and keep ids") {
    ...
    val rewrittenPlan = LogicalPlanConverter.convertLogicalPlan[plansV3_4.ProduceResult](p3_3, new TransactionLayers)._1
  ...
  test("should convert ErrorPlan") {
    ...
    val rewrittenPlan = LogicalPlanConverter.convertLogicalPlan[ErrorPlan](e3_3, new TransactionLayers)._1
  ...
  test("should convert NodeIndexSeek") {
    ...
    LogicalPlanConverter.convertLogicalPlan[ErrorPlan](n3_3, new TransactionLayers)._1 should be(n3_4)
  }
  ...
  test("should convert ProcedureCall") {
    ...
    val plan = LogicalPlanConverter.convertLogicalPlan[ProcedureCall](pc3_3, new TransactionLayers)._1
  ...
  test("should convert Sort") {
    ...
    val plan = LogicalPlanConverter.convertLogicalPlan[ProcedureCall](s3_3, new TransactionLayers)._1
    plan should be(s3_4)
  }
    ...
    subTypes.filter { c => !Modifier.isAbstract(c.getModifiers) }
      ...
      Try {
        ...
        case Success(expressionV3_3) =>
          ...
          val rewritten = LogicalPlanConverter.convertExpression[expressionsV3_4.Expression](expressionV3_3, new TransactionLayers)
    ...
    subTypes.filter { c => !Modifier.isAbstract(c.getModifiers) }
      ...
      .foreach { subType =>
        ...
        planV3_3 match {
          case Success(plan) =>
            plan.assignIds()
            val rewritten = LogicalPlanConverter.convertLogicalPlan[plansV3_4.LogicalPlan](plan, new TransactionLayers)._1
  ...
  test("Plans should have a transaction layer after conversion") {
    ...
    val attribute = new TransactionLayers
