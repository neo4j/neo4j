...
import org.neo4j.cypher.internal.compiler.v3_1.CompilationPhaseTracer.CompilationPhase.{LOGICAL_PLANNING, PARSING}
import org.neo4j.cypher.internal.compiler.v3_1.helpers.{closing, using}
