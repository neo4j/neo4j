...
import org.neo4j.cypher.internal.compiler.v3_1.commands.predicates.{GreaterThan, True}
import org.neo4j.cypher.internal.compiler.v3_1.helpers.{Counter, CountingIterator}
import org.neo4j.cypher.internal.compiler.v3_1.pipes._
import org.neo4j.cypher.internal.compiler.v3_1.pipes.matching._
...
class LazyTest extends ExecutionEngineFunSuite {
  ...
  test("graph global queries are lazy") {
    ...
    val cache = new QueryCacheManager[String, (ExecutionPlan, Map[String, Any])](cacheAccessor, lruCache)

    when(fakeReadStatement.schemaStateGetOrCreate(any(), any())).thenAnswer(
      new Answer[QueryCacheManager[String, (ExecutionPlan, Map[String, Any])]]() {
