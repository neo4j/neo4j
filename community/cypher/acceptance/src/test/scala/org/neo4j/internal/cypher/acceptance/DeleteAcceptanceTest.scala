...
class DeleteAcceptanceTest extends ExecutionEngineFunSuite with QueryStatisticsTestSupport with NewPlannerTestSupport with TimeLimitedTests {
  ...
  test("should plan within reasonable time") {
    updateWithBothPlannersAndCompatibilityMode("CREATE (n1: `node1` {oid: '1'})")
    updateWithBothPlannersAndCompatibilityMode("CREATE (n2: `node2` {oid: '2'})")
    updateWithBothPlannersAndCompatibilityMode("CREATE (n3: `node3` {oid: '3'})")
    updateWithBothPlannersAndCompatibilityMode("CREATE (n4: `node4` {oid: '4'})")
    updateWithBothPlannersAndCompatibilityMode("CREATE (n5: `node5` {oid: '5'})")
    updateWithBothPlannersAndCompatibilityMode("CREATE (n6: `node6` {oid: '6'})")
    updateWithBothPlannersAndCompatibilityMode("CREATE (n7: `node7` {oid: '7'})")
    updateWithBothPlannersAndCompatibilityMode("CREATE (n8: `users` {oid: '8'})")
    updateWithBothPlannersAndCompatibilityMode("CREATE (n9: `user` {oid: '9'})")
    updateWithBothPlannersAndCompatibilityMode("CREATE (n1)-[r10:`HAS_CHILD` {oid: '10'}]->(n2)")
    updateWithBothPlannersAndCompatibilityMode("CREATE (n1)-[r11:`HAS_CHILD` {oid: '11'}]->(n3)")
    updateWithBothPlannersAndCompatibilityMode("CREATE (n2)-[r12:`HAS_CHILD` {oid: '12'}]->(n4)")
    updateWithBothPlannersAndCompatibilityMode("CREATE (n2)-[r13:`HAS_CHILD` {oid: '13'}]->(n5)")
    updateWithBothPlannersAndCompatibilityMode("CREATE (n3)-[r14:`HAS_CHILD` {oid: '14'}]->(n6)")
    updateWithBothPlannersAndCompatibilityMode("CREATE (n3)-[r15:`HAS_CHILD` {oid: '15'}]->(n7)")
    updateWithBothPlannersAndCompatibilityMode("CREATE (n8)-[r16:`SECURITY` {oid: '16'}]->(n3)")
    updateWithBothPlannersAndCompatibilityMode("CREATE (n9)-[r17:`PART_OF` {oid: '17'}]->(n8)")
