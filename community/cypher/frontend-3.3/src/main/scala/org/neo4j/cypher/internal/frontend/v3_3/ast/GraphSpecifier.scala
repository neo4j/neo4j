...
final case class AliasGraph(ref: GraphRef, alias: Option[Variable])
...
final case class NewGraph(url: Option[GraphUrl], alias: Option[Variable])
                         (val position: InputPosition) extends GraphDef {
...
final case class CopyGraph(ref: GraphRef, to: Option[GraphUrl], alias: Option[Variable])
...
final case class LoadGraph(url: GraphUrl, alias: Option[Variable])
                          (val position: InputPosition) extends GraphDef {
