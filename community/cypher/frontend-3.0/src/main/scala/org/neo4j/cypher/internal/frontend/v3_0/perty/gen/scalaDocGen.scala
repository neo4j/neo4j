...
import org.neo4j.cypher.internal.frontend.v3_0.perty.format.{quoteChar, quoteString}
import org.neo4j.cypher.internal.frontend.v3_0.perty.helpers.{HasContainerType, HasMapType, HasType}
import org.neo4j.cypher.internal.frontend.v3_0.perty.recipe.{Pretty, RecipeAppender}
...
case object scalaDocGen extends CustomDocGen[Any] {
  ...
  import org.neo4j.cypher.internal.frontend.v3_0.perty.recipe.Pretty._
