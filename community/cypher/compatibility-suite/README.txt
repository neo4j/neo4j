...
An example of a configuration is the following (as of 2015-05-25):

Main Class:	cucumber.api.cli.Main
Glue:	cypher
Feature of folder path:	/path/to/neo4j/checkout/community/cypher/compatibility-suite/src/test/resources/cypher/
VM options:
