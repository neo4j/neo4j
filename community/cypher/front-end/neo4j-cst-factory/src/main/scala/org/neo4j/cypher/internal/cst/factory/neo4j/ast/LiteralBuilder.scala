...
trait LiteralBuilder extends CypherParserListener {
  ...
  final override def exitStringLiteral(
    ctx: CypherParser.StringLiteralContext
  ): Unit = {}

  final override def exitNumberLiteral(
    ctx: CypherParser.NumberLiteralContext
  ): Unit = {}
  ...
  override def exitStringsLiteral(
    ctx: CypherParser.StringsLiteralContext
  ): Unit = {}
  ...
  override def exitKeywordLiteral(
    ctx: CypherParser.KeywordLiteralContext
  ): Unit = {}
}
