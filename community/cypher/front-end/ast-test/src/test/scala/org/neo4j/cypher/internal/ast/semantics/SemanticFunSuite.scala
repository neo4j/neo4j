...
trait SemanticFunSuite extends CypherFunSuite3 with SemanticAnalysisTooling with AstConstructionTestSupport {
  ...
  def literal(x: String) = StringLiteral(x)(pos.withInputLength(0))
