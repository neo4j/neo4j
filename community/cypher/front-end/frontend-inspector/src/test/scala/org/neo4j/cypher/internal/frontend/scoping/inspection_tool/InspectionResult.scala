...
case class InspectionSuccess(viewModel: InspectionViewModel) extends InspectionResult

case class InspectionFailure(message: String, details: Seq[String]) extends InspectionResult
