...
class Cypher25VocabularyTest extends CypherFunSuite {
  ...
  private val expectedRuleDisplayNames: Map[Int, String] = Map(
    ...
    Cypher25Parser.RULE_interpolatedStringLiteralSingle -> "an interpolated string",
    Cypher25Parser.RULE_interpolatedStringLiteralDouble -> "an interpolated string",
    Cypher25Parser.RULE_interpolatedStringLiteral -> "an interpolated string",
