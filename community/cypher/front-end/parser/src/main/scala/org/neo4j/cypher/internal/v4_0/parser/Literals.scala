...
trait Literals extends Parser
  ...
  def NewParameter: Rule1[org.neo4j.cypher.internal.v4_0.expressions.Parameter] = rule("a parameter (new syntax") {
  ...
  def OldParameter: Rule1[org.neo4j.cypher.internal.v4_0.expressions.Parameter] = rule("a parameter (old syntax)") {
