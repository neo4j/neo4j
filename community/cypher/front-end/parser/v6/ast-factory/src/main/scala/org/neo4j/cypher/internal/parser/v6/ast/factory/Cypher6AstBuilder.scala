...
import org.neo4j.cypher.internal.parser.v6.AbstractCypher6AstBuilder
...
final class Cypher6AstBuilder(
  ...
  override def exitEndOfFile(ctx: Cypher6Parser.EndOfFileContext): Unit = {}
}
