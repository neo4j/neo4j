...
trait DdlBuilder extends Cypher6ParserListener {

  override def exitCommandOptions(ctx: Cypher6Parser.CommandOptionsContext): Unit = {
  ...
  final override def exitMapOrParameter(
    ctx: Cypher6Parser.MapOrParameterContext
  ): Unit = {
    val map = ctx.map()
    ctx.ast = if (map != null) {
  ...
  final override def exitCommand(
    ctx: Cypher6Parser.CommandContext
  ): Unit = {
    val useCtx = ctx.useClause()
    ctx.ast = lastChild[AstRuleCtx](ctx) match {
      case c: Cypher6Parser.ShowCommandContext => c.ast match {
      ...
      case c: Cypher6Parser.TerminateCommandContext =>
  ...
  final override def exitDropCommand(
    ctx: Cypher6Parser.DropCommandContext
  ): Unit = {
  ...
  final override def exitCommandRelPattern(
    ctx: Cypher6Parser.CommandRelPatternContext
  ): Unit = {
    ctx.ast = (
      ctx.variable().ast[Variable](),
  ...
  final override def exitDropConstraint(
    ctx: Cypher6Parser.DropConstraintContext
  ): Unit = {
  ...
  final override def exitDropIndex(
    ctx: Cypher6Parser.DropIndexContext
  ): Unit = {
  ...
  final override def exitPropertyList(
    ctx: Cypher6Parser.PropertyListContext
  ): Unit = {
  ...
  final override def exitEnclosedPropertyList(
    ctx: Cypher6Parser.EnclosedPropertyListContext
  ): Unit = {
  ...
  final override def exitRenameServer(
    ctx: Cypher6Parser.RenameServerContext
  ): Unit = {
  ...
  final override def exitDropServer(
    ctx: Cypher6Parser.DropServerContext
  ): Unit = {
  ...
  final override def exitRenameRole(
    ctx: Cypher6Parser.RenameRoleContext
  ): Unit = {
  ...
  final override def exitRenameUser(
    ctx: Cypher6Parser.RenameUserContext
  ): Unit = {
    val names = ctx.commandNameExpression()
  ...
  final override def exitAlterCurrentUser(
    ctx: Cypher6Parser.AlterCurrentUserContext
  ): Unit = {
  ...
  final override def exitAlterUser(
    ctx: Cypher6Parser.AlterUserContext
  ): Unit = {
  ...
  override def exitRemoveNamedProvider(ctx: Cypher6Parser.RemoveNamedProviderContext): Unit = {
  ...
  override def exitSetAuthClause(ctx: Cypher6Parser.SetAuthClauseContext): Unit = {
  ...
  override def exitUserAuthAttribute(ctx: Cypher6Parser.UserAuthAttributeContext): Unit = {
  ...
  override def exitPasswordOnly(ctx: Cypher6Parser.PasswordOnlyContext): Unit = {
    ctx.ast = Password(ctx.passwordExpression().ast[Expression](), ctx.ENCRYPTED() != null)(pos(ctx))
  }

  override def exitPassword(ctx: Cypher6Parser.PasswordContext): Unit = {
  ...
  final override def exitPasswordExpression(
    ctx: Cypher6Parser.PasswordExpressionContext
  ): Unit = {
  ...
  final override def exitPasswordChangeRequired(
    ctx: Cypher6Parser.PasswordChangeRequiredContext
  ): Unit = {
    ctx.ast = ctx.NOT() == null
  }

  final override def exitUserStatus(
    ctx: Cypher6Parser.UserStatusContext
  ): Unit = {
    ctx.ast = ctx.SUSPENDED() != null
  }

  final override def exitHomeDatabase(
    ctx: Cypher6Parser.HomeDatabaseContext
  ): Unit = {
  ...
  final override def exitCommandNameExpression(
    ctx: Cypher6Parser.CommandNameExpressionContext
  ): Unit = {
  ...
  final override def exitAliasName(ctx: Cypher6Parser.AliasNameContext): Unit = {
    ctx.ast = ctx.symbolicAliasNameOrParameter().ast[DatabaseName]
  }

  final override def exitDatabaseName(ctx: Cypher6Parser.DatabaseNameContext): Unit = {
    ctx.ast = ctx.symbolicAliasNameOrParameter().ast[DatabaseName]
  }

  final override def exitStringOrParameterExpression(
    ctx: Cypher6Parser.StringOrParameterExpressionContext
  ): Unit = {
  ...
  final override def exitStringOrParameter(
    ctx: Cypher6Parser.StringOrParameterContext
  ): Unit = {
    ctx.ast = if (ctx.stringLiteral() != null) {
