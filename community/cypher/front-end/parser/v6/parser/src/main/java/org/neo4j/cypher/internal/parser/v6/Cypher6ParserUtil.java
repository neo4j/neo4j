...
public class Cypher6ParserUtil {
    ...
    public static synchronized void clearDFACache() {
        for (int i = 0; i < Cypher6Parser._decisionToDFA.length; i++) {
            Cypher6Parser._decisionToDFA[i] = new DFA(Cypher6Parser._ATN.getDecisionState(i), i);
        }
    }
}
