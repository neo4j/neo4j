...
import org.neo4j.cypher.internal.rewriting.rewriters.RemoveUnusedNamedGroupVariablesRewriter
import org.neo4j.cypher.internal.util.StepSequencer

case object QPPsDoesNotHaveUnusedGroupVariables extends StepSequencer.Condition

case object RemoveUnusedNamedGroupVariablesPhase extends Phase[BaseContext, BaseState, BaseState]
  ...
  def process(from: BaseState, context: BaseContext): BaseState =
    from.withStatement(from.statement().endoRewrite(RemoveUnusedNamedGroupVariablesRewriter))
