...
object RememberToUpdateAstGeneratorTest {
  ...
  val ignoreAstClasses: Set[String] = Set(
    ...
    "org.neo4j.cypher.internal.util.symbols.NodeReferenceValueType",
    ...
    "org.neo4j.cypher.internal.util.symbols.RecordType",
    "org.neo4j.cypher.internal.util.symbols.RelationshipType",
    "org.neo4j.cypher.internal.util.symbols.RelationshipReferenceValueType",
