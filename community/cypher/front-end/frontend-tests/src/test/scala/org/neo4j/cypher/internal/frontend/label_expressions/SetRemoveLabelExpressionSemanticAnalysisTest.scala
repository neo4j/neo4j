...
import org.neo4j.gqlstatus.GqlHelper.getGql42001_42I29
...
abstract class LabelExpressionSemanticAnalysisTestSuiteWithChangeStatement(statement: ChangeStatement)
  ...
  protected val errorPosition: InputPosition = p(15, 1, 16)

  protected val errorPositionDynamicLabels: InputPosition =
    if (statement == ChangeStatement.SET) p(19, 1, 20) else p(22, 1, 23)
