...
case class RollUpApplyPipe(lhs: Pipe, rhs: Pipe, collectionName: String, identifierToCollect: String, nullableIdentifiers: Seq[String])
  ...
  override def planDescriptionWithoutCardinality =
    lhs.planDescription.andThen(id, "RollUpApply", variables, KeyNames(Seq(collectionName)))
