...
import org.neo4j.cypher.internal.compiler.v3_0.planner.{CardinalityEstimation, QueryGraph}
  ...
  private val instance: Rewriter = Rewriter.lift {
    case n@NodeHashJoin(nodeIds, lhs, rhs@Selection(rhsPredicates, rhsLeaf)) =>
      ...
      if (newSelection.isEmpty)
        ...
        val newRhsPlannerQuery = rhsLeaf.solved.updateQueryGraph(_.addPredicates(newSelection:_*))
