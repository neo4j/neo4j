...
case class MapProjection(id: String, includeAllProps: Boolean, literalExpressions: Map[String, Expression])
  ...
  override def rewrite(f: (Expression) => Expression) =
    f(MapProjection(id, includeAllProps, literalExpressions.rewrite(f)))
