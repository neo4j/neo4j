...
import org.neo4j.cypher.internal.compiler.v3_0.commands.{Pattern, RelatedTo, VarLengthRelatedTo}
import org.neo4j.cypher.internal.compiler.v3_0.pipes.matching.{PatternGraph, PatternNode, PatternRelationship}
