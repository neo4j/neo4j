...
import org.neo4j.cypher.internal.compiler.v3_0.planner.logical.cardinality._
...
case class PatternSelectivityCalculator(stats: GraphStatistics, combiner: SelectivityCombiner) extends Pattern2Selectivity {
  ...
  import org.neo4j.cypher.internal.compiler.v3_0.planner.logical.cardinality.assumeIndependence.PatternSelectivityCalculator._
