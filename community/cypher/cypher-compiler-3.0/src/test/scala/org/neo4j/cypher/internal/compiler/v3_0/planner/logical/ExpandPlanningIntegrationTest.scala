...
import org.neo4j.cypher.internal.compiler.v3_0.planner.{LogicalPlanningTestSupport2, PlannerQuery, RegularPlannerQuery}
  ...
  test("Should build plans containing expand for two unrelated relationship patterns") {
    ...
    (new given {
      cardinality = mapCardinality {
        ...
        case RegularPlannerQuery(queryGraph, _, _, _) if queryGraph.patternNodes == Set(IdName("d")) => 4000.0
        case _ => 100.0
      }
