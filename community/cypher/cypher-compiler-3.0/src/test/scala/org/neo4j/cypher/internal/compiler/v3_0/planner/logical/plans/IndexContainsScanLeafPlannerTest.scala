...
import org.neo4j.cypher.internal.compiler.v3_0.planner.logical.steps.indexContainsScanLeafPlanner
import org.neo4j.cypher.internal.frontend.v3_0.ast._
import org.neo4j.cypher.internal.frontend.v3_0.test_helpers.CypherFunSuite

class IndexContainsScanLeafPlannerTest extends CypherFunSuite with LogicalPlanningTestSupport2 {
  ...
  test("does not plan index scan when no index exist") {
    new given {
      ...
      // when
      val resultPlans = indexContainsScanLeafPlanner(cfg.qg)(ctx)
