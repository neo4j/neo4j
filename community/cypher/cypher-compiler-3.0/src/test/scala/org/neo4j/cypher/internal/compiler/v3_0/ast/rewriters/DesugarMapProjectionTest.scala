...
import org.neo4j.cypher.internal.frontend.v3_0.{InputPosition, Rewriter, SemanticCheckResult, SemanticState, inSequence}

class DesugarMapProjectionTest extends CypherFunSuite {
