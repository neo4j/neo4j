...
class PickBestPlanUsingHintsAndCostTest extends CypherFunSuite with LogicalPlanningTestSupport2 {
  ...
  val hint1: UsingIndexHint = UsingIndexHint(variable("n"), LabelName("Person")_, PropertyKeyName("name")_)_
  val hint2: UsingIndexHint = UsingIndexHint(variable("n"), LabelName("Person")_, PropertyKeyName("age")_)_
  val hint3: UsingIndexHint = UsingIndexHint(variable("n"), LabelName("Person")_, PropertyKeyName("income")_)_
