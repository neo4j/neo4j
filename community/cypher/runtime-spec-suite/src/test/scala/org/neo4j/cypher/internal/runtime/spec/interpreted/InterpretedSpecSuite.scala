...
class InterpretedLoadCsvTest extends LoadCsvTestBase(COMMUNITY.EDITION, InterpretedRuntime, SIZE_HINT)
                                with LoadCsvWithMergeTestBase[CommunityRuntimeContext]
...
class InterpretedRelationshipTypeReadConcurrencyStressTestBase extends RelationshipTypeReadConcurrencyStressTestBase(COMMUNITY.EDITION, InterpretedRuntime)