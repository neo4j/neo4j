...
abstract class OrderedUnionTestBase[CONTEXT <: RuntimeContext](
  ...
  test("should union two empty streams") {
    ...
    val logicalQuery = new LogicalQueryBuilder(this)
      ...
      .orderedUnion(Seq(Ascending(varFor("x")))).withLeveragedOrder()
      .|.filter("false")
      .|.allNodeScan("x")
      .filter("false")
      .allNodeScan("x")
  ...
  test("should union node and non-node variable") {
    ...
    val logicalQuery = new LogicalQueryBuilder(this)
      ...
      .orderedUnion(Seq(Ascending(varFor("x")), Ascending(varFor("y")))).withLeveragedOrder()
  ...
  test("should union many variables in permuted order") {
    ...
    val logicalQuery = new LogicalQueryBuilder(this)
      ...
      .orderedUnion(sortedOn =
        Seq(Ascending(varFor("x")), Ascending(varFor("y")), Ascending(varFor("z")))
      ).withLeveragedOrder()
  ...
  test("should union under apply") {
    ...
    val logicalQuery = new LogicalQueryBuilder(this)
      ...
      .|.orderedUnion(Seq(Ascending(varFor("res")))).withLeveragedOrder()
      .|.|.projection("z AS res")
  ...
  test("should distinct after union") {
    ...
    val logicalQuery = new LogicalQueryBuilder(this)
      .produceResults("res")
      .distinct("res AS res")
      .orderedUnion(Seq(Ascending(varFor("res"))))
      .|.projection("y AS res")
  ...
  test("should work with limit under apply") {
    ...
    val logicalQuery = new LogicalQueryBuilder(this)
      ...
      .apply().withLeveragedOrder()
      .|.limit(1).withLeveragedOrder()
      .|.orderedUnion(Seq(Ascending(varFor("a")))).withLeveragedOrder()
      .|.|.allNodeScan("a")
      .|.argument()
      .allNodeScan("a")
      .build()
  ...
  test("should union with alias on LHS") {
    ...
    val logicalQuery = new LogicalQueryBuilder(this)
      .produceResults("a", "x").withLeveragedOrder()
      .orderedUnion(Seq(Ascending(varFor("a")), Ascending(varFor("x")))).withLeveragedOrder()
      .|.projection("1 AS x")
      .|.allNodeScan("a")
      .projection("x AS xxx")
  ...
  test("should union on the RHS of a hash join") {
    ...
    val logicalQuery = new LogicalQueryBuilder(this)
      .produceResults("x")
      .nodeHashJoin("x")
      .|.orderedUnion(Seq(Ascending(varFor("x"))))
      .|.|.nodeByLabelScan("x", "B")
      .|.nodeByLabelScan("x", "A")
      .allNodeScan("x")
      .build()
  ...
  test("should union of nested ordered union with aggregations") {
    ...
    val logicalQuery = new LogicalQueryBuilder(this)
      ...
      .|.|.orderedUnion(Seq(Ascending(varFor("z"))))
  ...
  test("github issue #13169") {
    ...
    val logicalQuery = new LogicalQueryBuilder(this)
      ...
      .|.|.orderedUnion(Seq(Ascending(varFor("r"))))
      .|.|.|.filter("not r:A")
