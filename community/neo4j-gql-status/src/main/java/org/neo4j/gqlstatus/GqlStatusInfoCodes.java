...
public enum GqlStatusInfoCodes implements GqlStatusInfo {
    ...
    STATUS_00N70(
            new GqlStatus("00N70"),
            """
                    `$cmd` has no effect. The role or privilege is already assigned.""",
            new String[] {"cmd"},
            Condition.SUCCESSFUL_COMPLETION,
    ...
    STATUS_00N71(
            new GqlStatus("00N71"),
            """
                    `$cmd` has no effect. The role or privilege is not assigned.""",
            new String[] {"cmd"},
            Condition.SUCCESSFUL_COMPLETION,
    ...
    STATUS_00N83(
            new GqlStatus("00N83"),
            """
                    Cordoned servers existed when making an allocation decision. Server(s) `$serverList` are cordoned. This can impact allocation decisions.""",
    ...
    STATUS_00NA0(
            new GqlStatus("00NA0"),
            """
                    `$cmd` has no effect. `$indexConstrPat` already exists.""",
            new String[] {"cmd", "indexConstrPat"},
            Condition.SUCCESSFUL_COMPLETION,
            "index or constraint already exists"),
    STATUS_00NA1(
            new GqlStatus("00NA1"),
            """
                    `$cmd` has no effect. `$indexConstrName` does not exist.""",
            new String[] {"cmd", "indexConstrName"},
            Condition.SUCCESSFUL_COMPLETION,
    ...
    STATUS_01N01(
            new GqlStatus("01N01"),
            """
                    `$thing1` is deprecated. It is replaced by `$thing2`.""",
    ...
    STATUS_01N30(
            new GqlStatus("01N30"),
            """
                    Unable to create a plan with `JOIN ON $varList`. Try to change the join key(s) or restructure your query.""",
            new String[] {"varList"},
            Condition.WARNING,
    ...
    STATUS_01N31(
            new GqlStatus("01N31"),
            """
                    Unable to create a plan with `$indexDescr` because the index does not exist.""",
            new String[] {"indexDescr"},
            Condition.WARNING,
            "hinted index not found"),
    STATUS_01N40(
            new GqlStatus("01N40"),
            """
                    The query cannot be executed with `$preparserInput1`, `$preparserInput2` is used. Cause: `$msg`.""",
            new String[] {"preparserInput1", "preparserInput2", "msg"},
            Condition.WARNING,
            "unsupported runtime"),
    STATUS_01N42(
            new GqlStatus("01N42"),
    ...
    STATUS_01N51(
            new GqlStatus("01N51"),
            """
                    The relationship type `$reltype` does not exist. Verify that the spelling is correct.""",
            new String[] {"reltype"},
            Condition.WARNING,
    ...
    STATUS_01N52(
            new GqlStatus("01N52"),
            """
                    The property `$propkey` does not exist. Verify that the spelling is correct.""",
            new String[] {"propkey"},
            Condition.WARNING,
    ...
    STATUS_01N60(
            new GqlStatus("01N60"),
            """
                    The query plan cannot be cached and is not executable without `EXPLAIN` due to the undefined parameter(s) `$paramList`. Provide the parameter(s).""",
            new String[] {"paramList"},
            Condition.WARNING,
            "parameter missing"),
    STATUS_01N61(
            new GqlStatus("01N61"),
    ...
    STATUS_01N63(
            new GqlStatus("01N63"),
            """
                    `$var` is repeated in `$pat`, which leads to no results.""",
            new String[] {"var", "pat"},
            Condition.WARNING,
    ...
    STATUS_01N70(
            new GqlStatus("01N70"),
            """
                    `$cmd` has no effect. $msg Make sure nothing is misspelled. This notification will become an error in a future major version.""",
            new String[] {"cmd", "msg"},
            Condition.WARNING,
    ...
    STATUS_03N60(
            new GqlStatus("03N60"),
            """
                    The variable `$var` in the subquery uses the same name as a variable from the outer query. Use `WITH $var` in the subquery to import the one from the outer scope unless you want it to be a new variable.""",
            new String[] {"var", "var"},
            Condition.INFORMATIONAL,
    ...
    STATUS_03N90(
            new GqlStatus("03N90"),
            """
                    The disconnected patterns `$pat` build a cartesian product. A cartesian product may produce a large amount of data and slow down query processing.""",
            new String[] {"pat"},
            Condition.INFORMATIONAL,
            "cartesian product"),
    STATUS_03N91(
            new GqlStatus("03N91"),
            """
                    The provided pattern `$pat` is unbounded. Shortest path with an unbounded pattern may result in long execution times. Use an upper limit (e.g. `[*..5]`) on the number of node hops in your pattern.""",
            new String[] {"pat"},
            Condition.INFORMATIONAL,
    ...
    STATUS_03N92(
            new GqlStatus("03N92"),
            """
                    The query runs with exhaustive shortest path due to the existential predicate(s) `$predList`. It may be possible to use `WITH` to separate the `MATCH` from the existential predicate(s).""",
            new String[] {"predList"},
            Condition.INFORMATIONAL,
    ...
    STATUS_03N93(
            new GqlStatus("03N93"),
            """
                    `LOAD CSV` in combination with `MATCH` or `MERGE` on a label that does not have an index may result in long execution times. Consider adding an index for label `$label`.""",
            new String[] {"label"},
            Condition.INFORMATIONAL,
            "no applicable index"),
    STATUS_03N94(
    ...
    STATUS_03N95(
            new GqlStatus("03N95"),
            """
                    An index exists on label/type(s) `$labelList`. It is not possible to use indexes for dynamic properties. Consider using static properties.""",
            new String[] {"labelList"},
            Condition.INFORMATIONAL,
            "dynamic property"),
    STATUS_03N96(
            new GqlStatus("03N96"),
    ...
    STATUS_08N02(
            new GqlStatus("08N02"),
            """
                    Unable to connect to database `$dbName`. Server-side routing is disabled. Either connect to the `$dbName` directly, or enable server-side routing by setting `$routingEnabledSetting=true`.""",
            new String[] {"dbName", "dbName", "routingEnabledSetting"},
            Condition.CONNECTION_EXCEPTION,
    ...
    STATUS_08N10(
            new GqlStatus("08N10"),
            """
                    The server is not in a state that can process message of type: `$msgType`.""",
            new String[] {"msgType"},
            Condition.CONNECTION_EXCEPTION,
    ...
    STATUS_08N15(
            new GqlStatus("08N15"),
            """
                    Policy definition for '$routingPolicy' could not be found.""",
            new String[] {"routingPolicy"},
            Condition.CONNECTION_EXCEPTION,
    ...
    STATUS_22N04(
            new GqlStatus("22N04"),
            """
                    Invalid input `$input` for `$context`. Expected one of $validValuesList.""",
            new String[] {"input", "context", "validValuesList"},
            Condition.DATA_EXCEPTION,
            "invalid input value"),
    STATUS_22N05(
            new GqlStatus("22N05"),
    ...
    STATUS_22N18(
            new GqlStatus("22N18"),
            """
                    A `$crs` `POINT` must contain `$mandatoryKeys`.""",
            new String[] {"crs", "mandatoryKeys"},
            Condition.DATA_EXCEPTION,
    ...
    STATUS_22N57(
            new GqlStatus("22N57"),
            """
                    Protocol type is invalid. Invalid number of struct components (received `$actualComponentCount` but expected `$expectedComponentCount`).""",
    ...
    STATUS_22N59(
            new GqlStatus("22N59"),
            """
                    The `$tokenType` token with id `$tokenId` was not found.""",
            new String[] {"tokenType", "tokenId"},
            Condition.DATA_EXCEPTION,
            "no such token"),
    STATUS_22N62(
            new GqlStatus("22N62"),
            """
                    Relationship Type `$relType` not found.""",
            new String[] {"relType"},
            Condition.DATA_EXCEPTION,
    ...
    STATUS_22N63(
            new GqlStatus("22N63"),
            """
                    Property Key `$propKey` not found.""",
            new String[] {"propKey"},
            Condition.DATA_EXCEPTION,
    ...
    STATUS_22N64(
            new GqlStatus("22N64"),
            """
                    No such constraint: `$constraintDescriptorOrName`.""",
            new String[] {"constraintDescriptorOrName"},
            Condition.DATA_EXCEPTION,
            "no such constraint"),
    STATUS_22N65(
            new GqlStatus("22N65"),
            """
                    An equivalent constraint already exists: `$constraintDescriptorOrName`.""",
            new String[] {"constraintDescriptorOrName"},
            Condition.DATA_EXCEPTION,
    ...
    STATUS_22N66(
            new GqlStatus("22N66"),
            """
                    A conflicting constraint already exists: `$constraintDescriptorOrName`.""",
            new String[] {"constraintDescriptorOrName"},
            Condition.DATA_EXCEPTION,
    ...
    STATUS_22N67(
            new GqlStatus("22N67"),
            """
                    A constraint with the same name already exists: `$constraintName`.""",
    ...
    STATUS_22N69(
            new GqlStatus("22N69"),
            """
                    No such index: `$indexDescriptorOrName`.""",
            new String[] {"indexDescriptorOrName"},
            Condition.DATA_EXCEPTION,
            "no such index"),
    STATUS_22N70(
            new GqlStatus("22N70"),
            """
                    An equivalent index already exists: `$indexDescriptorOrName`.""",
            new String[] {"indexDescriptorOrName"},
            Condition.DATA_EXCEPTION,
    ...
    STATUS_22N73(
            new GqlStatus("22N73"),
            """
                    Constraint conflicts with already existing index `$indexName`.""",
            new String[] {"indexName"},
            Condition.DATA_EXCEPTION,
    ...
    STATUS_22N74(
            new GqlStatus("22N74"),
            """
                    An index that belongs to the constraint `$constraintName` contains a conflicting index.""",
            new String[] {"constraintName"},
            Condition.DATA_EXCEPTION,
    ...
    STATUS_22N75(
            new GqlStatus("22N75"),
            """
                    Constraint `$constraintDescriptorOrName` includes a $labelOrRelTypeOrPropKey more than once.""",
            new String[] {"constraintDescriptorOrName", "labelOrRelTypeOrPropKey"},
            Condition.DATA_EXCEPTION,
            "constraint contains duplicated tokens"),
    STATUS_22N76(
            new GqlStatus("22N76"),
            """
                    Index `$indexDescriptorOrName` includes a $labelOrRelTypeOrPropKey more than once.""",
            new String[] {"indexDescriptorOrName", "labelOrRelTypeOrPropKey"},
            Condition.DATA_EXCEPTION,
            "index contains duplicated tokens"),
    STATUS_22N77(
            new GqlStatus("22N77"),
            """
                    `$nodeOrRel` ($entityId) with $labelOrType `$labelOrTypeName` must have the following propertie(s): $propkeyList.""",
            new String[] {"nodeOrRel", "entityId", "labelOrType", "labelOrTypeName", "propkeyList"},
            Condition.DATA_EXCEPTION,
            "property presence verification failed"),
    STATUS_22N78(
            new GqlStatus("22N78"),
            """
                    `$nodeOrRel` ($entityId) with $labelOrType `$labelOrTypeName` must have the property `$propkey` with type `$type`.""",
            new String[] {"nodeOrRel", "entityId", "labelOrType", "labelOrTypeName", "propkey", "type"},
            Condition.DATA_EXCEPTION,
            "property type verification failed"),
    STATUS_22N79(
            new GqlStatus("22N79"),
            """
                    Both `$nodeOrRel` ($entityOneId) and `$nodeOrRel` ($entityTwoId) have the same value for property `$propkey`.""",
            new String[] {"nodeOrRel", "entityOneId", "nodeOrRel", "entityTwoId", "propkey"},
            Condition.DATA_EXCEPTION,
    ...
    STATUS_25N12(
            new GqlStatus("25N12"),
            """
                    Index `$indexName` was dropped in this transaction and cannot be used.""",
            new String[] {"indexName"},
            Condition.INVALID_TRANSACTION_STATE,
            "index was dropped"),
    STATUS_25N13(
            new GqlStatus("25N13"),
            """
                    A $nodeOrRelationship was accessed after being deleted in this transaction. Verify the transaction statements.""",
            new String[] {"nodeOrRelationship"},
            Condition.INVALID_TRANSACTION_STATE,
    ...
    STATUS_42N17(
            new GqlStatus("42N17"),
            """
                    `$thing` is not allowed on the system database.""",
            new String[] {"thing"},
            Condition.SYNTAX_ERROR_OR_ACCESS_RULE_VIOLATION,
            "unsupported request"),
    STATUS_42N18(
    ...
    STATUS_42N54(
            new GqlStatus("42N54"),
            """
                    The match mode `$matchMode ` is not supported.""",
            new String[] {"matchMode"},
            Condition.SYNTAX_ERROR_OR_ACCESS_RULE_VIOLATION,
    ...
    STATUS_42N89(
            new GqlStatus("42N89"),
            """
                    Failed evaluating the given driver settings. $cause""",
            new String[] {"cause"},
            Condition.SYNTAX_ERROR_OR_ACCESS_RULE_VIOLATION,
    ...
    STATUS_42N90(
            new GqlStatus("42N90"),
            """
                    Composite databases cannot be altered (database: `$name`).""",
            new String[] {"name"},
            Condition.SYNTAX_ERROR_OR_ACCESS_RULE_VIOLATION,
    ...
    STATUS_42N91(
            new GqlStatus("42N91"),
            """
                    Cannot index nested properties (property: `$property`).""",
            new String[] {"property"},
            Condition.SYNTAX_ERROR_OR_ACCESS_RULE_VIOLATION,
    ...
    STATUS_42N97(
            new GqlStatus("42N97"),
            """
                    Clause `$clause` is mandatory for auth provider `$provider`.""",
            new String[] {"clause", "provider"},
            Condition.SYNTAX_ERROR_OR_ACCESS_RULE_VIOLATION,
    ...
    STATUS_50N08(
            new GqlStatus("50N08"),
            """
                    Unable to create `$indexDescriptorOrName`.""",
            new String[] {"indexDescriptorOrName"},
            Condition.GENERAL_PROCESSING_EXCEPTION,
    ...
    STATUS_50N09(
            new GqlStatus("50N09"),
            """
                    The server transitioned into a server state that is not valid in the current context: `$stateName`.""",
    ...
    STATUS_50N10(
            new GqlStatus("50N10"),
            """
                    Unable to drop `$indexDescriptorOrName`.""",
            new String[] {"indexDescriptorOrName"},
            Condition.GENERAL_PROCESSING_EXCEPTION,
            "index drop failed"),
    STATUS_50N11(
            new GqlStatus("50N11"),
            """
                    Unable to create `$constraintDescriptorOrName`.""",
            new String[] {"constraintDescriptorOrName"},
            Condition.GENERAL_PROCESSING_EXCEPTION,
    ...
    STATUS_50N12(
            new GqlStatus("50N12"),
            """
                    Unable to drop `$constraintDescriptorOrName`.""",
            new String[] {"constraintDescriptorOrName"},
            Condition.GENERAL_PROCESSING_EXCEPTION,
    ...
    STATUS_50N13(
            new GqlStatus("50N13"),
            """
                    Unable to validate constraint `$constraintDescriptorOrName`.""",
            new String[] {"constraintDescriptorOrName"},
            Condition.GENERAL_PROCESSING_EXCEPTION,
    ...
    STATUS_50N15(
            new GqlStatus("50N15"),
            """
                    The system attemped to execute an unsupported operation on index `$indexName`. See debug.log for more information.""",
            new String[] {"indexName"},
            Condition.GENERAL_PROCESSING_EXCEPTION,
    ...
    STATUS_50N21(
            new GqlStatus("50N21"),
            """
                    No `$schemaDescriptor` was found for `$tokenName`.""",
            new String[] {"schemaDescriptor", "tokenName"},
            Condition.GENERAL_PROCESSING_EXCEPTION,
    ...
    STATUS_51N02(
            new GqlStatus("51N02"),
            """
                    Unable to set up injection for procedure `$javaClass`. The field `$javaField` has type `$javaType` which is not a supported injectable component.""",
            new String[] {"javaClass", "javaField", "javaType"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
            "unsupported injectable component type"),
    STATUS_51N03(
            new GqlStatus("51N03"),
            """
                    Unable to set up injection for `$javaClass`, failed to access field `$javaField`.""",
            new String[] {"javaClass", "javaField"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
            "unable to access field"),
    STATUS_51N04(
            new GqlStatus("51N04"),
            """
                    The field `$javaField` on `$javaClass` must be annotated as a `@Context` field in order to store its state.""",
            new String[] {"javaField", "javaClass"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
            "missing class field annotation"),
    STATUS_51N05(
            new GqlStatus("51N05"),
            """
                    The field `$javaField` on `$javaClass` must be declared non-final and public.""",
            new String[] {"javaField", "javaClass"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
    ...
    STATUS_51N06(
            new GqlStatus("51N06"),
            """
                    The argument at position `$positionNum` in `$javaMethod` requires a `@Name` annotation and a non-empty name.""",
            new String[] {"positionNum", "javaMethod"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
    ...
    STATUS_51N08(
            new GqlStatus("51N08"),
            """
                    The class `$javaClass` must contain exactly one '@UserAggregationResult' method and exactly one '@UserAggregationUpdate' method.""",
    ...
    STATUS_51N09(
            new GqlStatus("51N09"),
            """
                    The '@UserAggregationUpdate' method `$javaMethod` in $javaClass must be public and have the return type 'void'.""",
            new String[] {"javaMethod", "javaClass"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
            "@UserAggregationUpdate method must be public and void"),
    STATUS_51N10(
            new GqlStatus("51N10"),
            """
                    The '$javaMethod' method `$methodName` in $javaClass must be public.""",
            new String[] {"javaMethod", "methodName", "javaClass"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
            "aggregation method not public"),
    STATUS_51N11(
            new GqlStatus("51N11"),
            """
                    The class `$javaClass` must be public.""",
            new String[] {"javaClass"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
            "class not public"),
    STATUS_51N12(
    ...
    STATUS_51N14(
            new GqlStatus("51N14"),
            """
                    The procedure `$proc` has a duplicate $javaType field, `$javaField`.""",
            new String[] {"proc", "javaType", "javaField"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
    ...
    STATUS_51N17(
            new GqlStatus("51N17"),
            """
                    Procedures and functions cannot be defined in the root namespace, or use a reserved namespace. Use the package name instead e.g. `org.example.com.$procFun`.""",
            new String[] {"procFun"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
    ...
    STATUS_51N18(
            new GqlStatus("51N18"),
            """
                    The method `$javaMethod` has an invalid return type. Procedures must return a stream of records, where each record is of a defined concrete class.""",
            new String[] {"javaMethod"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
            "invalid method return type"),
    STATUS_51N20(
            new GqlStatus("51N20"),
            """
                    The field `$javaField` is not injectable. Ensure the field is marked as public and non-final.""",
            new String[] {"javaField"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
            "cannot inject field"),
    STATUS_51N21(
            new GqlStatus("51N21"),
    ...
    STATUS_51N26(
            new GqlStatus("51N26"),
            """
                    $thing is not available. This implementation of Cypher does not support $featureDescr.""",
            new String[] {"thing", "featureDescr"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
    ...
    STATUS_51N52(
            new GqlStatus("51N52"),
            """
                    Number of primaries '$number' may not exceed $maxPrimaries and needs to be at least 1.""",
            new String[] {"number", "maxPrimaries"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
            "cannot alter database topology"),
    STATUS_51N53(
            new GqlStatus("51N53"),
            """
                    Number of secondaries '$number' may not exceed $maxSecondaries and needs to be at least 0.""",
            new String[] {"number", "maxSecondaries"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
            "cannot alter database topology"),
    STATUS_51N54(
            new GqlStatus("51N54"),
    ...
    STATUS_51N55(
            new GqlStatus("51N55"),
            """
                    Failed to create the database `$databaseName`. The limit of databases is reached. Either increase the limit using the config setting `$setting` or drop a database.""",
            new String[] {"databaseName", "setting"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
    ...
    STATUS_51N58(
            new GqlStatus("51N58"), "", new String[] {}, Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION, ""),
    STATUS_51N59(
            new GqlStatus("51N59"),
            """
    ...
    STATUS_51N61(
            new GqlStatus("51N61"),
            """
                    Index `$indexName` population failed.""",
            new String[] {"indexName"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
    ...
    STATUS_51N62(
            new GqlStatus("51N62"),
            """
                    Unable to use index `$indexName` because it is in a failed state. See logs for more information.""",
            new String[] {"indexName"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
    ...
    STATUS_51N65(
            new GqlStatus("51N65"),
            """
                    Vector index `$indexName` has a dimensionality of `$indexDim`, but indexed vectors have `$vectorsDim`.""",
            new String[] {"indexName", "indexDim", "vectorsDim"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
    ...
    STATUS_51N67(
            new GqlStatus("51N67"),
            """
                    Unexpected selector `$selectorType` at `$in`, expected selector to be a `$selectorType2` selector.""",
            new String[] {"selectorType", "in", "selectorType2"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
    ...
    STATUS_51N69(
            new GqlStatus("51N69"),
            """
                    It is not possible to perform $action on the system database.""",
            new String[] {"action"},
            Condition.SYSTEM_CONFIGURATION_OR_OPERATION_EXCEPTION,
    ...
    STATUS_52N06(
            new GqlStatus("52N06"),
            """
                    Unexpected number of arguments (expected 0-2 but received $nbr).""",
            new String[] {"nbr"},
            Condition.PROCEDURE_EXCEPTION,
    ...
    STATUS_52N22(
            new GqlStatus("52N22"),
            """
                    Invalid argument `$arg` for `$param` on procedure `$proc`. `$param` expected format is `$paramFmt`.""",
            new String[] {"arg", "param", "proc", "param", "paramFmt"},
            Condition.PROCEDURE_EXCEPTION,
    ...
    STATUS_52N25(
            new GqlStatus("52N25"),
            """
                    JMX error while accessing `$param`. See logs for more information.""",
            new String[] {"param"},
            Condition.PROCEDURE_EXCEPTION,
            "JMX error"),
    STATUS_52N26(
    ...
    STATUS_52N28(
            new GqlStatus("52N28"),
            """
                    `$param1` is not a valid change identifier. Transaction ID `$param2` does not exist.""",
            new String[] {"param1", "param2"},
            Condition.PROCEDURE_EXCEPTION,
    ...
    public static String getMessage(String message, List<String> params) {
        ...
        for (int i = 0; i < params.size() && i < foundParams.size(); i++) {
            paramMap.put(foundParams.get(i), params.get(i));
        }
        return getMessage(message, paramMap);
    }

    public String getMessage(Map<String, String> parameterMap) {
        return GqlStatusInfoCodes.getMessage(message, parameterMap);
    }

    public static String getMessage(String message, Map<String, String> parameterMap) {
