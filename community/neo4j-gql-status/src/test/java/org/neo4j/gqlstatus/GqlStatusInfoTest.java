...
public class GqlStatusInfoTest {
    ...
    void shouldSubstituteParams() {
        String m = "My name is `$param1`, nice to meet `$param2`";
        String resultMap = GqlStatusInfoCodes.getMessage(
                m, Map.of(GqlMessageParams.param1, "Neo", GqlMessageParams.param2, "you"));
    ...
    void shouldNotCrashIfTooFewParams() {
        String m1 = "My name is `$param1`, nice to meet `$param2`";
        String resultMap1 = GqlStatusInfoCodes.getMessage(m1, Map.of(GqlMessageParams.param1, "Neo"));
        String resultList1 = GqlStatusInfoCodes.getMessage(m1, List.of("Neo"));
        assertEquals("My name is `Neo`, nice to meet `$param2`", resultMap1);
        assertEquals(resultMap1, resultList1);

        String m2 = "My name is `$param1`, nice to meet `$param2`";
        String resultMap2 = GqlStatusInfoCodes.getMessage(m2, Map.of(GqlMessageParams.param2, "you"));
        String resultList2 = GqlStatusInfoCodes.getMessage(m2, List.of("you"));
        assertEquals("My name is `$param1`, nice to meet `you`", resultMap2);
        ...
        assertEquals(resultList2, "My name is `you`, nice to meet `$param2`");
    }

    @Test
    void shouldNotCrashIfTooManyParams() {
        String m1 = "My name is `$param1`, nice to meet `$param2`";
        String resultMap1 = GqlStatusInfoCodes.getMessage(
                m1,
                Map.of(
                        GqlMessageParams.param1,
                        "Neo",
                        GqlMessageParams.param2,
                        "you",
                        GqlMessageParams.param3,
                        "many"));
        ...
        String m2 = "My name is `$param1`, nice to meet `$param2`";
        String resultMap2 = GqlStatusInfoCodes.getMessage(
                m2,
                Map.of(
                        GqlMessageParams.param1,
                        "Neo",
    ...
    void shouldNotCrashIfParamsAreWrong() {
        String m = "My name is `$param1`, nice to meet `$param2`";
        String resultMap =
                GqlStatusInfoCodes.getMessage(m, Map.of(GqlMessageParams.db, "123", GqlMessageParams.dbName, "hello"));
        String resultList = GqlStatusInfoCodes.getMessage(m, List.of("123", "hello"));
        assertEquals("My name is `$param1`, nice to meet `$param2`", resultMap);
    ...
    void shouldNotCrashIfParamValueContainsRegexSyntax() {
        ...
        String m1 = "My name is `$param1`, nice to meet `$param2`";
        String resultMap1 = GqlStatusInfoCodes.getMessage(
                m1, Map.of(GqlMessageParams.param1, "$Neo", GqlMessageParams.param2, "$you"));
        ...
        String m2 = "My name is `$param1`, nice to meet `$param2`";
        String resultMap2 = GqlStatusInfoCodes.getMessage(
                m2, Map.of(GqlMessageParams.param1, "[A-Z]", GqlMessageParams.param2, "^."));
    ...
    void shouldSubstituteRepeatedParams() {
        ...
        String resultMap = GqlStatusInfoCodes.getMessage(m, Map.of(GqlMessageParams.db, "My awesome database"));
    ...
    void shouldSubstituteParamsWithoutBackticks() {
        ...
        String resultMap = GqlStatusInfoCodes.getMessage(m, Map.of(GqlMessageParams.name, "Neo"));
    ...
    void shouldAllowDollarsIfMessageNotCamelCase() {
        ...
        String m1 = "This costs $5, your balance is $`$value`";
        String expected = "This costs $5, your balance is $`10`";
        String resultMap1 = GqlStatusInfoCodes.getMessage(m1, Map.of(GqlMessageParams.value, "10"));
        String resultList1 = GqlStatusInfoCodes.getMessage(m1, List.of("10"));
        assertEquals(expected, resultMap1);
        assertEquals(resultMap1, resultList1);

        String m2 = "This costs $9.99, your balance is $`$value`";
        String expected2 = "This costs $9.99, your balance is $`10`";
        String resultMap2 = GqlStatusInfoCodes.getMessage(m2, Map.of(GqlMessageParams.value, "10"));
        ...
        String m3 = "This costs $9.99, your balance is $$value";
        String expected3 = "This costs $9.99, your balance is $10";
        String resultMap3 = GqlStatusInfoCodes.getMessage(m3, Map.of(GqlMessageParams.value, "10"));
