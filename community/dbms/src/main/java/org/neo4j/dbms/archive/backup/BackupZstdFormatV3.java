...
public class BackupZstdFormatV3 implements BackupCompressionFormat {
    static final MagicSignature MAGIC_HEADER = MagicSignature.of(ArchiveFormat.BACKUP_PREFIX + "ZV3");
    ...
    public StreamWithDescription decompressAndDescribe(InputStream stream) throws IOException {
        ...
        return new StreamWithDescription(StandardCompressionFormat.ZSTD.decompress(stream), description);
    }
    ...
    public String toString() {
        return "BackupZstdFormatV3{metadata=" + metadata + '}';
    }
}
