...
class ExtendedDatabaseInfoTest
{
    ...
    {
        // given
        var databaseInfo = new ExtendedDatabaseInfo( null, null, null, null, null, null, COMMITTED_TX_ID_NOT_AVAILABLE, -1 );
    ...
    {
        // given
        var databaseInfo = new ExtendedDatabaseInfo( null, null, null, null, null, null, COMMITTED_TX_ID_NOT_AVAILABLE, -42 );
    ...
    void shouldReturnLastCommittedTxIdWithValue()
    {
        ...
        var databaseInfo = new ExtendedDatabaseInfo( null, null, null, null, null, null, lastCommittedTxId, -42 );
    ...
    void shouldReturnTxCommitLagWithValue()
    {
        // given
        var txCommitLag = -1;
        var databaseInfo = new ExtendedDatabaseInfo( null, null, null, null, null, null, 5040, txCommitLag );
    ...
    {
        // given
        var databaseInfo1 = new ExtendedDatabaseInfo( null, null, null, null, null, null, -1, -7 );
        var databaseInfo2 = new ExtendedDatabaseInfo( null, null, null, null, null, null, -1, -50 );
