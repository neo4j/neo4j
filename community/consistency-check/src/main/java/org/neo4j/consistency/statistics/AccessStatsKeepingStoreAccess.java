...
public class AccessStatsKeepingStoreAccess extends StoreAccess
{
            ...
            extends RecordStore.Delegator<RECORD>
    {
        ...
        @Override
        public RECORD forceGetRaw( RECORD record )
        {
            RECORD result = super.forceGetRaw( record );
            accessStats.upRead( record.getLongId() );
            return result;
        }

        @Override
        public RECORD forceGetRaw( long id )
        {
            accessStats.upRead( id );
            return super.forceGetRaw( id );
        }
    }
}
