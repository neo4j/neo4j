...
public class FullCheck
{
            ...
            throws ConsistencyCheckIncompleteException
    {
        ...
        DiffRecordAccess records = recordAccess( stores.nativeStores(), cacheAccess );
        execute( stores, decorator, records, report, cacheAccess );
            ...
            throws ConsistencyCheckIncompleteException
    {
        ...
        StringBuilder consoleMsg = new StringBuilder( "Full Consistency Check" );
                      ...
                      new IndexAccessors( directStoreAccess.indexes(), nativeStores.getSchemaStore(), samplingConfig ) )
        {
            MultiPassStore.Factory multiPass = new MultiPassStore.Factory(
                    decorator, recordAccess, cacheAccess, report );
    ...
    static DiffRecordAccess recordAccess( StoreAccess store, CacheAccess cacheAccess )
    {
