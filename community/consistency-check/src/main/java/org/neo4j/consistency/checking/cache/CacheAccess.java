...
public interface CacheAccess
{
    ...
    interface Client
    {
         ...
         */
        PropertyRecord getPropertyFromCacheCache( long id );

        /**
         * Processes the {@link #putPropertiesToCache(Collection) cached properties}, at least feeding them into
         * the {@code propertyCheck}.
         *
         * @param node {@link NodeRecord} owner of the cached properties. I.e. the cached properties are only
         * used for nodes a.t.m.
         *
         * @param propertyCheck {@link RecordCheck} to feed the properties into.
         * @param reporter inconsistencies reporter.
         */
        void processProperties( NodeRecord node,
    ...
    Client EMPTY_CLIENT = new Client()
    {
        ...
        @Override
        public PropertyRecord getPropertyFromCacheCache( long id )
        {
            return null;
        }

        @Override
        public void processProperties( NodeRecord node,
                RecordCheck<PropertyRecord,PropertyConsistencyReport> propertyCheck, ConsistencyReporter reporter )
        {
        }
