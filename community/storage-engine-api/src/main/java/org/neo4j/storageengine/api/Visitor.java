...
/**
 * Able to visit, i.e. gain brief access to data. See https://en.wikipedia.org/wiki/Visitor_pattern
 *
 * @param <E> type of items to visit.
 * @param <FAILURE> {@link Exception} thrown from {@link #visit(Object)} method.
 */
@FunctionalInterface
