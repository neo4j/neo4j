...
public class HTTP
{
    ...
    public static Response POST( String uri, Payload payload )
    {
        return BUILDER.POST( uri, payload );
    }
    ...
    public static Response PUT( String uri, Payload payload )
    {
        return BUILDER.PUT( uri, payload );
    }
    ...
    public static class Builder
    {
        ...
        {
            return exec( "POST", uri, new JsonPayload(payload) );
        }

        public Response POST( String uri, Payload payload )
        {
        ...
        {
            return exec( "PUT", uri, new JsonPayload(payload) );
        }

        public Response PUT( String uri, Payload payload )
        {
        ...
        public Response exec( String method, String uri, Payload payload )
        {
            ClientRequest.Builder lastBuilder = build().entity( payload.content(), payload.contentType());
    ...
    public static class Response
    {
        ...
        public Response( ClientResponse response )
        {
            ...
            this.entity = response.getEntity( byte[].class );
        }
        ...
        public <T> T content()
        {
            try
            {
                return (T) JsonHelper.readJson( new String(entity, Charsets.UTF_8) );
            }
            catch ( JsonParseException e )
            {
                throw new RuntimeException( "Unable to deserialize: " + BytePrinter.hex(entity), e );
            }
        }
        ...
        {
            return JsonHelper.jsonNode( new String(entity, Charsets.UTF_8) ).get( fieldName );
        }
        ...
        public String toString()
        {
            ...
            sb.append( "\n" );
            sb.append( new String(entity, Charsets.UTF_8) ).append( "\n" );
    ...
    public static class JsonPayload implements Payload
    {
        ...
        public JsonPayload( Object data )
        {
            this.data = data;
        }
