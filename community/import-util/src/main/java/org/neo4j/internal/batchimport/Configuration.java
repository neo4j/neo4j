...
public interface Configuration
{
     ...
     * @param pathOnDevice {@link File} to look for clues how to fine tune the configuration even more.
     ...
     */
    static Configuration defaultConfiguration( File pathOnDevice )
    {
        boolean highIoForDevice = FileUtils.highIODevice( pathOnDevice.toPath() );
