...
public class NumberArrayFactories
{
    ...
    public static final NumberArrayFactory HEAP = new NumberArrayFactory.Adapter()
    {
        ...
        @Override
        public HeapByteArray newByteArray( long length, byte[] defaultValue, long base )
        {
    ...
    /**
     * Used as part of the fallback strategy for {@link Auto}. Tries to split up fixed-size arrays ({@link NumberArrayFactory#newLongArray(long, long)} and
     * {@link NumberArrayFactory#newIntArray(long, int)} into smaller chunks where some can live on heap and some off heap.
     */
     ...
     * {@code pageCache}.
     */
    public static NumberArrayFactory auto( PageCache pageCache, File dir, boolean allowHeapAllocation, NumberArrayFactory.Monitor monitor, Log log )
    {
