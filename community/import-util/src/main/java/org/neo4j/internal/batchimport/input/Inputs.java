...
public class Inputs
{
    ...
    public static int calculatePropertySize( InputEntity entity, ToIntBiFunction<Value[],PageCursorTracer> valueSizeCalculator,
            PageCursorTracer cursorTracer )
    {
        ...
        if ( propertyCount > 0 )
        {
            ...
            size += valueSizeCalculator.applyAsInt( values, cursorTracer );
        }
        return size;
    }
}
