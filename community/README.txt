...
o Connecting to a local already running Neo4j instance (NOTE: 
  NeoService.enableRemoteShell() must have been invoked):
	...
	java -jar shell-1.0-b9.jar 

o Connecting to an offline Neo4j store you will need neo-1.0-b9.jar, 
  jta-1_1.jar and shell-1.0-b9 in your classpath. Type:

	java -cp neo-1.0-b9.jar:jta-1_1.jar:shell-1.0-b9.jar \
