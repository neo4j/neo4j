...
public class PersonRepository {
    ...
    public static final RelationshipType STATUS =
            DynamicRelationshipType.withName("STATUS");
    static final RelationshipType NEXT =
            DynamicRelationshipType.withName("NEXT");
    ...
    private Node createNewStatusNode(String text, Node personNode) {
        ...
        newStatus.createRelationshipTo(personNode, StatusUpdate.PERSON);
        return newStatus;
    }
}