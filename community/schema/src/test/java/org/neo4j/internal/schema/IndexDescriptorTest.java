...
class IndexDescriptorTest
{
    private static final SchemaDescriptor[] SCHEMAS = {
            ...
            SchemaDescriptor.forLabelOfType( IndexType.BTREE, 1, 1 ),
            SchemaDescriptor.forLabelOfType( IndexType.BTREE, 1, 2 ),
            SchemaDescriptor.forLabelOfType( IndexType.BTREE, 2, 1 ),
            SchemaDescriptor.forLabelOfType( IndexType.BTREE, 2, 2 ),
            SchemaDescriptor.forLabelOfType( IndexType.BTREE, 1, 1, 1 ),
            SchemaDescriptor.forLabelOfType( IndexType.BTREE, 1, 1, 2 ),
            SchemaDescriptor.forLabelOfType( IndexType.BTREE, 1, 2, 1 ),
            SchemaDescriptor.forLabelOfType( IndexType.BTREE, 1, 2, 2 ),
            SchemaDescriptor.forLabelOfType( IndexType.BTREE, 2, 1, 1 ),
            SchemaDescriptor.forLabelOfType( IndexType.BTREE, 2, 2, 1 ),
            SchemaDescriptor.forLabelOfType( IndexType.BTREE, 2, 1, 2 ),
            SchemaDescriptor.forLabelOfType( IndexType.BTREE, 2, 2, 2 ),
            ...
            SchemaDescriptor.forRelTypeOfType( IndexType.BTREE, 1, 1 ),
            SchemaDescriptor.forRelTypeOfType( IndexType.BTREE, 1, 2 ),
            SchemaDescriptor.forRelTypeOfType( IndexType.BTREE, 2, 1 ),
            SchemaDescriptor.forRelTypeOfType( IndexType.BTREE, 2, 2 ),
            SchemaDescriptor.forRelTypeOfType( IndexType.BTREE, 1, 1, 1 ),
            SchemaDescriptor.forRelTypeOfType( IndexType.BTREE, 1, 1, 2 ),
            SchemaDescriptor.forRelTypeOfType( IndexType.BTREE, 1, 2, 1 ),
            SchemaDescriptor.forRelTypeOfType( IndexType.BTREE, 1, 2, 2 ),
            SchemaDescriptor.forRelTypeOfType( IndexType.BTREE, 2, 1, 1 ),
            SchemaDescriptor.forRelTypeOfType( IndexType.BTREE, 2, 2, 1 ),
            SchemaDescriptor.forRelTypeOfType( IndexType.BTREE, 2, 1, 2 ),
            SchemaDescriptor.forRelTypeOfType( IndexType.BTREE, 2, 2, 2 ),
    };
