...
public record IndexSettingEntry(IndexSetting setting, Object value, Value storable)
        implements ImmutableMapEntry<IndexSetting, Object>, HasSetting {
    public IndexSettingEntry(IndexSetting setting, Object value) {
        this(setting, value, Values.unsafeOf(value, true));
    }
