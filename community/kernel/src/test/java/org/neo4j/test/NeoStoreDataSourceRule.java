...
public class NeoStoreDataSourceRule extends ExternalResource
{
           ...
           PageCache pageCache, Map<String, String> additionalConfig, KernelHealth kernelHealth )
    {
        ...
        theDs = new NeoStoreDataSource( config, sf,
                StringLogger.DEV_NULL,
                mock( JobScheduler.class ), DevNullLoggingService.DEV_NULL, mock( TokenNameLookup.class ),
                dependencyResolverForNoIndexProvider(), mock( PropertyKeyTokenHolder.class ), mock( LabelTokenHolder.class ),
                mock( RelationshipTypeTokenHolder.class ), locks, mock( SchemaWriteGuard.class ),
                mock( TransactionEventHandlers.class ), IndexingService.NO_MONITOR,
