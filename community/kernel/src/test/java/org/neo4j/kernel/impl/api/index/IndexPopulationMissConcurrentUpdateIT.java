...
public class IndexPopulationMissConcurrentUpdateIT
{
    ...
    /**
     * A very specific {@link SchemaIndexProvider} which can be paused and continued at juuust the right places.
     */
    private static class ControlledSchemaIndexProvider extends KernelExtensionFactory<Supplier>
    {
        ...
        @Override
        public Lifecycle newInstance( KernelContext context, Supplier noDependencies ) throws Throwable
        {
            return new SchemaIndexProvider( new SchemaIndexProvider.Descriptor( "controlled", "1" ),
