...
public class TransactionHookIT extends KernelIntegrationTest
{
    ...
    public void shouldRecieveTxStateOnCommit() throws Exception
    {
        ...
        // Then
        verify( hook ).beforeCommit( any( TransactionHookView.class ), any( KernelTransaction.class ),
                any( StoreReadLayer.class ) );
        verify( hook ).afterCommit( any( TransactionHookView.class ), any( KernelTransaction.class ),
    ...
    public void shouldRollbackOnFailureInBeforeCommit() throws Exception
    {
        ...
        when( hook.beforeCommit( any( TransactionHookView.class ), any( KernelTransaction.class ),
        ...
        verify( hook ).beforeCommit( any( TransactionHookView.class ), any( KernelTransaction.class ),
                any( StoreReadLayer.class ) );
        verify( hook ).afterRollback( any( TransactionHookView.class ), any( KernelTransaction.class ),
                any( TransactionHook.Outcome.class ) );
        verifyNoMoreInteractions( hook );
    }
}
