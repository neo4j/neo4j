...
public class IndexRecoveryIT
{
    ...
    public void shouldBeAbleToRecoverInTheMiddleOfPopulatingAnIndex() throws Exception
    {
        ...
        when( mockedIndexProvider.getPopulator( anyLong(), any( IndexDescriptor.class ), any( IndexConfiguration.class ), any( ValueSampler.class ) ) )
        ...
        verify( mockedIndexProvider, times( 2 ) ).getPopulator( anyLong(), any( IndexDescriptor.class ), any( IndexConfiguration.class ), any( ValueSampler.class ) );
    ...
    public void shouldBeAbleToRecoverAndUpdateOnlineIndex() throws Exception
    {
        ...
        verify( mockedIndexProvider, times( 1 ) )
                .getPopulator( anyLong(), any( IndexDescriptor.class ), any( IndexConfiguration.class ), any( ValueSampler.class ) );
