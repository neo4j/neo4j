...
public class TestReadOnlyNeo4j
{
    ...
    public void testSimple()
    {
        ...
        GraphDatabase readGraphDb = CommunityTestGraphDatabase.buildEphemeral()
    ...
    private DbRepresentation createSomeData()
    {
        ...
        GraphDatabase db = CommunityTestGraphDatabase.buildEphemeral().withFileSystem( fs.get() ).open( PATH );
