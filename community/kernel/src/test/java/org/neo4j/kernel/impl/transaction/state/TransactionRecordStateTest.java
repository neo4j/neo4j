...
public class TransactionRecordStateTest
{
    ...
    public void shouldCreateEqualNodePropertyUpdatesOnRecoveryOfCreatedNode() throws Exception
    {
        ...
        SchemaRule rule = indexRule( ruleId, SchemaDescriptorFactory.forLabel( labelId, propertyKeyId ), PROVIDER_DESCRIPTOR, IndexDescriptor.Type.GENERAL );
    ...
    private class CollectingIndexingUpdateService implements IndexingUpdateService
    {
        ...
        @Override
        public Iterable<IndexEntryUpdate<SchemaDescriptor>> convertToIndexUpdates( EntityUpdates entityUpdates, EntityType relationship )
        {
