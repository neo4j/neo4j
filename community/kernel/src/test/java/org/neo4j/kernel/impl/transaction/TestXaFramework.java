...
//        }
    ...
    public void testCreateXaResource() throws Exception
    {
        ...
        xaDsMgr.registerDataSource( new DummyXaDataSource(
                config, UTF8.encode( "DDDDDD" ), "dummy_datasource", new XaFactory(new Config( StringLogger.DEV_NULL, fileSystem, config), TxIdGenerator.DEFAULT, new PlaceboTm(), new DefaultLogBufferFactory(), fileSystem, StringLogger.DEV_NULL, CommonFactories.defaultRecoveryVerifier())) );
    ...
    public void testTxIdGeneration() throws Exception
    {
        ...
        try
        {
            ...
            config.put( "store_dir", "target/var" );
            FileSystemAbstraction fileSystem = new DefaultFileSystemAbstraction();
            xaDsMgr.registerDataSource(new DummyXaDataSource( config, UTF8.encode( "DDDDDD" ),"dummy_datasource1" , new XaFactory(new Config( StringLogger.DEV_NULL, fileSystem, config), TxIdGenerator.DEFAULT, new PlaceboTm(), new DefaultLogBufferFactory(), fileSystem, StringLogger.DEV_NULL, CommonFactories.defaultRecoveryVerifier())) );
