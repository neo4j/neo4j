...
public class TestPlaceboTransaction
{
    ...
    public void before() throws Exception
    {
        ...
        when( mockTxManager.getTransactionState() ).thenReturn( transactionState );
        placeboTx = new PlaceboTransaction( mockTxManager, lockManager );
    ...
    public void canAcquireReadLock() throws Exception
    {
        ...
        verify( transactionState ).addLockToTransaction( lockManager, resource, LockType.READ );
    }
    ...
    public void canAcquireWriteLock() throws Exception
    {
        ...
        verify( transactionState ).addLockToTransaction( lockManager, resource, LockType.WRITE );
    }
}
