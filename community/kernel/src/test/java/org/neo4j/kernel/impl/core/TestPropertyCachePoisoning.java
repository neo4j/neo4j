 ...
 */
@ForeignBreakpoints( {
        @ForeignBreakpoints.BreakpointDef( type = "org.neo4j.kernel.impl.core.Primitive", method = "setProperties" ),
        @ForeignBreakpoints.BreakpointDef( type = "org.neo4j.kernel.impl.core.Primitive", method = "commitPropertyMaps", on = BreakPoint.Event.EXIT ) } )
