...
public class KernelDiagnosticsTest
{
    ...
    public void shouldPrintDiskUsage()
    {
        ...
        logProvider.rawMessageMatcher().assertContainsMessageContaining( "100 / 40 / 40" );
    }
    ...
    public void shouldCountFileSizeRecursively() throws IOException
    {
        ...
        logProvider.rawMessageMatcher().assertContainsMessageContaining( "Total size of store: 4.00 kB" );
        logProvider.rawMessageMatcher().assertContainsMessageContaining( "Total size of mapped files: 3.00 kB" );
    }
