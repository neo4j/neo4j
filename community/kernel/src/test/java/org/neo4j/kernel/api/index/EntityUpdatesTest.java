...
public class EntityUpdatesTest
{
    ...
    {
        // When
        EntityUpdates updates = EntityUpdates.forEntity( nodeId ).withTokensBefore( label )
    ...
    {
        // When
        EntityUpdates updates = EntityUpdates.forEntity( nodeId ).withTokensBefore( empty ).withTokensAfter( label ).build();
    ...
    public void shouldGenerateUpdatesForLabelAdditionWithExistingProperties()
    {
        ...
        EntityUpdates updates =
                EntityUpdates.forEntity( nodeId ).withTokensBefore( empty ).withTokensAfter( label )
                        .existing( propertyKeyId1, Values.of( "Neo" ) )
                        .existing( propertyKeyId2, Values.of( 100L ) )
                        .existing( propertyKeyId3, Values.pointValue( CoordinateReferenceSystem.WGS84, 12.3, 45.6 ) )
                        .build();
    ...
    public void shouldNotGenerateUpdateForPartialCompositeSchemaIndexUpdate()
    {
        // When
        EntityUpdates updates =
                EntityUpdates.forEntity( nodeId ).withTokensBefore( label ).withTokensAfter( label )
    ...
    {
        // When
        EntityUpdates updates = EntityUpdates.forEntity( nodeId ).withTokensBefore( label ).withTokensAfter( empty ).build();
    ...
    public void shouldGenerateUpdateForLabelRemovalWithExistingProperty()
    {
        // When
        EntityUpdates updates =
                EntityUpdates.forEntity( nodeId ).withTokensBefore( label ).withTokensAfter( empty ).build();
    ...
    {
        // When
        EntityUpdates updates = EntityUpdates.forEntity( nodeId ).withTokensBefore( empty ).withTokensAfter( label )
    ...
    {
        // When
        EntityUpdates updates = EntityUpdates.forEntity( nodeId ).withTokensBefore( label ).withTokensAfter( empty )
                .added( property1.propertyKeyId(), property1.value() )
                .added( property2.propertyKeyId(), property2.value() )
                .added( property3.propertyKeyId(), property3.value() )
                .build();
    ...
    {
        // When
        EntityUpdates updates = EntityUpdates.forEntity( nodeId ).withTokensBefore( label ).build();
    ...
    {
        // When
        EntityUpdates updates = EntityUpdates.forEntity( nodeId ).withTokensBefore( empty )
                .added( property1.propertyKeyId(), property1.value() )
                .build();
    ...
    public void shouldGenerateUpdateWhenAddingOneTokenForNonSchemaIndex()
    {
        // When
        EntityUpdates updates =
                EntityUpdates.forEntity( nodeId ).withTokensBefore( empty ).withTokensAfter( label ).build();
    ...
    public void shouldGenerateUpdateWhenAddingMultipleTokensForNonSchemaIndex()
    {
        // When
        EntityUpdates updates =
                EntityUpdates.forEntity( nodeId ).withTokensBefore( empty ).withTokensAfter( allLabels ).build();
    ...
    public void shouldNotGenerateUpdateWhenAddingAnotherTokenForNonSchemaIndex()
    {
        // When
        EntityUpdates updates =
                EntityUpdates.forEntity( nodeId ).withTokensBefore( label ).withTokensAfter( allLabels ).build();
    ...
    public void shouldNotGenerateUpdateWhenAddingAnotherUselessTokenForNonSchemaIndex()
    {
        // When
        EntityUpdates updates =
                EntityUpdates.forEntity( nodeId ).withTokensBefore( label ).withTokensAfter( labelId1, unusedLabelId ).build();
    ...
    public void shouldGenerateUpdateWhenSwitchingToUselessTokenForNonSchemaIndex()
    {
        // When
        EntityUpdates updates =
                EntityUpdates.forEntity( nodeId ).withTokensBefore( label ).withTokensAfter( unusedLabelId ).build();
    ...
    public void shouldNotGenerateUpdateWhenRemovingOneTokenForNonSchemaIndex()
    {
        // When
        EntityUpdates updates =
                EntityUpdates.forEntity( nodeId ).withTokensBefore( allLabels ).withTokensAfter( label ).build();
    ...
    public void shouldGenerateUpdateAnyEntityTokenIndexWithoutLabels()
    {
        // When
        EntityUpdates updates =
                EntityUpdates.forEntity( nodeId ).withTokensBefore( empty ).withTokensAfter( empty )
                        .added( property1.propertyKeyId(), property1.value() )
                        .build();
    ...
    public void shouldGenerateUpdateAnyEntityTokenIndexWithLabelRemove()
    {
        // When
        EntityUpdates updates =
                EntityUpdates.forEntity( nodeId ).withTokensBefore( label ).withTokensAfter( empty )
                        .added( property1.propertyKeyId(), property1.value() )
                        .build();
