...
class CursorPropertyAccessorTest
{
    ...
    void shouldLookupProperty() throws EntityNotFoundException
    {
        ...
        // when
        Value readValue = accessor.getNodePropertyValue( nodeId, propertyKeyId, NULL_CONTEXT );
    ...
    void shouldReturnNoValueOnMissingProperty() throws EntityNotFoundException
    {
        ...
        // when
        Value readValue = accessor.getNodePropertyValue( nodeId, 0, NULL_CONTEXT );
    ...
    void shouldThrowOnEntityNotFound()
    {
        ...
        // when
        assertThrows( EntityNotFoundException.class, () -> accessor.getNodePropertyValue( nodeId + 1, propertyKeyId, NULL_CONTEXT ) );
    }
}
