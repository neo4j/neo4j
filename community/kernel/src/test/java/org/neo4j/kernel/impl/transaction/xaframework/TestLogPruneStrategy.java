...
//    {
//        int fileCount = 5;
//        MockedLogLoader log = new MockedLogLoader( LogPruneStrategies.nonEmptyFileCount( FS, null, null, null, fileCount ) );
//        for ( int i = 0; i < 100; i++ )
//        {
//            log.addTransactionsUntilRotationHappens();
...
//    {
//        MockedLogLoader log = new MockedLogLoader( LogPruneStrategies.nonEmptyFileCount( FS, null, null, null, 3 ) );
//        
...
//        MockedLogLoader log = new MockedLogLoader( LogPruneStrategies.totalFileSize( FS, null, null, null, maxSize ) );
//        
//        for ( int i = 0; i < 100; i++ )
//        {
//            log.addTransactionsUntilRotationHappens();
...
//    {
//        MockedLogLoader log = new MockedLogLoader( 10000, LogPruneStrategies.transactionCount( FS, null, null, null, 1000 ) );
//        
//        for ( int i = 1; i < 100; i++ )
//        {
//            log.addTransactionsUntilRotationHappens();
...
//        MockedLogLoader log = new MockedLogLoader( LogPruneStrategies.transactionTimeSpan( FS, null, null, null, millisToKeep, MILLISECONDS ) );
//        
...
//    {
//        makeSureOneLogStaysEvenWhenZeroConfigured( new MockedLogLoader( LogPruneStrategies.nonEmptyFileCount( FS, null, null, null, 0 ) ) );
//    }
//
//    @Test
//    public void makeSureOneLogStaysEvenWhenZeroSpaceIsConfigured() throws Exception
//    {
//        makeSureOneLogStaysEvenWhenZeroConfigured( new MockedLogLoader( LogPruneStrategies.totalFileSize( FS, null, null, null, 0 ) ) );
//    }
//    
//    @Test
//    public void makeSureOneLogStaysEvenWhenZeroTransactionsIsConfigured() throws Exception
//    {
//        makeSureOneLogStaysEvenWhenZeroConfigured( new MockedLogLoader( LogPruneStrategies.transactionCount( FS, null, null, null, 0 ) ) );
//    }
//
//    @Test
//    public void makeSureOneLogStaysEvenWhenZeroTimeIsConfigured() throws Exception
//    {
//        makeSureOneLogStaysEvenWhenZeroConfigured( new MockedLogLoader( LogPruneStrategies.transactionTimeSpan( FS, null, null, null, 0, SECONDS ) ) );
//    }
//    
//    private void makeSureOneLogStaysEvenWhenZeroConfigured( MockedLogLoader mockedLogLoader ) throws Exception
//    {
//        MockedLogLoader log = new MockedLogLoader( LogPruneStrategies.nonEmptyFileCount( FS, null, null, null, 0 ) );
//        log.rotate();
