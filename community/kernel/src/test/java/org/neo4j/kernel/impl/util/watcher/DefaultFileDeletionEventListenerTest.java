...
class DefaultFileDeletionEventListenerTest
{
    ...
    {
        DatabaseId databaseId = new TestDatabaseIdRepository().get( "testDatabase" );
        SimpleLogService logService = new SimpleLogService( NullLogProvider.getInstance(), internalLogProvider );
        return new DefaultFileDeletionEventListener( databaseId, asSet( watchedResource ), logService,
