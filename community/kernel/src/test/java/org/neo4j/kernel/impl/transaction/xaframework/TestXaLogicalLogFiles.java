...
public class TestXaLogicalLogFiles {
    ...
    {    
        ...
        when(fs.fileExists("logical_log")).thenReturn(false);
        when(fs.fileExists("logical_log.1")).thenReturn(false);
        when(fs.fileExists("logical_log.2")).thenReturn(true);
