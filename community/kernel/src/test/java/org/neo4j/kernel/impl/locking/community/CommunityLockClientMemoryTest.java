...
class CommunityLockClientMemoryTest
{
    private static final long ONE_LOCK_SIZE_ESTIMATE =
            LockResource.SHALLOW_SIZE + RWLock.SHALLOW_SIZE + RWLock.TxLockElement.SHALLOW_SIZE + HeapEstimator.HASH_MAP_NODE_SHALLOW_SIZE * 2;
    private GlobalMemoryGroupTracker memoryPool;
    private MemoryTracker memoryTracker;
    private CommunityLockManger lockManager;
    ...
    void setUp()
    {
        ...
        lockManager = new CommunityLockManger( Config.defaults(), Clocks.nanoClock() );
    }
...
//        assertThat( memoryTracker.estimatedHeapMemory() ).isEqualTo( 0 );
    ...
    void concurrentMemoryShouldEndUpZero() throws Throwable
    {
        ...
        for ( int i = 0; i < numThreads; i++ )
        {
            ...
            Locks.Client client = lockManager.newClient();
