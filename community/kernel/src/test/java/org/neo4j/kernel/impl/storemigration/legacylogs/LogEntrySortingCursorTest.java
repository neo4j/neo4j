...
public class LogEntrySortingCursorTest
{
    ...
    private final VersionableReadableClosablePositionAwareChannel channel = mock( VersionableReadableClosablePositionAwareChannel.class );
    @SuppressWarnings("unchecked")
    private final LogEntryReader<VersionableReadableClosablePositionAwareChannel> reader = mock( LogEntryReader.class );
