...
public class TestKernelPanic
{
    ...
    private ReadableByteChannel simpleTransaction() throws IOException
    {
        ...
        writer.start( -1, -1, 0 );
        writer.add( new NodeRecord( 0, false, Record.NO_NEXT_RELATIONSHIP.intValue(), Record.NO_NEXT_PROPERTY.intValue() ),
                new NodeRecord( 0, false, Record.NO_NEXT_RELATIONSHIP.intValue(), Record.NO_NEXT_PROPERTY.intValue() ) );
