...
{
    @Override
    NativeSchemaIndexPopulator<StringSchemaKey,NativeSchemaValue> createPopulator(
    ...
    {
        return new StringSchemaIndexPopulator( pageCache, fs, indexFile, layout, monitor,
