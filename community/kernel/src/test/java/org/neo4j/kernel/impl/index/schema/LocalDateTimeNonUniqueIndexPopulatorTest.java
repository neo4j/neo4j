...
public class LocalDateTimeNonUniqueIndexPopulatorTest extends NativeNonUniqueIndexPopulatorTest<LocalDateTimeIndexKey,NativeIndexValue>
{
    @Override
    NativeIndexPopulator<LocalDateTimeIndexKey,NativeIndexValue> createPopulator()
    {
