...
public class WriteTransactionCommandOrderingTest
{
    ...
    private static class RecordingNodeStore extends NodeStore
    {
        ...
        {
            super( null, Config.empty(), null, null, NullLogProvider.getInstance(), null, StandardV3_0_7.RECORD_FORMATS );
            this.currentRecording = currentRecording;
        }
    ...
    private static class RecordingRelationshipStore extends RelationshipStore
    {
        ...
        {
            super( null, Config.empty(), null, null, NullLogProvider.getInstance(), StandardV3_0_7.RECORD_FORMATS );
            this.currentRecording = currentRecording;
        }
