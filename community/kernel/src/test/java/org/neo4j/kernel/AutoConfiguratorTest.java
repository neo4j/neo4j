...
public class AutoConfiguratorTest
{
    ...
    public void shouldProvideDefaultAssignmentsForHugeFiles() throws Exception
    {
        ...
        AutoConfigurator autoConf = new AutoConfigurator( fs, storeDir.getPath(), true, physicalMemory * MiB, vmMemory * MiB );
    ...
    public void shouldProvideDefaultAssignmentsForHugeFilesWhenMemoryMappingIsNotUsed() throws Exception
    {
        ...
        AutoConfigurator autoConf = new AutoConfigurator( fs, storeDir.getPath(), false, 10000 * GiB, 2 * availableMem * MiB );
    ...
    {
        when( fs.getFileSize( new File( storeDir, "neostore." + file ).getPath() ) ).thenReturn( size );
    }
}
