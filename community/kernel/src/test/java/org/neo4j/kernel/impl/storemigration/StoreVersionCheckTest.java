...
public class StoreVersionCheckTest
{
    ...
    public void shouldReportFileWithIncorrectVersion() throws IOException
    {
        ...
        // then
        assertFalse( storeVersionCheck.hasVersion( shortFile, "correctVersion" ).first().isSuccessful() );
    }
    ...
    public void shouldReportFileWithCorrectVersion() throws IOException
    {
        ...
        // then
        assertTrue( storeVersionCheck.hasVersion( shortFile, "correctVersion" ).first().isSuccessful() );
    }
