...
public class SpatialIndexSettingsTest
{
    ...
    {
        return new SpatialIndexProvider( pageCache, fs, directoriesByProvider( directory.storeDir() ), monitor, immediate(), false, config );
    }
    ...
    {
        return new File( new File( new File( directory.storeDir(), "schema" ), "index" ), "spatial-1.0" );
    }
