...
public class TestPath extends TraversalTestBase
{
    ...
    public void testPathIterator()
    {
        ...
        {
            assertPathIsCorrect( resourceIterator.next() );
        }
    }
    ...
    public void reverseNodes() throws Exception
    {
        ...
        assertContains( getFirstPath( traverse ).reverseNodes(), a );

        Traverser traverse2 = getGraphDb().traversalDescription().evaluator( atDepth( 4 ) ).traverse( a );
        assertContainsInOrder( getFirstPath( traverse2 ).reverseNodes(), e, d, c, b, a );
    }
