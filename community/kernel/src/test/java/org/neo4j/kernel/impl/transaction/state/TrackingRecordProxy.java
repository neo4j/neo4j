...
class TrackingRecordProxy<RECORD, ADDITIONAL> implements RecordProxy<RECORD, ADDITIONAL>
{
    ...
    TrackingRecordProxy( RecordProxy<RECORD,ADDITIONAL> delegate, boolean created, Tracker tracker )
    {
