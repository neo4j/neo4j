...
class GenericNativeUniqueIndexPopulatorTest<KEY extends NativeIndexKey<KEY>, VALUE extends NativeIndexValue> extends NativeUniqueIndexPopulatorTest<KEY, VALUE>
{
    GenericNativeUniqueIndexPopulatorTest()
    {
        super( (PopulatorFactory<KEY, VALUE>) genericPopulatorFactory(), ValueType.values(),
