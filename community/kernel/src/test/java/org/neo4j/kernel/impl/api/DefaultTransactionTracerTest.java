...
public class DefaultTransactionTracerTest
{
    ...
    public void shouldComputeStartEndAndTotalTimeForLogRotation() throws Throwable
    {
        ...
        assertEquals( 10, tracer.lastLogRotationStartTime() );
        assertEquals( 30, tracer.lastLogRotationEndTime() );
        assertEquals( 20, tracer.lastLogRotationTotalTime() );
    }
    ...
    {
        DefaultTransactionTracer tracer = new DefaultTransactionTracer( clock );
        assertEquals( -1, tracer.lastLogRotationStartTime() );
        assertEquals( -1, tracer.lastLogRotationEndTime() );
        assertEquals( -1, tracer.lastLogRotationTotalTime() );
    }
}
