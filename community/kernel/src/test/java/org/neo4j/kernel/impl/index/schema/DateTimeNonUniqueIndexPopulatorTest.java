...
public class DateTimeNonUniqueIndexPopulatorTest extends NativeNonUniqueIndexPopulatorTest<ZonedDateTimeIndexKey,NativeIndexValue>
{
    @Override
    NativeIndexPopulator<ZonedDateTimeIndexKey,NativeIndexValue> createPopulator( IndexSamplingConfig samplingConfig )
    {
