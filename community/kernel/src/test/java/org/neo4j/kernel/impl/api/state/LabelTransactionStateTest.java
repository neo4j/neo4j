...
import org.neo4j.kernel.impl.api.StatementContextTestHelper;
...
public class LabelTransactionStateTest
{
    ...
    public void before() throws Exception
    {
        ...
        state = StatementContextTestHelper.mockedState( txState );
        txContext = new StateHandlingStatementContext( store, store, mock( AuxiliaryStoreOperations.class ),
