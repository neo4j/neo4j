...
public class LabelRecoveryTest
{
    ...
    {
        // GIVEN
        database = CommunityTestGraphDatabase.buildEphemeral().withFileSystem( fs ).open();
        Node node;
        ...
        database.shutdown();
        database = CommunityTestGraphDatabase.buildEphemeral().withFileSystem( snapshot ).open();
