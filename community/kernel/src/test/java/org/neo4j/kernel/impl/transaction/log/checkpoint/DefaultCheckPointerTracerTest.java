...
public class DefaultCheckPointerTracerTest
{
    ...
    public void shouldComputeStartEndAndTotalTime() throws Throwable
    {
        ...
        assertEquals( 10, tracer.lastCheckPointStartTimeMillis() );
        assertEquals( 30, tracer.lastCheckPointEndTimeMillis() );
        assertEquals( 20, tracer.lastCheckPointTotalTimeMillis() );
    }
    ...
    {
        DefaultCheckPointerTracer tracer = new DefaultCheckPointerTracer( clock );
        assertEquals( 0, tracer.lastCheckPointStartTimeMillis() );
        assertEquals( 0, tracer.lastCheckPointEndTimeMillis() );
        assertEquals( 0, tracer.lastCheckPointTotalTimeMillis() );
    }
}
