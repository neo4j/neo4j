    ...
    public void shouldListCorrectBuiltinProcedures() throws Throwable
    {
        ...
        assertThat( call( "dbms.procedures" ), containsInAnyOrder(
                ...
                record( "db.relationshipManualIndexSearch",
                        "db.relationshipManualIndexSearch(indexName :: STRING?, query :: ANY?) :: (relationship :: RELATIONSHIP?, weight :: FLOAT?)",
                ...
                record( "db.relationshipAutoIndexSearch",
                ...
                record( "db.relationshipManualIndexAdd",
                ...
                record( "db.nodeManualIndexRemove",
                ...
                record( "db.relationshipManualIndexRemove",
