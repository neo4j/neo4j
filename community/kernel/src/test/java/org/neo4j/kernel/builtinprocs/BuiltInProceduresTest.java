...
public class BuiltInProceduresTest
{
    ...
    public void shouldListCorrectBuiltinProcedures() throws Throwable
    {
        ...
        assertThat( call( "dbms.procedures" ), containsInAnyOrder(
                ...
                record( "db.nodeLegacyIndexSearch",
                ...
                record( "db.nodeLegacyIndexSeek",
                        "db.nodeLegacyIndexSeek(indexName :: STRING?, key :: STRING?, value :: ANY?) :: (node :: NODE?)",
                        "Get node from legacy index. Replaces `START n=node:nodes(key = 'A')`"),
                record( "db.relationshipLegacyIndexSearch",
                        "db.relationshipLegacyIndexSearch(indexName :: STRING?, query :: ANY?) :: (relationship :: RELATIONSHIP?)",
                        "Search relationship from legacy index. Replaces `START r=relationship:relIndex('key:foo*')`"),
                record( "db.relationshipLegacyIndexSeek",
