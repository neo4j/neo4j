...
public class KernelIT extends KernelIntegrationTest
{
    ...
    public void shouldKillTransactionsOnShutdown() throws Throwable
    {
        ...
        // Then
        try ( KernelTransaction tx = kernel.newTransaction( KernelTransaction.Type.implicit, READ ) )
        {
            ((Kernel)kernel).stop();
    ...
    public void txReturnsCorrectIdWhenCommitted() throws Exception
    {
        ...
        KernelTransaction tx = kernel.newTransaction( KernelTransaction.Type.implicit, FULL );
