...
public interface Notification
{
     ...
     */
    NotificationSeverityLevel getSeverity();
     ...
     * that case return {@link InputPosition#empty}
     *
     * @return the position in the query where the issue was found, or
     * {@link InputPosition#empty} if no position is associated with this notification.
     */
