...
import static org.neo4j.kernel.impl.store.AbstractDynamicStore.RECORD_HEADER_SIZE;
...
{
    private final int dataSize = parseInt( string_block_size.getDefaultValue() ) - RECORD_HEADER_SIZE;
