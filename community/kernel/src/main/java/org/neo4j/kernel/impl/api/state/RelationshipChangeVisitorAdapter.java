 ...
 *
 * By invoking a constructor that takes a {@linkplain TransactionHookView transaction state} parameter, the default
...
public abstract class RelationshipChangeVisitorAdapter implements DiffSetsVisitor<Long>
{
     ...
     */
    public RelationshipChangeVisitorAdapter( TransactionHookView txState )
    {
    ...
    DetailVisitor added( final TransactionHookView txState )
    {
