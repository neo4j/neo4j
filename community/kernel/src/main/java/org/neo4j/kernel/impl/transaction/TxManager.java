...
//        }
    ...
    public void begin( ForceMode forceMode ) throws NotSupportedException, SystemException
    {
        ...
        tx = new TransactionImpl( this, forceMode, stateFactory.create(), period.currentEpoch() );
        txThreadMap.set( tx );
            ...
            HeuristicRollbackException, IllegalStateException, SystemException
    {
        ...
        {
            throw logAndReturn( "TM error tx commit", new IllegalStateException( "Transaction " + tx + " started in a previous epoch" ) );
        }
