...
import static org.neo4j.kernel.impl.index.schema.GeometryType2.dimensions;
import static org.neo4j.kernel.impl.index.schema.GeometryType2.putCrs;
import static org.neo4j.kernel.impl.index.schema.GeometryType2.putPoint;
import static org.neo4j.kernel.impl.index.schema.GeometryType2.readCrs;
 ...
 */
class GeometryArrayType2 extends AbstractArrayType<PointValue>
{
    // Affected key state:
    ...
    {
        super( ValueGroup.GEOMETRY_ARRAY, typeId, ( o1, o2, i ) -> GeometryType2.compare(
                o1.long0, o1.long1, o1.long2, o1.long0Array, (int) o1.long2 * i,
                o2.long0, o2.long1, o2.long2, o2.long0Array, (int) o2.long2 * i ),
    ...
    {
        readCrs( cursor, into );
        return readArray( cursor, ValueWriter.ArrayType.POINT, GeometryArrayType2::readGeometryArrayItem, into );
    }

    @Override
    String toString( GenericKey<?> state )
    {
        return format( "GeometryArray2[tableId:%d, code:%d, value:%s]",
