...
public class DataSourceManager implements Lifecycle
{
    ...
    {
        void registered( NeoStoreXaDataSource dataSource );

        void unregistered( NeoStoreXaDataSource dataSource );
    }
    ...
    public void register( final NeoStoreXaDataSource dataSource )
    {
    ...
    public void unregister( final NeoStoreXaDataSource dataSource )
    {
