...
public class SpatialAllEntriesReader<KEY extends SpatialSchemaKey, VALUE extends SpatialSchemaValue> implements BoundedIterable<Long>
{
    private final GBPTree<KEY,VALUE> tree;
    private final Layout<KEY,VALUE> layout;
    private RawCursor<Hit<KEY,VALUE>,IOException> seeker;

    SpatialAllEntriesReader( GBPTree<KEY,VALUE> tree, Layout<KEY,VALUE> layout )
    {
        this.tree = tree;
        this.layout = layout;
    }
