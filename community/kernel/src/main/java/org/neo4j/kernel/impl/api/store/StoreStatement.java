...
public class StoreStatement implements StorageStatement
{
    ...
    private final InstanceCache<SingleRelationshipCursor> singleRelationshipCursor;
    private final InstanceCache<IteratorRelationshipCursor> iteratorRelationshipCursor;
    private final InstanceCache<NodeRelationshipCursor> nodeRelationshipsCursor;
    private final InstanceCache<PropertyCursor> propertyCursorCache;
    private final InstanceCache<SinglePropertyCursor> singlePropertyCursorCache;
            ...
            Supplier<LabelScanReader> labelScanReaderSupplier, LockService lockService )
    {
        ...
        singleRelationshipCursor = new InstanceCache<SingleRelationshipCursor>()
        {
            @Override
            protected SingleRelationshipCursor create()
            {
                return new SingleRelationshipCursor( neoStores.getRelationshipStore(), this, lockService );
            }
        };
        iteratorRelationshipCursor = new InstanceCache<IteratorRelationshipCursor>()
        {
            @Override
            protected IteratorRelationshipCursor create()
            {
                return new IteratorRelationshipCursor( neoStores.getRelationshipStore(), this, lockService );
            }
        };
        nodeRelationshipsCursor = new InstanceCache<NodeRelationshipCursor>()
        {
            @Override
            protected NodeRelationshipCursor create()
            {
                return new NodeRelationshipCursor( neoStores.getRelationshipStore(),
                        neoStores.getRelationshipGroupStore(), this, lockService );
            }
        };
        propertyCursorCache = new InstanceCache<PropertyCursor>()
        {
            @Override
            protected PropertyCursor create()
            {
                return new PropertyCursor( neoStores.getPropertyStore(), this );
            }
        };
        singlePropertyCursorCache = new InstanceCache<SinglePropertyCursor>()
        {
            @Override
            protected SinglePropertyCursor create()
            {
                return new SinglePropertyCursor( neoStores.getPropertyStore(), this );
            }
        };
