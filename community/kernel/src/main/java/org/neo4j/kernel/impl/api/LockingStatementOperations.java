        ...
        LockOperations
{
    ...
    {
        state.locks().explicit().acquireExclusive( state.lockTracer(), resourceType, resourceId );
        state.assertOpen();
    }
    ...
    {
        state.locks().explicit().acquireShared( state.lockTracer(), resourceType, resourceId );
        state.assertOpen();
    }
