...
public abstract class CacheProvider extends Service
{
    ...
    public abstract Cache<NodeImpl> newNodeCache( StringLogger logger, Map<Object, Object> config );

    public abstract Cache<RelationshipImpl> newRelationshipCache( StringLogger logger, Map<Object, Object> config );
