...
{
    NumberSchemaIndexPopulator( PageCache pageCache, FileSystemAbstraction fs, File storeFile, Layout<NumberSchemaKey,NativeSchemaValue> layout, IndexProvider.Monitor monitor, IndexDescriptor descriptor,
