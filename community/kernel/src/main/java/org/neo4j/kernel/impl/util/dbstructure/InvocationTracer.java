...
public class InvocationTracer<C> implements InvocationHandler
{
    ...
    private void printPreamble( StringBuilder builder )
    {
        ...
        println( builder, "import org.neo4j.kernel.impl.util.dbstructure.Visitable;");
        println( builder );
        println( builder, "//" );
        ...
        println( builder, "//" );
        println( builder );
        println( builder, "public enum %s implements Visitable<%s>", generatedClassName, interfaceClassName );
        println( builder, "{" );
