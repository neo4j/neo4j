 ...
 */
class SpatialFullScanNonUniqueIndexSampler<KEY extends SpatialSchemaKey, VALUE extends SpatialSchemaValue>
        extends NonUniqueIndexSampler.Adapter
{
    ...
    SpatialFullScanNonUniqueIndexSampler( GBPTree<KEY,VALUE> gbpTree, Layout<KEY,VALUE> layout, IndexSamplingConfig samplingConfig )
    {
