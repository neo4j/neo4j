...
public interface IndexUpdateProcessor<INDEX_KEY extends LabelSchemaDescriptor>
{
    void accept( IndexEntryUpdate<INDEX_KEY> update ) throws IOException, IndexEntryConflictException;

    static <INDEX_KEY extends LabelSchemaDescriptor> void applyIndexUpdatesByMode( Iterable<IndexEntryUpdate<INDEX_KEY>> updates,
    ...
    static <INDEX_KEY extends LabelSchemaDescriptor> IndexEntryUpdate<INDEX_KEY> additionOfChange( IndexEntryUpdate<INDEX_KEY> indexUpdate )
    {
        return IndexEntryUpdate.add( indexUpdate.getEntityId(), indexUpdate.indexKey(), indexUpdate.values() );
    }

    static <INDEX_KEY extends LabelSchemaDescriptor> IndexEntryUpdate<INDEX_KEY> removalOfChange( IndexEntryUpdate<INDEX_KEY> indexUpdate )
    {
