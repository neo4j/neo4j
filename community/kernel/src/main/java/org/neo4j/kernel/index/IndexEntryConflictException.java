...
public abstract class IndexEntryConflictException extends KernelException
{
    public IndexEntryConflictException( String message )
    {
        super( Status.Schema.ConstraintViolation, message );
    }
    ...
    /**
     * Use this method in cases where {@link org.neo4j.kernel.index.IndexEntryConflictException} was caught but it should not have been
