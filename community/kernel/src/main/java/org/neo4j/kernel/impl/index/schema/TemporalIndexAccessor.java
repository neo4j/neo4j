...
class TemporalIndexAccessor extends NativeSchemaIndexAccessor<TemporalSchemaKey,NativeSchemaValue>
{
    TemporalIndexAccessor( PageCache pageCache, FileSystemAbstraction fs, File storeFile, Layout<TemporalSchemaKey,NativeSchemaValue> layout,
