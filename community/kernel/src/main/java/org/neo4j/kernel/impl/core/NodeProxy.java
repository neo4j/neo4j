...
class NodeProxy implements Node
{
    ...
    public void delete()
    {
        nm.getNodeForProxy( this, LockType.WRITE ).delete( nm );
    }
    ...
    {
        nm.getNodeForProxy( this, LockType.WRITE ).setProperty( nm, key, value );
    }

    public Object removeProperty( String key ) throws NotFoundException
    {
        return nm.getNodeForProxy( this, LockType.WRITE ).removeProperty( nm, key );
    }
    ...
    {
        return nm.getNodeForProxy( this, LockType.WRITE ).createRelationshipTo( nm, otherNode, type );
    }
