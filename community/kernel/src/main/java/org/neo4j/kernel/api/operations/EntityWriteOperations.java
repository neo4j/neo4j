...
public interface EntityWriteOperations
{
    ...
    Property nodeSetProperty( KernelStatement state, long nodeId, SafeProperty property )
            throws EntityNotFoundException, ConstraintValidationKernelException;

    Property relationshipSetProperty( KernelStatement state, long relationshipId, SafeProperty property )
            throws EntityNotFoundException;
    
    Property graphSetProperty( KernelStatement state, SafeProperty property );
