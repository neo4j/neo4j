...
class CachingLegacyIndexTxState implements LegacyIndexTxState
{
    private Map<String,LegacyIndex> nodeLegacyIndexChanges;
    private Map<String,LegacyIndex> relationshipLegacyIndexChanges;
    private final LegacyIndexTxState txState;

    CachingLegacyIndexTxState( LegacyIndexTxState txState )
    {
