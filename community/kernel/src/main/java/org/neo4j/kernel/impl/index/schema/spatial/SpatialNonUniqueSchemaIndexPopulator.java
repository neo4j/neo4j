...
/**
 * {@link SpatialSchemaIndexPopulator} which can accept duplicate values (for different entity ids).
 */
class SpatialNonUniqueSchemaIndexPopulator<KEY extends SpatialSchemaKey, VALUE extends SpatialSchemaValue>
        extends SpatialSchemaIndexPopulator<KEY,VALUE>
{
    private NonUniqueIndexSampler sampler;

    SpatialNonUniqueSchemaIndexPopulator( PageCache pageCache, FileSystemAbstraction fs, File storeFile, Layout<KEY,VALUE> layout,
