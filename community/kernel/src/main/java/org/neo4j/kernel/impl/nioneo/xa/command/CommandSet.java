...
{
    private final Map<Long, org.neo4j.kernel.impl.nioneo.xa.command.Command.NodeCommand> nodeCommands = new TreeMap<>();
    private final ArrayList<org.neo4j.kernel.impl.nioneo.xa.command.Command.PropertyCommand> propCommands = new ArrayList<>();
    private final ArrayList<org.neo4j.kernel.impl.nioneo.xa.command.Command.RelationshipCommand> relCommands = new ArrayList<>();
    private final ArrayList<org.neo4j.kernel.impl.nioneo.xa.command.Command.SchemaRuleCommand> schemaRuleCommands = new ArrayList<>();
    private final ArrayList<org.neo4j.kernel.impl.nioneo.xa.command.Command.RelationshipGroupCommand> relGroupCommands = new ArrayList<>();
    private final ArrayList<org.neo4j.kernel.impl.nioneo.xa.command.Command.RelationshipTypeTokenCommand> relationshipTypeTokenCommands = new ArrayList<>();
    private final ArrayList<org.neo4j.kernel.impl.nioneo.xa.command.Command.LabelTokenCommand> labelTokenCommands = new ArrayList<>();
    private final ArrayList<org.neo4j.kernel.impl.nioneo.xa.command.Command.PropertyKeyTokenCommand> propertyKeyTokenCommands = new ArrayList<>();
    private final org.neo4j.kernel.impl.nioneo.xa.command.Command.NeoStoreCommand neoStoreCommand = new Command.NeoStoreCommand();
