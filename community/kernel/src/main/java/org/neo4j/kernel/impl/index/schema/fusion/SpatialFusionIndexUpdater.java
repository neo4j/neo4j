...
class SpatialFusionIndexUpdater implements IndexUpdater
{
    ...
    static SpatialFusionIndexUpdater updaterForAccessor( Map<CoordinateReferenceSystem,SpatialCRSSchemaIndex> indexMap,
                                                         long indexId, SpatialCRSSchemaIndex.Supplier indexFactory,
                                                         SchemaIndexDescriptor descriptor )
    {
        return new SpatialFusionIndexUpdater( indexMap, indexId, indexFactory, descriptor, false );
    }

    static SpatialFusionIndexUpdater updaterForPopulator( Map<CoordinateReferenceSystem,SpatialCRSSchemaIndex> indexMap,
                                                          long indexId, SpatialCRSSchemaIndex.Supplier indexFactory,
                                                          SchemaIndexDescriptor descriptor )
    {
