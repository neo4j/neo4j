...
/**
 * Value in a {@link GBPTree} handling geometries suitable for schema indexing.
 *
 * NOTE:  For the time being no data exists in {@link SpatialSchemaValue}, but since the layout is under development
 ...
 */
class SpatialSchemaValue
{
    static final int SIZE = 0;

    static final SpatialSchemaValue INSTANCE = new SpatialSchemaValue();
