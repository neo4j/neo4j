 ...
 */
class StoreSinglePropertyCursor extends StorePropertyCursor
{
    ...
    StoreSinglePropertyCursor init( long firstPropertyId, int propertyKeyId, Lock lock, AssertOpen assertOpen )
    {
