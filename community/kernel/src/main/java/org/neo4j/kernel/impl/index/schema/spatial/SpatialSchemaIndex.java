...
class SpatialSchemaIndex<KEY extends SpatialSchemaKey, VALUE extends SpatialSchemaValue>
{
    ...
    SpatialSchemaIndex( PageCache pageCache, FileSystemAbstraction fs, File storeFile, Layout<KEY,VALUE> layout,
