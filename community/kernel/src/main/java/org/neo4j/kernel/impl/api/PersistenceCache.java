...
public class PersistenceCache
{
    ...
    public Iterator<SafeProperty> nodeGetProperties( KernelStatement state, long nodeId,
    ...
    public Iterator<SafeProperty> relationshipGetProperties( KernelStatement state, long relationshipId,
    ...
    public Iterator<SafeProperty> graphGetProperties( KernelStatement state, CacheLoader<Iterator<SafeProperty>> cacheLoader )
    {
    ...
    public Property graphGetProperty( KernelStatement state, CacheLoader<Iterator<SafeProperty>> cacheLoader,
            long propertyKeyId )
    {
