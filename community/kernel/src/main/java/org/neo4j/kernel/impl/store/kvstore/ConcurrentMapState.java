...
class ConcurrentMapState<Key> extends ActiveState<Key>
{
    ...
    static <Key> void applyUpdate( ReadableState<Key> store, ConcurrentMap<Key,ChangeEntry> changes, Key key, ValueUpdate
            update, boolean reset, long version ) throws IOException
    {
