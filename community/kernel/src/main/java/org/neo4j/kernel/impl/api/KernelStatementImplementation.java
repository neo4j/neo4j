 ...
 *
 * <ol>
 * <li>Construct {@link KernelStatementImplementation} when {@link KernelTransactionImplementation} is constructed</li>
...
public class KernelStatementImplementation implements KernelStatement
{
    ...
    @Override
    public final void startQueryExecution( ExecutingQuery query )
    {
    ...
    @Override
    public void assertAllowsTokenCreates()
    {
        assertAllows( AccessMode::allowsTokenCreates, "Token create" );
    }
