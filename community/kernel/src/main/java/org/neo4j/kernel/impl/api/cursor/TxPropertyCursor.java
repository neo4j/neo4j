...
public class TxPropertyCursor implements PropertyCursor
{
    ...
    private InstanceCache<TxPropertyCursor> instanceCache;
    private PropertyCursor cursor;

    public TxPropertyCursor( KernelStatement statement, InstanceCache<TxPropertyCursor> instanceCache )
    {
        this.statement = statement;
        this.instanceCache = instanceCache;
    }

    public TxPropertyCursor init( PropertyCursor cursor)
    {
        this.cursor = cursor;
        return this;
    }
