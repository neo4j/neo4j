...
public class SpatialHitIndexProgressor<KEY extends SpatialSchemaKey, VALUE extends SpatialSchemaValue> implements IndexProgressor
{
    ...
    public SpatialHitIndexProgressor( RawCursor<Hit<KEY,VALUE>,IOException> seeker, NodeValueClient client,
