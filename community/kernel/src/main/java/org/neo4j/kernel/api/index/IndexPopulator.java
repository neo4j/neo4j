...
public interface IndexPopulator
{
     ...
     * should be stored and made available for later requests from {@link IndexProvider#getPopulationFailure(long)}.
     * @throws IOException on I/O error.
     */
     ...
     * {@link IndexProvider#getPopulationFailure(long)}. Called before {@link #close(boolean)}
