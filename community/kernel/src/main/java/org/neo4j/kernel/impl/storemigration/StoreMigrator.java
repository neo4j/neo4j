...
public class StoreMigrator extends StoreMigrationParticipant.Adapter
{
    ...
    public StoreMigrator( Monitors monitors, MigrationProgressMonitor progressMonitor,
                          FileSystemAbstraction fileSystem )
    {
        this( monitors, progressMonitor, new UpgradableDatabase( new StoreVersionCheck( fileSystem ) ),
    ...
    {
        final File storeDir = new File( migrationDir, NeoStore.DEFAULT_NAME );
        return new StoreFactory( StoreFactory.configForStoreDir( config, storeDir ),
                new DefaultIdGeneratorFactory(),
                resolve.resolveDependency( PageCache.class ),
                fileSystem,
