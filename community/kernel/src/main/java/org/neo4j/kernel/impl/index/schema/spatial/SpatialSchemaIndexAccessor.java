...
public class SpatialSchemaIndexAccessor<KEY extends SpatialSchemaKey, VALUE extends SpatialSchemaValue>
        extends SpatialSchemaIndex<KEY,VALUE> implements IndexAccessor
{
    private final SpatialSchemaIndexUpdater<KEY,VALUE> singleUpdater;
    private final IndexSamplingConfig samplingConfig;

    SpatialSchemaIndexAccessor(
            PageCache pageCache,
            ...
            IndexSamplingConfig samplingConfig ) throws IOException
    {
        ...
        singleUpdater = new SpatialSchemaIndexUpdater<>( layout.newKey(), layout.newValue() );
    ...
    {
        assertOpen();
        return new SpatialSchemaIndexReader<>( tree, layout, samplingConfig, descriptor.schema().getPropertyIds() );
    }

    @Override
    public BoundedIterable<Long> newAllEntriesReader()
    {
        return new SpatialAllEntriesReader<>( tree, layout );
    }
