...
public class DefaultTimeZoneIdCreator extends IsolatedTransactionTokenCreator
{
    public DefaultTimeZoneIdCreator( Supplier<InwardKernel> kernelSupplier, IdGeneratorFactory idGeneratorFactory )
    {
