...
class NativeLabelScanWriter implements LabelScanWriter
{
    ...
    private final Modifier<LabelScanKey,LabelScanValue> inserter;
    ...
    NativeLabelScanWriter( Modifier<LabelScanKey,LabelScanValue> inserter, int rangeSize, int batchSize )
    {
