...
{
    StringSchemaIndexPopulator( PageCache pageCache, FileSystemAbstraction fs, File storeFile, Layout<StringSchemaKey,NativeSchemaValue> layout, IndexProvider.Monitor monitor, IndexDescriptor descriptor,
