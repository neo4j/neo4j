...
public class TestApps extends AbstractShellTest
{
    ...
    @Test
    public void canExecuteCypherAndSetResultsAsShellVariables() throws Exception
    {
        executeCommand( "start n=node(0) return 42 as foo;", "42", "foo" );
        executeCommand( "start n=node(0) return {foo} as bar;", "42", "bar" );
    }
    ...
    public void canDumpSubgraphWithCypher() throws Exception
    {
        ...
        executeCommand( "dump -s start n=node(0) match n-[r]->m return n,r,m;",
                "begin",
    ...
    @Test
    public void canDumpGraphForShellImport() throws Exception
    {
        final DynamicRelationshipType type = DynamicRelationshipType.withName( "KNOWS" );
        final Relationship rel = createRelationshipChain( db.getReferenceNode(), type, 1 )[0];
        ...
        executeCommand( "dump ",
                "begin",
                "export _props=\\{\"f o o\":\"bar\"\\}",
                "create _n=\\{_props\\} return _n;",
                "export _0=_n",
                "export _1=_n",
                "export _props=\\{\"flags\":\\[true,false,true\\]\\}",
                "create _n=\\{_props\\} return _n;",
                "export _n=_0 && export _m=_1",
                "export _props=\\{\"since\":2010\\}",
                "start n=node\\(\\{_n\\}\\), m=node\\(\\{_m\\}\\) create n-\\[:`KNOWS` \\{_props\\}\\]->m;",
                "export _0=null",
                "export _1=null",
                "export _n=null && export _m=null && export _props=null",
                "commit"
        );
    }

    @Test
    public void canDumpSubgraphWithCypherForShellImport() throws Exception
    {
        final DynamicRelationshipType type = DynamicRelationshipType.withName( "KNOWS" );
        createRelationshipChain( db.getReferenceNode(), type, 1 );
        executeCommand( "dump start n=node(0) match n-[r]->m return n,r,m;",
                ...
                "export _1=_n",
                "export _n=_0 && export _m=_1",
                "start n=node\\(\\{_n\\}\\), m=node\\(\\{_m\\}\\) create n-\\[:`KNOWS` \\]->m",
                "export _0=null",
                "export _1=null",
                "export _n=null && export _m=null && export _props=null",
                "commit" );
