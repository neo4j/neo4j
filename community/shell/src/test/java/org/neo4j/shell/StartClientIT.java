...
public class StartClientIT extends AbstractShellIT
{
    ...
    public void testShellCloseAfterCommandExecution() throws Exception
    {
        ...
        // when
        startClient.start( new String[]{"-path", getDatabaseAbsolutePath(), "-c", "CREATE (n {foo:'bar'});"},
                ctrlCHandler );
    ...
    public void shouldReportEditionThroughDbInfoApp()
    {
        ...
        // when
        client.start( new String[]{"-path", getDatabaseAbsolutePath() + "testDb", "-c",
    ...
    public void shouldNotStartBolt() throws IOException
    {
        ...
        }.start( new String[]{"-c", "RETURN 1;", "-path", getDatabaseAbsolutePath() + "test-db", "-config",
    ...
    {
        return db.databaseLayout().databaseDirectory().getAbsolutePath();
    }
