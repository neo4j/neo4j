...
use the +cypher VERSION+ prefix to select a certain cypher compiler.
...
* +cypher 1.8 start n = node(0) return n;+ will execute the query with the Cypher compiler version 2.0
