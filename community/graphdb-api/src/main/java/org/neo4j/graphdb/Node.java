...
public interface Node extends PropertyContainer
{
    ...
    /**
     * Determines whether the node has been deleted in the current transaction.
     *
     * @return true if the node has been deleted in the current transaction, otherwise false.
     */
    boolean isDeleted();
}
