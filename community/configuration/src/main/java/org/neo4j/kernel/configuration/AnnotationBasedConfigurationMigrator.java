...
{
    private final ArrayList<ConfigurationMigrator> migrators = new ArrayList<>();
    private final AnnotatedFieldHarvester fieldHarvester = new AnnotatedFieldHarvester();

    public AnnotationBasedConfigurationMigrator( Iterable<Class<?>> settingsClasses )
    {
        for ( Class<?> settingsClass : settingsClasses )
        {
            for ( Pair<Field,ConfigurationMigrator> field : fieldHarvester.findStatic( settingsClass,
