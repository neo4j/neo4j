...
public class GraphDatabaseInternalSettings implements SettingsDeclaration
{
    ...
    public static final Setting<List<IPAddressString>> cypher_ip_blocklist =
            newBuilder( "internal.dbms.cypher_ip_blocklist", listOf( CIDR_IP ), List.of() ).build();

    @Internal
    @Description( "Path of the databases directory" )
    public static final Setting<Path> databases_root_path =
            newBuilder( "internal.dbms.directories.databases.root", PATH, Path.of( GraphDatabaseSettings.DEFAULT_DATABASES_ROOT_DIR_NAME ) )
    ...
    public static final Setting<Boolean> ephemeral_lucene = newBuilder( "internal.dbms.lucene.ephemeral", BOOL, false ).build();
    ...
    public static final Setting<Integer> lucene_max_partition_size = newBuilder( "internal.dbms.lucene.max_partition_size", INT, null ).build();

    @Internal
    @Description( "Name of the lock manager to be used, as defined in the corresponding LocksFactory." )
    public static final Setting<String> lock_manager = newBuilder( "internal.dbms.lock_manager", STRING, "forseti" ).build();

    @Internal
    @Description( "Include additional information in deadlock descriptions." )
    public static final Setting<Boolean> lock_manager_verbose_deadlocks = newBuilder( "internal.dbms.lock_manager.verbose_deadlocks", BOOL, false ).build();

    @Internal
    @Description( "Name of the tracer factory to be used. Current implementations are: null, default & verbose." )
    public static final Setting<String> tracer = newBuilder( "internal.dbms.tracer", STRING, null ).build();

    @Internal
    @Description( "Print out the effective Neo4j configuration after startup." )
    public static final Setting<Boolean> dump_configuration = newBuilder( "internal.dbms.report_configuration", BOOL, false ).build();
    ...
    public static final Setting<Integer> consistency_checker_fail_fast_threshold =
            newBuilder( "internal.consistency_checker.fail_fast_threshold", INT, 0 ).addConstraint( min( 0 ) ).build();
    ...
    public static final Setting<CypherRuntime> cypher_runtime =
            newBuilder( "internal.cypher.runtime", ofEnum( CypherRuntime.class ), CypherRuntime.DEFAULT ).build();
    ...
    public static final Setting<Integer> var_expand_relationship_id_set_threshold =
            newBuilder( "internal.cypher.var_expand_relationship_id_set_threshold", INT, 128 ).addConstraint( min( -1 ) ).build();
    ...
    public static final Setting<CypherExpressionEngine> cypher_expression_engine =
            newBuilder( "internal.cypher.expression_engine", ofEnum( CypherExpressionEngine.class ), CypherExpressionEngine.DEFAULT ).build();

    @Internal
    @Description( "Number of uses before an expression is considered for compilation" )
    public static final Setting<Integer> cypher_expression_recompilation_limit = newBuilder( "internal.cypher.expression_recompilation_limit", INT, 10 )
            .addConstraint( min( 0 ) )
            .build();

    @Internal
    @Description( "Enable tracing of compilation in cypher." )
    public static final Setting<Boolean> cypher_compiler_tracing = newBuilder( "internal.cypher.compiler_tracing", BOOL, false ).build();
    ...
    public static final Setting<Double> query_statistics_divergence_target =
            newBuilder( "internal.cypher.statistics_divergence_target", DOUBLE, 0.10 ).addConstraint( range( 0.0, 1.0 ) ).build();
    ...
    public static final Setting<Long> query_non_indexed_label_warning_threshold =
            newBuilder( "internal.cypher.non_indexed_label_warning_threshold", LONG, 10000L ).build();
    ...
    public static final Setting<Integer> cypher_idp_solver_table_threshold =
            newBuilder( "internal.cypher.idp_solver_table_threshold", INT, 128 ).addConstraint( min( 16 ) ).build();
    ...
    public static final Setting<Long> cypher_idp_solver_duration_threshold =
            newBuilder( "internal.cypher.idp_solver_duration_threshold", LONG, 1000L ).addConstraint( min( 10L ) ).build();
    ...
    public static final Setting<Duration> cypher_replan_interval_target =
            newBuilder( "internal.cypher.target_replan_interval", DURATION, Duration.ofHours( 7 ) ).build();
    ...
    public static final Setting<CypherReplanAlgorithm> cypher_replan_algorithm =
            newBuilder( "internal.cypher.replan_algorithm", ofEnum( CypherReplanAlgorithm.class ), CypherReplanAlgorithm.DEFAULT ).build();
    ...
    public static final Setting<Boolean> enable_pipelined_runtime_trace =
            newBuilder( "internal.cypher.pipelined.enable_runtime_trace", BOOL, false ).build();
    ...
    public static final Setting<Path> pipelined_scheduler_trace_filename =
            newBuilder( "internal.cypher.pipelined.runtime_trace_path", PATH, Path.of( "stdOut" ) )
    ...
    public static final Setting<Integer> cypher_pipelined_batch_size_small =
            newBuilder( "internal.cypher.pipelined.batch_size_small", INT, 128 ).addConstraint( min( 1 ) ).build();
    ...
    public static final Setting<Integer> cypher_pipelined_batch_size_big =
            newBuilder( "internal.cypher.pipelined.batch_size_big", INT, 1024 ).addConstraint( min( 1 ) ).build();
    ...
    public static final Setting<CypherOperatorEngine> cypher_operator_engine =
            newBuilder( "internal.cypher.pipelined.operator_engine", ofEnum( CypherOperatorEngine.class ), CypherOperatorEngine.DEFAULT ).build();
    ...
    public static final Setting<CypherPipelinedInterpretedPipesFallback> cypher_pipelined_interpreted_pipes_fallback =
            newBuilder( "internal.cypher.pipelined_interpreted_pipes_fallback", ofEnum( CypherPipelinedInterpretedPipesFallback.class ),
    ...
    public static final Setting<Integer> cypher_pipelined_operator_fusion_over_pipeline_limit =
            newBuilder( "internal.cypher.pipelined.operator_fusion_over_pipeline_limit", INT, 8 ).build();
    ...
    public static final Setting<SplittingTopBehavior> cypher_splitting_top_behavior =
            newBuilder( "internal.cypher.splitting_top_behavior", ofEnum( SplittingTopBehavior.class ), SplittingTopBehavior.DEFAULT ).build();
    ...
    public static final Setting<Set<String>> cypher_enable_extra_semantic_features =
            newBuilder( "internal.cypher.enable_extra_semantic_features", setOf(STRING), Set.of() ).build();
    ...
    public static final Setting<Integer> data_collector_max_recent_query_count =
            newBuilder( "internal.datacollector.max_recent_query_count", INT, 8192 ).addConstraint( min( 0 ) ).build();
    ...
    public static final Setting<Integer> data_collector_max_query_text_size =
            newBuilder( "internal.datacollector.max_query_text_size", INT, 10000 ).addConstraint( min( 0 ) ).build();
    ...
    public static final Setting<Duration> transaction_start_timeout =
            newBuilder( "internal.dbms.transaction_start_timeout", DURATION, ofSeconds( 1 ) ).build();

    @Internal
    @Description( "Location of the database scripts directory." )
    public static final Setting<Path> scripts_dir = newBuilder( "internal.dbms.directories.scripts", PATH, Path.of("scripts" ) )
            .setDependency( GraphDatabaseSettings.neo4j_home )
            .immutable()
            .build();
    ...
    public static final Setting<Path> system_init_file =
            newBuilder( "internal.dbms.init_file", PATH, null ).immutable().setDependency( scripts_dir ).build();
    ...
    public static final Setting<Duration> counts_store_rotation_timeout =
            newBuilder( "internal.dbms.counts_store_rotation_timeout", DURATION, ofMinutes( 10 ) ).build();
    ...
    public static final Setting<Integer> index_sampling_parallelism =
            newBuilder( "internal.dbms.index_sampling.parallelism", INT, 4 ).addConstraint( min( 0 ) ).build();
    ...
    public static final Setting<Integer> index_population_parallelism =
            newBuilder( "internal.dbms.index_population.parallelism", INT, 2 ).addConstraint( min( 0 ) ).build();
    ...
    public static final Setting<Integer> index_population_workers =
            newBuilder( "internal.dbms.index_population.workers", INT, Integer.max( 1, Runtime.getRuntime().availableProcessors() / 4 ) )
    ...
    public static final Setting<String> default_fulltext_provider =
            newBuilder( "internal.dbms.index.default_fulltext_provider", STRING, "fulltext-1.0" ).build();
    ...
    public static final Setting<Boolean> skip_default_indexes_on_creation =
            newBuilder( "internal.dbms.index.skip_default_indexes_on_creation", BOOL, false ).build();
    ...
    public static final Setting<Boolean> fail_on_corrupted_log_files =
            newBuilder("internal.dbms.tx_log.fail_on_corrupted_log_files", BOOL, true ).build();
    ...
    public static final Setting<Boolean> snapshot_query = newBuilder( "internal.dbms.query.snapshot", BOOL, false ).build();
    ...
    public static final Setting<Integer> snapshot_query_retries =
            newBuilder( "internal.dbms.query.snapshot.retries", INT, 5 ).addConstraint( range( 1, Integer.MAX_VALUE ) ).build();
    ...
    public static final Setting<Integer> query_execution_plan_cache_size =
            newBuilder( "internal.dbms.query_execution_plan_cache_size", INT, -1 ).addConstraint( min( -1 ) ).build();
    ...
    public static final Setting<Integer> string_block_size =
            newBuilder( "internal.dbms.block_size.strings", INT, 0 ).addConstraint( min( 0 ) ).build();
    ...
    public static final Setting<Integer> array_block_size =
            newBuilder( "internal.dbms.block_size.array_properties", INT, 0 ).addConstraint( min( 0 ) ).build();
    ...
    public static final Setting<Integer> label_block_size =
            newBuilder( "internal.dbms.block_size.labels", INT, 0 ).addConstraint( min( 0 ) ).build();
    ...
    public static final Setting<Duration> vm_pause_monitor_measurement_duration =
            newBuilder( "internal.vm_pause_monitor.measurement_duration", DURATION, ofMillis( 200 ) ).build();
    ...
    public static final Setting<Duration> vm_pause_monitor_stall_alert_threshold =
            newBuilder( "internal.vm_pause_monitor.stall_alert_threshold", DURATION, ofMillis( 200 ) ).build();
    ...
    public static final Setting<Boolean> log_queries_heap_dump_enabled =
            newBuilder( "internal.dbms.logs.query.heap_dump_enabled", BOOL, false ).dynamic().build();
    ...
    public static final Setting<Path> auth_store_directory = newBuilder( "internal.dbms.directories.auth", PATH, Path.of( "dbms" ) )
            .immutable()
    ...
    public static final Setting<Boolean> bolt_outbound_buffer_throttle =
            newBuilder( "internal.dbms.bolt.outbound_buffer_throttle", BOOL, true ).build();
    ...
    public static final Setting<Integer> bolt_outbound_buffer_throttle_high_water_mark =
            newBuilder( "internal.dbms.bolt.outbound_buffer_throttle.high_watermark", INT, (int) kibiBytes( 512 ) )
    ...
    public static final Setting<Integer> bolt_outbound_buffer_throttle_low_water_mark =
            newBuilder( "internal.dbms.bolt.outbound_buffer_throttle.low_watermark", INT, (int) kibiBytes( 128 ))
    ...
    public static final Setting<Duration> bolt_outbound_buffer_throttle_max_duration =
            newBuilder( "internal.dbms.bolt.outbound_buffer_throttle.max_duration", DURATION, ofMinutes( 15 )  )
    ...
    public static final Setting<Integer> bolt_inbound_message_throttle_high_water_mark =
            newBuilder( "internal.dbms.bolt.inbound_message_throttle.high_watermark", INT, 300 )
    ...
    public static final Setting<Integer> bolt_inbound_message_throttle_low_water_mark =
            newBuilder( "internal.dbms.bolt.inbound_message_throttle.low_watermark", INT, 100 )
                    .addConstraint( range( 1, Integer.MAX_VALUE ) )
                    .build();

    @Internal
    @Description( "Enable/disable the use of Epoll for netty" )
    public static final Setting<Boolean> netty_server_use_epoll = newBuilder( "internal.dbms.bolt.netty_server_use_epoll", BOOL, true ).build();

    @Internal
    @Description( "Quiet period for netty shutdown" )
    public static final Setting<Integer> netty_server_shutdown_quiet_period =
            newBuilder( "internal.dbms.bolt.netty_server_shutdown_quiet_period", INT, 5 ).build();

    @Internal
    @Description( "Timeout for netty shutdown" )
    public static final Setting<Duration> netty_server_shutdown_timeout =
            newBuilder( "internal.dbms.bolt.netty_server_shutdown_timeout", DURATION, ofSeconds( 15 ) ).build();
    ...
    public static final Setting<Boolean> netty_message_merge_cumulator =
            newBuilder( "internal.dbms.bolt.netty_message_merge_cumulator", BOOL, false ).build();
    ...
    public static final Setting<Boolean> force_small_id_cache = newBuilder( "internal.dbms.force_small_id_cache", BOOL, Boolean.FALSE ).build();
    ...
    public static final Setting<Boolean> consistency_check_on_apply =
            newBuilder( "internal.dbms.storage.consistency_check_on_apply", BOOL, Boolean.FALSE ).build();
    ...
    public static final Setting<Duration> routing_driver_idle_timeout =
            newBuilder( "internal.dbms.routing.driver.timeout", DURATION, ofMinutes( 1 ) ).build();
    ...
    public static final Setting<Duration> routing_driver_idle_check_interval =
            newBuilder( "internal.dbms.routing.driver.idle_check_interval", DURATION, ofMinutes( 1 ) ).build();
    ...
    public static final Setting<Integer> routing_driver_event_loop_count =
            newBuilder( "internal.dbms.routing.driver.event_loop_count", INT, Runtime.getRuntime().availableProcessors() ).build();
    ...
    public static final Setting<Boolean> routing_driver_log_leaked_sessions =
            newBuilder( "internal.dbms.routing.driver.logging.leaked_sessions", BOOL, false ).build();
    ...
    public static final Setting<Long> checkpoint_logical_log_rotation_threshold =
            newBuilder( "internal.dbms.checkpoint_log.rotation.size", BYTES, mebiBytes( 1 ) ).addConstraint( min( kibiBytes( 1 ) ) ).build();
    ...
    public static final Setting<Integer> checkpoint_logical_log_keep_threshold =
            newBuilder( "internal.dbms.checkpoint_log.rotation.keep.files", INT, 3 ).addConstraint( range( 2, 100 ) ).build();
    ...
    public static final Setting<Boolean> dump_diagnostics = newBuilder( "internal.dbms.dump_diagnostics", BOOL, Boolean.TRUE ).build();

    // === SETTINGS FROM FEATURE TOGGLES ===

    @Internal
    @Description( "Validate if transaction statements are properly closed" )
    public static final Setting<Boolean> track_tx_statement_close = newBuilder( "internal.dbms.debug.track_tx_statement_close", BOOL, false ).build();

    @Internal
    @Description( "Trace open/close transaction statements" )
    public static final Setting<Boolean> trace_tx_statements = newBuilder( "internal.dbms.debug.trace_tx_statement", BOOL, false ).build();

    @Internal
    @Description( "Validate if cursors are properly closed" )
    public static final Setting<Boolean> track_cursor_close = newBuilder( "internal.dbms.debug.track_cursor_close", BOOL, false ).build();

    @Internal
    @Description( "Trace unclosed cursors" )
    public static final Setting<Boolean> trace_cursors = newBuilder( "internal.dbms.debug.trace_cursors", BOOL, false ).build();
    ...
    public static final Setting<Duration> page_cache_tracer_speed_reporting_threshold =
            newBuilder( "internal.dbms.debug.page_cache_tracer_speed_reporting_threshold", DURATION, ofSeconds( 10 ) ).build();

    @Internal
    @Description( "Logging information about recovered index samples" )
    public static final Setting<Boolean> log_recover_index_samples = newBuilder( "internal.dbms.index.sampling.log_recovered_samples", BOOL, false ).build();

    @Internal
    @Description( "Enable asynchronous index sample recovery" )
    public static final Setting<Boolean> async_recover_index_samples = newBuilder( "internal.dbms.index.sampling.async_recovery", BOOL, true )
            .immutable().build();
    ...
    public static final Setting<Boolean> async_recover_index_samples_wait =
            newBuilder( "internal.dbms.index.sampling.async_recovery_wait", BOOL, null )
    ...
    public static final Setting<Boolean> enable_transaction_heap_allocation_tracking =
            newBuilder( "internal.dbms.enable_transaction_heap_allocation_tracking", BOOL, false ).build();
    ...
    public static final Setting<Long> initial_transaction_heap_grab_size =
            newBuilder( "internal.dbms.initial_transaction_heap_grab_size", BYTES, mebiBytes( 2 ) ).build();
    ...
    public static final Setting<Boolean> strictly_prioritize_id_freelist =
            newBuilder( "internal.dbms.strictly_prioritize_id_freelist", BOOL, true ).build();

    @Internal
    @Description( "Block/buffer size for index population" )
    public static final Setting<Long> index_populator_block_size = newBuilder( "internal.dbms.index.populator_block_size", BYTES, mebiBytes( 1 ) )
    ...
    public static final Setting<Integer> index_populator_merge_factor = newBuilder( "internal.dbms.index.populator_merge_factor", INT, 8 ).build();

    @Internal
    @Description( "Enable/disable logging for the id generator" )
    public static final Setting<Boolean> id_generator_log_enabled = newBuilder( "internal.dbms.idgenerator.log.enabled", BOOL, false ).build();
    ...
    public static final Setting<Long> id_generator_log_rotation_threshold =
            newBuilder( "internal.dbms.idgenerator.log.rotation_threshold", BYTES, mebiBytes( 200 ) ).build();
    ...
    public static final Setting<Duration> id_generator_log_prune_threshold =
            newBuilder( "internal.dbms.idgenerator.log.prune_threshold", DURATION, ofDays( 2 ) ).build();
    ...
    public static final Setting<Boolean> print_page_buffer_allocation_trace =
            newBuilder( "internal.dbms.debug.print_page_buffer_allocation_trace", BOOL, false ).build();
    ...
    public static final Setting<Boolean> index_population_print_debug =
            newBuilder( "internal.dbms.index.population_print_debug", BOOL, false ).build();
    ...
    public static final Setting<Integer> index_population_queue_threshold =
            newBuilder( "internal.dbms.index.population_queue_threshold", INT, 20_000 ).build();

    @Internal
    @Description( "Max size for an index population batch" )
    public static final Setting<Long> index_population_batch_max_byte_size =
            newBuilder( "internal.dbms.index.population_batch_max_byte_size", BYTES, mebiBytes( 10 ) )
                    .addConstraint( max( (long) Integer.MAX_VALUE ) )
                    .build();
    ...
    public static final Setting<Duration> config_command_evaluation_timeout =
            newBuilder( "internal.dbms.config.command_evaluation_timeout", DURATION, ofSeconds( 30 ) ).build();
    ...
    public static final Setting<Boolean> additional_lock_verification = newBuilder( "internal.dbms.extra_lock_verification", BOOL, false ).build();
    ...
    public static final Setting<Boolean> io_controller_consider_external_io =
            newBuilder( "internal.dbms.io.controller.consider.external.enabled", BOOL, false ).dynamic().build();
    ...
    public static final Setting<Boolean> managed_network_buffers =
            newBuilder( "internal.dbms.memory.managed_network_buffers", BOOL, false ).build();
    ...
    public static final Setting<Integer> counts_store_max_cached_entries =
            newBuilder( "internal.dbms.memory.counts_store_max_cached_entries", INT, 1_000_000 ).build();
    ...
    @Description( "Name of storage engine to use when creating new databases (except system database). If null or empty string then a default will be used." +
            ...
            "will be used" )
    @Internal
    public static final Setting<String> storage_engine = newBuilder( "internal.dbms.storage_engine", STRING, "record" ).build();

    @Internal
    @Description( "Whether or not to log contents of data that is inconsistent when deleting it." )
    public static final Setting<Boolean> log_inconsistent_data_deletion = newBuilder( "internal.dbms.log_inconsistent_data_deletion", BOOL, Boolean.FALSE )
            .dynamic()
            .build();

    @Internal
    @Description( "Whether or database should switch to read only mode on disk space problems." )
    public static final Setting<Boolean> dynamic_read_only_failover = newBuilder( "internal.dbms.readonly.failover", BOOL, Boolean.TRUE )
            .dynamic()
            .build();

    @Internal
    @Description( "Feature flag to enable/disable planning use of text indexes." )
    public static final Setting<Boolean> planning_text_indexes_enabled = newBuilder( "internal.cypher.planning_text_indexes_enabled", BOOL, true ).build();
    ...
    public static final Setting<Boolean> planning_range_indexes_enabled =
            newBuilder( "internal.cypher.planning_range_indexes_enabled", BOOL, true ).build();
    ...
    public static final Setting<Boolean> planning_point_indexes_enabled =
            newBuilder( "internal.cypher.planning_point_indexes_enabled", BOOL, true ).build();
    ...
    public static final Setting<Double> consistency_check_memory_limit_factor =
            newBuilder( "internal.consistency_checker.memory_limit_factor", DOUBLE, 0.9D )
    ...
    public static final Setting<Integer> reserved_page_header_bytes =
            newBuilder( "internal.dbms.reserved.page.header.bytes", INT, RESERVED_BYTES ).addConstraint( min( 0 ) ).build();

    @Description( "Feature flag for multi-versioned store prototype" )
    @Internal
    public static final Setting<Boolean> multi_version_store = newBuilder( "internal.dbms.multiversioned.store", BOOL,
            Boolean.valueOf( System.getProperty( "internal.dbms.multiversioned.store.override" ) ) ).build();
    ...
    public static final Setting<Boolean> dedicated_transaction_appender =
            newBuilder( "internal.dbms.tx.logs.dedicated.appender", BOOL, Boolean.FALSE ).build();

    @Internal
    @Description( "Enable per page file metrics collection in a default page cache and cursor tracer." )
    public static final Setting<Boolean> per_file_metrics_counters = newBuilder( "internal.dbms.page.file.tracer", BOOL, false ).build();

    @Internal
    @Description( "Enables sketching of next transaction log file in the background during reverse recovery." )
    public static final Setting<Boolean> pre_sketch_transaction_logs = newBuilder( "internal.dbms.tx_log.presketch", BOOL, false ).build();
    ...
    public static final Setting<Boolean> include_versions_under_development =
            newBuilder( "internal.dbms.include_dev_record_format_versions", BOOL, false ).build();
    ...
    public static final Setting<Boolean> use_old_token_index_location =
            newBuilder( "internal.dbms.use_old_token_index_location", BOOL, false ).build();

    @Description( "Whether or not to do parallel index writes during online transaction application" )
    @Internal
    public static Setting<Boolean> parallel_index_updates_apply = newBuilder( "internal.dbms.parallel_index_updates_apply", BOOL, false ).build();

    @Description( "Whether to offload buffered IDs for freeing to disk, rather than to keep them in memory" )
    @Internal
    public static Setting<Boolean> buffered_ids_offload = newBuilder( "internal.dbms.id_buffering.offload_to_disk", BOOL, true ).build();
}
