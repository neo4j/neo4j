...
public class GraphDatabaseSettings implements SettingsDeclaration
{
    ...
    public static final Setting<Boolean> strict_config_validation = newBuilder( "dbms.config.strict_validation", BOOL, true ).build();
    ...
    public static final Setting<Boolean> rebuild_idgenerators_fast =
            newBuilder( "unsupported.dbms.id_generator_fast_rebuild_enabled", BOOL, true ).build();
    ...
    @Internal
    public static final Setting<Integer> record_id_batch_size =
            newBuilder( "unsupported.dbms.record_id_batch_size", INT, 20 ).addConstraint( range( 1, 1_000 ) ).build();
    ...
    public static final Setting<Duration> bolt_outbound_buffer_throttle_max_duration =
            newBuilder( "unsupported.dbms.bolt.outbound_buffer_throttle.max_duration", DURATION, ofMinutes( 15 )  )
                    .addConstraint( min( ofSeconds( 30 ) ) )
                    .build();
