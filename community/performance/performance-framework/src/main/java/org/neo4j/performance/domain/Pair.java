...
/**
 * Copied from kernel, because we don't want to depend on any specific neo4j stuff (both to avoid circular deps,
 * but also because we might want to use this library to test multiple neo4j versions).
 *
 * @param <T1>
 * @param <T2>
 */
