...
public class RelationshipChainVisitor
{
    ...
    public RelationshipChainVisitor( LongFunction<NodeRecord> nodeStore, LongFunction<RelationshipRecord> relationshipStore,
    ...
    private void visitGroupChain( long nodeId, long firstRelationshipId, RelationshipDirection direction, Visitor visitor )
    {
