...
class SchemaStoreMapificationTest
{
    ...
    @Test
    void labelIndexDeterministicLegacyAnyGeneralUnmapification() throws Exception
    {
        // labelIndex: Index( 1, 'labelIndex', GENERAL, :label[1](property[2], property[3]), native-btree-1.0 )
        Map<String,Value> mapified = Map.of(
                "__org.neo4j.SchemaRule.schemaEntityType", Values.stringValue( "NODE" ),
                "__org.neo4j.SchemaRule.name", Values.stringValue( "labelIndex" ),
                "__org.neo4j.SchemaRule.schemaPropertySchemaType", Values.stringValue( "COMPLETE_ALL_TOKENS" ),
                ...
                "__org.neo4j.SchemaRule.schemaPropertyIds", Values.intArray( new int[] {2,3} ),
                "__org.neo4j.SchemaRule.schemaRuleType", Values.stringValue( "INDEX" ),
                "__org.neo4j.SchemaRule.indexType", Values.stringValue( "ANY_GENERAL" ),
                "__org.neo4j.SchemaRule.indexRuleType", Values.stringValue( "NON_UNIQUE" ),
                "__org.neo4j.SchemaRule.schemaEntityIds", Values.intArray( new int[] {1} )
        );
        assertThat( SchemaStore.unmapifySchemaRule( 1, mapified ), is( equalTo( labelIndex ) ) );
    ...
    @Test
    void labelUniqueIndexDeterministicLegacyAnyGeneralUnmapification() throws Exception
    {
        // labelUniqueIndex: Index( 1, 'labelUniqueIndex', UNIQUE, :label[1](property[2], property[3]), native-btree-1.0 )
        Map<String,Value> mapified = Map.of(
                "__org.neo4j.SchemaRule.schemaEntityType", Values.stringValue( "NODE" ),
                "__org.neo4j.SchemaRule.name", Values.stringValue( "labelUniqueIndex" ),
                "__org.neo4j.SchemaRule.schemaPropertySchemaType", Values.stringValue( "COMPLETE_ALL_TOKENS" ),
    ...
    @Test
    void relTypeIndexDeterministicLegacyAnyGeneralUnmapification() throws Exception
    {
        // relTypeIndex: Index( 1, 'relTypeIndex', GENERAL, -[:relType[1](property[2], property[3])]-, native-btree-1.0 )
        Map<String,Value> mapified = Map.of(
                "__org.neo4j.SchemaRule.schemaEntityType", Values.stringValue( "RELATIONSHIP" ),
                "__org.neo4j.SchemaRule.name", Values.stringValue( "relTypeIndex" ),
                "__org.neo4j.SchemaRule.schemaPropertySchemaType", Values.stringValue( "COMPLETE_ALL_TOKENS" ),
    ...
    @Test
    void relTypeUniqueIndexDeterministicLegacyAnyGeneralUnmapification() throws Exception
    {
        // relTypeUniqueIndex: Index( 1, 'relTypeUniqueIndex', UNIQUE, -[:relType[1](property[2], property[3])]-, native-btree-1.0 )
        Map<String,Value> mapified = Map.of(
                "__org.neo4j.SchemaRule.schemaEntityType", Values.stringValue( "RELATIONSHIP" ),
                "__org.neo4j.SchemaRule.name", Values.stringValue( "relTypeUniqueIndex" ),
                "__org.neo4j.SchemaRule.schemaPropertySchemaType", Values.stringValue( "COMPLETE_ALL_TOKENS" ),
    ...
    @Test
    void uniqueLabelConstraintDeterministicLegacyAnyGeneralUnmapification() throws Exception
    {
        // uniqueLabelConstraint: org.neo4j.internal.schema.constraints.ConstraintDescriptorImplementation@4081ce06
        Map<String,Value> mapified = Map.of(
                "__org.neo4j.SchemaRule.schemaEntityType", Values.stringValue( "NODE" ),
                "__org.neo4j.SchemaRule.name", Values.stringValue( "uniqueLabelConstraint" ),
                "__org.neo4j.SchemaRule.schemaPropertySchemaType", Values.stringValue( "COMPLETE_ALL_TOKENS" ),
    ...
    @Test
    void existsLabelConstraintDeterministicLegacyAnyGeneralUnmapification() throws Exception
    {
        // existsLabelConstraint: org.neo4j.internal.schema.constraints.ConstraintDescriptorImplementation@40e00a04
        Map<String,Value> mapified = Map.of(
                "__org.neo4j.SchemaRule.schemaEntityType", Values.stringValue( "NODE" ),
                "__org.neo4j.SchemaRule.name", Values.stringValue( "existsLabelConstraint" ),
                "__org.neo4j.SchemaRule.schemaPropertySchemaType", Values.stringValue( "COMPLETE_ALL_TOKENS" ),
    ...
    @Test
    void nodeKeyConstraintDeterministicLegacyAnyGeneralUnmapification() throws Exception
    {
        // nodeKeyConstraint: org.neo4j.internal.schema.constraints.ConstraintDescriptorImplementation@4916aa26
        Map<String,Value> mapified = Map.of(
                "__org.neo4j.SchemaRule.schemaEntityType", Values.stringValue( "NODE" ),
                "__org.neo4j.SchemaRule.name", Values.stringValue( "nodeKeyConstraint" ),
                "__org.neo4j.SchemaRule.schemaPropertySchemaType", Values.stringValue( "COMPLETE_ALL_TOKENS" ),
    ...
    @Test
    void existsRelTypeConstraintDeterministicLegacyAnyGeneralUnmapification() throws Exception
    {
        // existsRelTypeConstraint: org.neo4j.internal.schema.constraints.ConstraintDescriptorImplementation@680000
        Map<String,Value> mapified = Map.of(
                "__org.neo4j.SchemaRule.schemaEntityType", Values.stringValue( "RELATIONSHIP" ),
                "__org.neo4j.SchemaRule.name", Values.stringValue( "existsRelTypeConstraint" ),
                "__org.neo4j.SchemaRule.schemaPropertySchemaType", Values.stringValue( "COMPLETE_ALL_TOKENS" ),
    ...
    @Test
    void labelIndexDeterministicLegacyTreeUnmapification() throws Exception
    {
        // labelIndex: Index( 1, 'labelIndex', GENERAL, :label[1](property[2], property[3]), native-btree-1.0 )
        Map<String,Value> mapified = Map.of(
                "__org.neo4j.SchemaRule.schemaEntityType", Values.stringValue( "NODE" ),
                ...
                "__org.neo4j.SchemaRule.schemaPropertyIds", Values.intArray( new int[] {2,3} ),
                "__org.neo4j.SchemaRule.schemaRuleType", Values.stringValue( "INDEX" ),
                "__org.neo4j.SchemaRule.indexType", Values.stringValue( "TREE" ),
                "__org.neo4j.SchemaRule.indexRuleType", Values.stringValue( "NON_UNIQUE" ),
                "__org.neo4j.SchemaRule.schemaEntityIds", Values.intArray( new int[] {1} )
        );
        assertThat( SchemaStore.unmapifySchemaRule( 1, mapified ), is( equalTo( labelIndex ) ) );
    ...
    @Test
    void labelUniqueIndexDeterministicLegacyTreeUnmapification() throws Exception
    {
        // labelUniqueIndex: Index( 1, 'labelUniqueIndex', UNIQUE, :label[1](property[2], property[3]), native-btree-1.0 )
        Map<String,Value> mapified = Map.of(
                "__org.neo4j.SchemaRule.schemaEntityType", Values.stringValue( "NODE" ),
    ...
    @Test
    void relTypeIndexDeterministicLegacyTreeUnmapification() throws Exception
    {
        // relTypeIndex: Index( 1, 'relTypeIndex', GENERAL, -[:relType[1](property[2], property[3])]-, native-btree-1.0 )
        Map<String,Value> mapified = Map.of(
                "__org.neo4j.SchemaRule.schemaEntityType", Values.stringValue( "RELATIONSHIP" ),
    ...
    @Test
    void relTypeUniqueIndexDeterministicLegacyTreeUnmapification() throws Exception
    {
        // relTypeUniqueIndex: Index( 1, 'relTypeUniqueIndex', UNIQUE, -[:relType[1](property[2], property[3])]-, native-btree-1.0 )
        Map<String,Value> mapified = Map.of(
                "__org.neo4j.SchemaRule.schemaEntityType", Values.stringValue( "RELATIONSHIP" ),
    ...
    @Test
    void uniqueLabelConstraintDeterministicLegacyTreeUnmapification() throws Exception
    {
        // uniqueLabelConstraint: org.neo4j.internal.schema.constraints.ConstraintDescriptorImplementation@4081ce06
        Map<String,Value> mapified = Map.of(
                "__org.neo4j.SchemaRule.schemaEntityType", Values.stringValue( "NODE" ),
    ...
    @Test
    void existsLabelConstraintDeterministicLegacyTreeUnmapification() throws Exception
    {
        // existsLabelConstraint: org.neo4j.internal.schema.constraints.ConstraintDescriptorImplementation@40e00a04
        Map<String,Value> mapified = Map.of(
                "__org.neo4j.SchemaRule.schemaEntityType", Values.stringValue( "NODE" ),
    ...
    @Test
    void nodeKeyConstraintDeterministicLegacyTreeUnmapification() throws Exception
    {
        // nodeKeyConstraint: org.neo4j.internal.schema.constraints.ConstraintDescriptorImplementation@4916aa26
        Map<String,Value> mapified = Map.of(
                "__org.neo4j.SchemaRule.schemaEntityType", Values.stringValue( "NODE" ),
    ...
    @Test
    void existsRelTypeConstraintDeterministicLegacyTreeUnmapification() throws Exception
    {
        // existsRelTypeConstraint: org.neo4j.internal.schema.constraints.ConstraintDescriptorImplementation@680000
        Map<String,Value> mapified = Map.of(
                "__org.neo4j.SchemaRule.schemaEntityType", Values.stringValue( "RELATIONSHIP" ),
