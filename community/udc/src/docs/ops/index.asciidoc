...
UDC is easily turned off by disabling it in the database configuration.
In _conf/neo4j.properties_ for Neo4j server or in the configuration passed to the database in embedded mode.
