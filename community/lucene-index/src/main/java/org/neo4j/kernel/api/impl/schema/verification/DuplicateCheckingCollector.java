...
import static org.neo4j.kernel.api.impl.schema.verification.DuplicateCheckStrategy.BucketsDuplicateCheckStrategy;
import static org.neo4j.kernel.api.impl.schema.verification.DuplicateCheckStrategy.MapDuplicateCheckStrategy;
...
public class DuplicateCheckingCollector extends SimpleCollector
{
    ...
    protected void doCollect( int doc ) throws IOException, KernelException, IndexEntryConflictException
    {
        ...
        duplicateCheckStrategy.checkForDuplicate( property, property.value(), nodeId );
    }
    ...
    public void init( int expectedNumberOfEntries )
    {
        ...
        {
            duplicateCheckStrategy = new MapDuplicateCheckStrategy( expectedNumberOfEntries );
        }
        else
        {
