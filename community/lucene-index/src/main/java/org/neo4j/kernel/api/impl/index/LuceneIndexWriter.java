...
public class LuceneIndexWriter implements Closeable
{
    ...
    private static final Map<String,String> ONLINE_STATUS_USER_DATA = Collections.singletonMap( KEY_STATUS, ONLINE );
    ...
    static boolean isOnline( Directory directory ) throws IOException
    {
    ...
    void commitAsOnline() throws IOException
    {
        writer.commit( ONLINE_STATUS_USER_DATA );
    }
    ...
    void reserveDocumentInsertions( int insertionsCount ) throws IOException
    {
