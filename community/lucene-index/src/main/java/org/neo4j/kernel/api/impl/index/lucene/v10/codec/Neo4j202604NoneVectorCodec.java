...
public class Neo4j202604NoneVectorCodec extends FilterCodec implements Lucene10Codec {
    ...
    public Neo4j202604NoneVectorCodec(VectorIndexConfig config, int numMergeWorkers, ExecutorService mergeExec) {
        ...
        this.vectorFormat = (mergeExec == null || numMergeWorkers <= 1)
                ? new LuceneKnnVectorFormatV2(maxDimensions, config.hnsw())
                : new LuceneKnnVectorFormatV2(maxDimensions, config.hnsw(), numMergeWorkers, mergeExec);
    }
