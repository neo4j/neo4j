 ...
 */
@Deprecated
public class ObsoleteLuceneIndexWriter implements Closeable, LuceneIndexWriter
{
     ...
     */
    ObsoleteLuceneIndexWriter( Directory dir, IndexWriterConfig conf ) throws IOException
    {
