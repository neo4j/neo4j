...
{
    public static IndexWriterFactory standard( final DirectoryFactory directoryFactory )
    {
        return new IndexWriterFactory()
        {
            @Override
            public IndexWriter create( File directory ) throws IOException
            {
                ...
                return new IndexWriter( directoryFactory.open( directory ), writerConfig );
            }
        };
    }
}
