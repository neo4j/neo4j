...
public class DatabaseCompositeIndexAccessorTest
{
    ...
    private static final IndexDescriptor SCHEMA_INDEX_DESCRIPTOR = IndexDescriptorFactory
            .forLabel( 0, PROP_ID1, PROP_ID2 );
    private static final IndexDescriptor UNIQUE_SCHEMA_INDEX_DESCRIPTOR = IndexDescriptorFactory
