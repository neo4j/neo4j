...
public class LuceneIndexAccessorIT
{
    ...
    void shouldIterateAllDocumentsEvenWhenContainingDeletions() throws Exception
    {
        ...
        populateWithInitialNodes( indexDescriptor, nodes, expectedNodes, tokenNameLookup );
    ...
    private void populateWithInitialNodes( IndexDescriptor indexDescriptor, int nodes, MutableLongSet expectedNodes, TokenNameLookup tokenNameLookup )
            throws IndexEntryConflictException
    {
        ...
        populator.scanCompleted( nullInstance, mock( JobScheduler.class ), NULL );
