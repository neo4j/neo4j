...
public final class AssumptionHelper
{
     ...
     * @throws TestAbortedException if the assumptions fail, e.i. user is unable to change permissions or can still read the file even without permissions.
     */
     ...
     * @return A {@link Closeable} that will restore permissions when closed.
     * @throws TestAbortedException if the assumptions fail, e.i. user is unable to change permissions or can still write to the file even without permissions.
     */
    @SuppressWarnings( "ResultOfMethodCallIgnored" )
