...
public enum ZippedStoreCommunity implements ZippedStore {
    ...
    REC_AF11_V202602_EMPTY(
            "record-aligned-1.1_V2026.02_empty_community.zip",
            new DbStatistics(
                    "record-aligned-1.1",
                    KernelVersion.V2026_02,
                    4,
                    COMMUNITY,
                    0,
                    0,
    ...
    REC_AF11_V202606_EMPTY(
            "record-aligned-1.1_V2026.06_empty_community.zip",
            new DbStatistics(
                    "record-aligned-1.1",
                    KernelVersion.V2026_06,
                    4,
                    COMMUNITY,
                    0,
                    0,
    ...
    REC_AF11_V202607_EMPTY(
            "record-aligned-1.1_V2026.07_empty_community.zip",
            new DbStatistics(
                    "record-aligned-1.1",
