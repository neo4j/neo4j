...
class ProcessedRecords<R extends Abstract64BitRecord>
{
    ...
    {
        return "ProcessedRecords{" + "command=" + checkType.name() + ", recordsById.size=" + recordsById.size() + "}";
    }
}
