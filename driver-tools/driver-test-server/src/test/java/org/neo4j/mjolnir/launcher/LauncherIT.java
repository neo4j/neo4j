...
public class LauncherIT
{
    ...
    public void shouldControlHostAndPort() throws Throwable
    {
        ...
        LauncherMatchers.assertEventually(
                ...
                LauncherMatchers.serverListensTo( host, port ) );
    }

    @Test( timeout = 120_000 )
    public void shouldPrintHelpMessage() throws Exception
    {
        // Given
        ...
        // When
        proc = buildProcess( Launcher.class, "--help" )
        ...
        assertTrue( output.contains( "Neo4j - Graph database server" ) );
    }
