...
;(function()
{
	...
	function Brush()
	{
        var funcs   =   'abs acos all allShortestPaths any asin atan atan2 avg ceil coalesce collect collect cos cot count degrees e end endnode exp extract filter floor has head id labels last left length length log log10 lower ltrim max min node nodes none percentile_cont percentile_disc pi radians rand range reduce rel relationship relationships replace right round rtrim shortestPath sign sin single sqrt startnode stdev stdevp str substring sum tail tan timestamp trim type type upper';
