...
;(function()
{
	...
	function Brush()
	{
        ...
        var keywords =  'as asc ascending by case constraint create cypher delete desc descending distinct drop else false foreach in index is limit match merge null on order remove return set skip start then true union unique using when where with';
