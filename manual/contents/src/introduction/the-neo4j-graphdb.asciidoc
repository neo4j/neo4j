...
_Relationships are equally well traversed in either direction._
...
Note that the word _type_ might be misleading here, you could rather think of it as a _name_.
