...
public class BoltResponseMessageStructsDocTest
{
    ...
    public static Collection<Object[]> documentedTypeMapping()
    {
        ...
        for ( DocStruct struct : DocsRepository.docs().read(
                ...
                "code[data-lang=\"bolt_response_message_struct\"]",
    ...
    public void ensureSerializingMessagesAsDocumentedWorks() throws Throwable
    {
        ...
        {
            DocStruct.packValueOf( field.type(), packer );
        }
        packer.flush();
        ...
        BoltResponseMessageReader responseMessageReader = new BoltResponseMessageReader( unpacker );

        BoltResponseMessageRecorder messages = new BoltResponseMessageRecorder();
        responseMessageReader.read( messages );
