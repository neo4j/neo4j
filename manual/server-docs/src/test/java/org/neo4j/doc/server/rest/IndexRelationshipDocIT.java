...
public class IndexRelationshipDocIT extends org.neo4j.doc.server.rest.AbstractRestFunctionalTestBase
{
    ...
    public void shouldCreateANamedRelationshipIndexAndAddToIt() throws JsonParseException
    {
        ...
        org.neo4j.doc.server.rest.JaxRsResponse response = httpPostIndexRelationshipRoot( JsonHelper.createJsonFrom( indexSpecification ) );
    ...
    public void shouldGet404WhenRequestingIndexUriWhichDoesntExist()
    {
        ...
        org.neo4j.doc.server.rest.JaxRsResponse response = httpGet( indexUri );
    ...
    public void shouldGet404WhenDeletingNonExtistentIndex()
    {
        ...
        org.neo4j.doc.server.rest.JaxRsResponse response = request.delete( indexUri );
        assertEquals( Status.NOT_FOUND.getStatusCode(), response.getStatus() );
    }
    ...
    public void shouldGet200AndArrayOfRelationshipRepsWhenGettingFromIndex() throws JsonParseException
    {
        ...
        String indexName = indexes.newInstance();
        org.neo4j.doc.server.rest.JaxRsResponse
                indexCreationResponse = httpPostIndexRelationshipRoot( "{\"name\":\"" + indexName + "\"}" );
        assertEquals( 201, indexCreationResponse.getStatus() );
        org.neo4j.doc.server.rest.JaxRsResponse indexedRelationshipResponse = httpPostIndexRelationshipNameKeyValue( indexName,
        ...
        org.neo4j.doc.server.rest.JaxRsResponse response = RestRequest.req().get(
    ...
    public void shouldBeAbleToRemoveIndexing()
    {
        ...
        org.neo4j.doc.server.rest.JaxRsResponse response = RestRequest.req().delete(
    ...
    public void shouldRespondWith400WhenSendingCorruptJson() throws Exception
    {
        ...
        org.neo4j.doc.server.rest.JaxRsResponse response = RestRequest.req().post( functionalTestHelper.indexRelationshipUri( indexName ),
                corruptJson );
    ...
    private org.neo4j.doc.server.rest.JaxRsResponse httpPostIndexRelationshipRoot( String jsonIndexSpecification )
    {
        return RestRequest.req().post( functionalTestHelper.relationshipIndexUri(), jsonIndexSpecification );
    }

    private org.neo4j.doc.server.rest.JaxRsResponse httpGetIndexRelationshipNameKeyValue( String indexName, String key, String value )
    {
        return RestRequest.req().get( functionalTestHelper.indexRelationshipUri( indexName, key, value ) );
    }

    private org.neo4j.doc.server.rest.JaxRsResponse httpPostIndexRelationshipNameKeyValue( String indexName, long relationshipId, String key,
            String value )
    {
    ...
    private org.neo4j.doc.server.rest.JaxRsResponse httpGet( String indexUri )
    {
        return request.get( indexUri );
    }

    private org.neo4j.doc.server.rest.JaxRsResponse httpPostCreateRelationship( long startNode, String jsonString )
    {
