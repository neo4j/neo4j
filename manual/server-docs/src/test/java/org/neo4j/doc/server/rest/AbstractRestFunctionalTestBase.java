...
public class AbstractRestFunctionalTestBase extends SharedServerTestBase implements GraphHolder
{
    ...
    public @Rule
    TestData<org.neo4j.doc.server.rest.RESTDocsGenerator> gen = TestData.producedThrough( org.neo4j.doc.server.rest
            .RESTDocsGenerator.PRODUCER );
    ...
    public org.neo4j.doc.server.rest.RESTDocsGenerator gen() {
        return gen.get();
    }
