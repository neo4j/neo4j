            ...
            throws Exception
    {
        ...
        server = CommunityServerBuilder.server().withDefaultDatabaseTuning()
                .withThirdPartyJaxRsPackage( "org.dummy.web.service",
                        mountPoint )
                .withSecurityRules(
                        org.neo4j.doc.server.rest.security.PermanentlyFailingSecurityRuleWithWildcardPath.class.getCanonicalName() )
                .usingDataDir( folder.directory( name.getMethodName() ).getAbsolutePath() )
                .build();
        server.start();
        ...
        gen.get().addTestSourceSnippets( org.neo4j.doc.server.rest.security.PermanentlyFailingSecurityRuleWithWildcardPath.class,
                "failingRuleWithWildcardPath" );
            ...
            throws Exception
    {
        ...
        server = CommunityServerBuilder.server().withDefaultDatabaseTuning()
                .withThirdPartyJaxRsPackage( "org.dummy.web.service",
                        mountPoint )
                .withSecurityRules(
                        org.neo4j.doc.server.rest.security.PermanentlyFailingSecurityRuleWithComplexWildcardPath.class.getCanonicalName() )
                .usingDataDir( folder.directory( name.getMethodName() ).getAbsolutePath() )
                .build();
        server.start();
        gen.get().addSnippet(
        ...
        gen.get().addTestSourceSnippets( org.neo4j.doc.server.rest.security.PermanentlyFailingSecurityRuleWithComplexWildcardPath.class,
                "failingRuleWithComplexWildcardPath" );
        gen.get().setSection( "ops" );
