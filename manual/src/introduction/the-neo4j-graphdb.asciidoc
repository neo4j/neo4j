...
////
// removed as it doesn't make sense unless you're into unix filesystems quite deeply.
...
* <<shell-listing-indexes-and-constraints, Listing Indexes via Shell>>
...
* <<shell-listing-indexes-and-constraints, Listing Constraints via Shell>>
