...
When programming, you can refer to the +link:javadocs/org/neo4j/graphdb/GraphDatabaseService.html[GraphDatabaseService]+ API.
To switch from a single instance to multiple highly available instances, simply switch from the concrete +link:javadocs/org/neo4j/kernel/EmbeddedGraphDatabase.html[EmbeddedGraphDatabase]+ to the +link:javadocs/org/neo4j/kernel/HighlyAvailableGraphDatabase.html[HighlyAvailableGraphDatabase]+.
