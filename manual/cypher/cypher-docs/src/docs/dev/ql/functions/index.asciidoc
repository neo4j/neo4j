...
There are four groups of functions in Cypher:

* _Predicate functions_ return either true or false for the arguments given.
* _Scalar functions_ return a single value.
* _List functions_ return lists of other values.
* _String functions_ are used to manipulate strings or to create a string representation of another value.
