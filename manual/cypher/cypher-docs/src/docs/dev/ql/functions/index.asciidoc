...
This example shows how you create a _user-defined function_ and invoke it from Cypher.
[snippet,java]
----
component=neo4j-cypher-docs
source=org/neo4j/procedure/example/JoinFunction.java
classifier=sources
tag=joinFunction
----
...
include::call-a-user-defined-function.asciidoc[]
