...
|<<functions-length,length() - path>>               | Returns the length of a path.
|<<functions-length-of-string,length() - string>>   | Returns the length of a string.
...
|<<functions-size,size() - list>>                   | Returns the number of items in a list.
|<<functions-size-of-pattern-expression,size() - pattern expression>>    | Returns the number of sub-graphs matching the pattern expression.
